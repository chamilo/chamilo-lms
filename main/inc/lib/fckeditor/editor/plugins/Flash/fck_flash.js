...
Media.prototype.replaceObject = function(o){
	...
	if (this.align != '')	SetAttribute(o, 'align', this.align);
	if (this.width > 0)		SetAttribute(o, 'width', this.width);
	if (this.height > 0)	SetAttribute(o, 'height', this.height);
	if (this.vspace > 0)	SetAttribute(o, 'vspace', this.vspace);
	if (this.hspace > 0)	SetAttribute(o, 'hspace', this.height);
...
Media.prototype.getOuterHTML = function (objectId){
  ...
  if (this.vspace > 0)  	s+= this.createAttribute('vspace',this.vspace);
	if (this.hspace > 0) 		s+= this.createAttribute('hspace',this.hspace);
