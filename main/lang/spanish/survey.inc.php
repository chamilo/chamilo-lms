...
$YesNo = "Si / No";
$MultipleChoice = "Respuesta única";
...
$UseLinkSyntax = "Los usuarios seleccionados recibirán un correo electrónico con el texto que ha rellenado más arriba, así como un enlace que tienen que pulsar para complementar la encuesta. Si desea introducir este enlace en algún lugar de su texto, debe introducir lo siguiente: ** enlace ** (asterisco asterisco enlace asterisco asterisco). Esta etiqueta será sustituida automáticamente por el enlace. Si no agrega el ** enlace ** a su texto,  el enlace será añadido al final del correo";
