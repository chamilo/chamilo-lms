...
$PermissionsForNewFilesComment = "La possibilità di definire permessi per ogni nuovo file creato migliora la sicurezza nei confronti di attacchi eseguiti caricando nel portale dei file pericolosi. I permessi 0550 (in formato Linux) permettono una protezione abbastanza elevata.<br/>Se usi";
...
$SplitUsersUploadDirectoryComment = "Nei portali con un numero molto alto di utenti, i dati e le immagini degli utenti possono eccedere il massimo consentito (36000 files in sistemi Debian). Attivando l\'opzione vengono create 9 directory (eventualmente da creare trasferendo i dati esistenti";
...
$langPpt2lpDescription = "Oogie-Woogie è uno strumento di rapid e-learning che permette di trasformare una presentazione o un documento (ad esempio nei formati ppt o doc) in un modulodidattico in standard SCORM con pochi click.<br/>Dopo la conversione, alle singole pagine potrà es";
...
$VersionCheckExplanation = "Per attivare il controllo automatico della versione è necessario registrare il campus su chamilo.com. L\'informazione trasmessa cliccando sul pulsante sarà usata solo internamente al sistema e i dati verranno pubblicati in modo aggregato (numero totale di";
...
$UploadExtensionsBlacklistComment = "La lista nera è usata per filtrare i files con determinate estensioni, rimuovendoli o rinominandoli. Le estensioni devono essere descritte senza il punto (.) e i diversi elementi devono essere separati da un punto e virgola (;), ad esempio: exe;com;bat;sc";
$UploadExtensionsWhitelistComment = "La lista bianca è usata per consentire il caricamento di files che abbiano SOLO determinate estensioni, rimuovendo o rinominando gli altri. Il grado di sicurezza è maggiore ma piuttosto restrittivo.Le estensioni devono essere descritte senza il punto (.)";
$UploadExtensionsSkip = "Comportamento del filtro (rimuovi/rinomina)";
$UploadExtensionsSkipComment = "Se scegli Rimuovi, i files non saranno caricati. Se decidi di rinominare le estensioni dei files saranno sostituite da quelle assegnate in fase di configurazione. Attenzione: rinominare non garantisce la protezione e può creare conflitti tra files con lo";
...
$UserFieldsAddHelp = "Per aggiungere un campo utente semplicemente:<br />- scegli un identificatore formato da una sola parola, minuscola,<br />- selezionane il tipo,<br />- immetti un testo che l\'utente possa vedere (un termine già tradotto come BirthDate o UserSex sarà auto";
...
$LDAPEnableComment = "Se hai un server LDAP, devi configurare i parametri sottostanti, modificare il file di configurazione come descritto nel manuale di installazione e attivare il server. Gli utenti potranno così adoperare il nome utente LDAP per accedere alla piattaforma. S";
...
$LDAPFilledTutorFieldComment = "Il campo verrà analizzato all\'atto dell\'inserimento di un nuovo utente. Se vuoi che l\'utente sia considerato come semplice utente (corsista) lascia vuoto il campo, altrimenti l\'utente sarà considerato un docente.Il campo può essere modificato cambiand";
...
$VisioUseRtmptComment = "Il protocollo rtmpt permette di accedere alla videoconferenza anche attraverso un firewall, ridirezionando la comunicazione alla porta 80. Ciò ovviamente peggiora la velocità dello streaming, per cui tale soluzione è da utilizzare solo se strettamente nec";
...
$LDAPFilledTutorFieldValueComment = "Se il campo è lasciato vuoto, un utente è considerato docente solo se il rispettivo sottocampo LDAP lo definisce tale ( ad esempio campo \\"memberof\\" e  valore da cercare  \\"CN=G_TRAINER,OU=Trainer\\").Se il campo è marcato, un utente è considerato docente";
