...
{
    public static $correctFb;
    public static $incorrectFb;
    ...
    public static function addResponseCondition($node, $title, $ident, $feedbackRefid, $respident): void
    {
    ...
    public static function addAssesmentDescription($rt, $content, $contenttype): void
    {
    ...
    public static function addRespcondition($node, $title, $feedbackRefid, $gradeValue = null, $continue = false): void
    {
        $qrespcondition = new CcAssesmentRespconditiontype();
    ...
    public static function processQuestions(&$objQuizz, &$manifest, CcAssesmentSection &$section, $rootpath, $contextid, $outdir)
    {
        ...
        // return dependencies
        return (0 == $questioncount) ? false : PkgResourceDependencies::instance()->getDeps();
    }
}
