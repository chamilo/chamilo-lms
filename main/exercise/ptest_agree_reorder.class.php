 ...
 * Class UniqueAnswer.
 *
 * This class allows to instantiate an object of type QUESTION_PT_TYPE_AGREE_REORDER
 * (Re-order words by most agree to least agree),
 ...
 */
class PtestAgreeReorder extends Question
{
    public $typePicture = 'ptorder.png';
    public $explanationLangVar = 'PtestAgreeReorder';
    ...
    {
        parent::__construct();
        $this->type = QUESTION_PT_TYPE_AGREE_REORDER;
