...
class CSurveyInvitation
{
     ...
     * @var integer
     *
     * @ORM\Column(name="survey_invitation_id", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="survey_code", type="string", length=20, precision=0, scale=0, nullable=false, unique=false)
     */
    private $surveyCode;
     ...
     * @var string
     *
     * @ORM\Column(name="invitation_code", type="string", length=250, precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="invitation_date", type="datetime", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="reminder_date", type="datetime", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="answered", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $answered;
