 ...
 * Class UniqueAnswer.
 *
 * This class allows to instantiate an object of type QUESTION_PT_TYPE_AGREE_OR_DISAGREE
 * (Select the most agree and disagree options),
...
{
    public $typePicture = 'ptaod.png';
    public $explanationLangVar = 'PtestAgreeOrDisagree';
    ...
    {
        parent::__construct();
        $this->type = QUESTION_PT_TYPE_AGREE_OR_DISAGREE;
