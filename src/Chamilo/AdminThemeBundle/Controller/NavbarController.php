...
class NavbarController extends Controller
{
    ...
    public function notificationsAction($max = 5)
    {
        ...
        return $this->render(
                    'ChamiloAdminThemeBundle:Navbar:notifications.html.twig',
                        array(
    ...
    public function messagesAction($max = 5)
    {
        ...
        return $this->render(
                    'ChamiloAdminThemeBundle:Navbar:messages.html.twig',
                        array(
    ...
    public function tasksAction($max = 5)
    {
        ...
        return $this->render(
                    'ChamiloAdminThemeBundle:Navbar:tasks.html.twig',
                        array(
    ...
    public function userAction()
    {
        ...
        return $this->render(
                    'ChamiloAdminThemeBundle:Navbar:user.html.twig',
                        array(
