...
$langAdministrationTools  = "Administratorski alati";
$langState  = "Stanje sistema";
$langDevAdmin  = "Administracija razvoja";
$langLinksToClaroProjectSite  = "Link ka Web sajtu projekta";
$langStatistiques  = "Statistike";
$langNbProf  = "Broj predava&#269;a";
$langNbStudents  = "Broj polaznika";
$langNbLogin  = "Broj prijava";
$langToday    = "Danas";
$langLast7Days  = "Poslednjih 7 dana";
$langLast30Days  = "Poslednjih 30 dana";
$langNbAnnoucement  = "Broj obaveštenja";
$langCheckDatabase  = "Proveri glavnu bazu Dokeosa";
$langPleaseCheckConfigForMainDataBaseName  = "Molim Vas, proverite ove vrednosti<br>Ime glavne baze podataka u<br> ";
$langBaseFound  = "Prona&#273;eno<br>
Proveravanje tabela u ovoj bazi";
$langNeeded  = "Obavezno";
$langNotNeeded  = "Nije obavezno";
$langArchive    = "Arhiva";
$langUsed       = "Koriš&#263;eno";
$langPresent   = "Ok";
$langCreateMissingNow  = "Da li želite da kreirate tabele sada?";
$langMissing    = "Ne postoji";
$langCheckingCourses  = "Proveravanje kurseva";
$langExist      = "Postoji";
$langCreateClaroTables  = "Kreiraj tabelu za glavnu bazu";
$langTableStructureDontKnow  = "Struktura ove tabele je nepoznata";
...
$AllowUserHeadings = "Dozvoli naslove korisnika";
$langCourseBackup = "Napravi back-up ovog kursa";
$langSecureDocument = "Osiguraj direktorijum Dokument";
$langProtectedDocument = "stavite .htaccess  fajl u folder /document/ da biste izbegli neovlaš&#263;en pristup ";
$langNotProtectedDocument = "Dozvolite pristup folder /document/ kada nije povezan sa kursem";
...
$langFromHomepageWithoutLogin = "sa po&#269;etne stranice &#269;ak i bez autentifikacije";
$langSiteReservedToPeopleInMemberList = "dostupno samo osobama sa liste korisnika";
$langCode = "Šifra";
$langUsers = "Korisnici";
$langLanguage = "Jezik";
...
$langOfficialCode = "Šifra korisnika";
$langFirstName = "Ime";
...
$langAtLeastOneUser = "Morate da selektujete bar jednog korisnika!";
...
$langConfTip = "Svaki kurs po kreiranju je javni, ali Vi možete definisati nifo poverljivosti gore.";
$Tool = "alat";
...
$UserRolesRights = "Uloge i prava korisnika";
$ManageRoles = "Upravljanje ulogama";
$RolesRightsOverview = "Pregled uloga i prava";
$SeeAllRightsAllLocationsForSpecificRole = "Sva prava i lokacije specifi&#269;nih uloga";
