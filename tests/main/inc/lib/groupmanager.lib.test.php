...
class TestGroupManager extends UnitTestCase
{
    ...
    public function testCreateCategory()
    {
        ...
        $res = GroupManager::create_category(
            $categ['title'],
            $categ['description'],
            $categ['doc_state'],
            $categ['work_state'],
            $categ['calendar_state'],
            $categ['announcements_state'],
            $categ['forum_state'],
            $categ['wiki_state'],
            $categ['chat_state'],
            $categ['self_registration_allowed'],
            $categ['self_unregistration_allowed'],
            $categ['maximum_number_of_students'],
            $categ['groups_per_user']
        );
        $this->assertTrue(is_numeric($res));
        //var_dump($res);
    ...
    public function testUpdateCategory()
    {
        ...
        $res = GroupManager::update_category(
            $categ['id'],
            $categ['title'],
            $categ['description'],
            $categ['doc_state'],
