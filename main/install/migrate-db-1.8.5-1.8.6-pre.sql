...
ALTER TABLE survey ADD one_question_page bool NOT NULL default 0;
ALTER TABLE survey ADD shuffle bool NOT NULL default 0;
ALTER TABLE survey ADD version varchar(20) NOT NULL default '';
ALTER TABLE survey ADD parent_id int NOT NULL default 0;
ALTER TABLE survey ADD type bool NOT NULL default 0;
ALTER TABLE survey_question ADD cond_group_basic int unsigned NOT NULL default 0;
ALTER TABLE survey_question ADD cond_group_sec1 int unsigned NOT NULL default 0;
ALTER TABLE survey_question ADD cond_group_sec2 int unsigned NOT NULL default 0;
CREATE TABLE survey_group (  id int unsigned NOT NULL auto_increment, name(20) NOT NULL, description(200) NOT NULL,  survey_id int unsigned NOT NULL, PRIMARY KEY  (id) );
