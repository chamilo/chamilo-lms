...
$Options = "Opciones";
$WelcomeOogieConverter = "Bienvenido al conversor de PowerPoint Oogie<br>1. Examine su disco duro y busque cualquier archivo con las extensiones *.ppt o *.odp<br>2. Envíelo a Oogie, que lo transformará en un vizualizador de Lecciones Scorm.<br>3.  Podrá añadir comentarios de audio";
...
$HelpDefaultDirDocuments = "Este directorio contiene los archivos suministrados por defecto. Puede eliminar o añadir otros archivos, pero si un archivo está oculto cuando es insertado en un documento web los estudiantes tampoco podrán verlo aquí. Cuando inserte un archivo en un docu";
$HelpSharedFolder = "Este directorio contiene los archivos que los estudiantes (y Ud.) envían a un curso a través del editor si no lo hacen desde la herramienta grupos. Por defecto serán visibles por cualquier profesor, pero estarán ocultos para otros estudiantes salvo que ac";
