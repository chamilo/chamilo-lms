...
('hide_scorm_export_link', NULL, 'radio', 'Course', 'true', 'HideScormExportLinkTitle', 'HideScormExportLinkComment', NULL, NULL, 1),
...
('allow_session_course_copy_for_teachers', NULL, 'radio', 'Session', 'true', 'AllowSessionCourseCopyForTeachersTitle', 'AllowSessionCourseCopyForTeachersComment', NULL, NULL, 1),
('hide_logout_button', NULL, 'radio', 'Platform', 'false', 'HideLogoutButtonTitle', 'HideLogoutButtonComment', NULL, NULL, 1),
('redirect_admin_to_courses_list', NULL, 'radio', 'Platform', 'true', 'RedirectAdminToCoursesListTitle', 'RedirectAdminToCoursesListComment', NULL, NULL, 1),
...
('document_if_file_exists_option', NULL, 'radio', 'Tools', 'overwrite', 'DocumentDefaultOptionIfFileExistsTitle', 'DocumentDefaultOptionIfFileExistsComment', NULL, NULL, 1),
...
('gravatar_enabled', NULL, 'radio', 'Platform', 'true', 'GravatarPicturesTitle', 'GravatarPicturesComment', NULL, NULL, 1),
