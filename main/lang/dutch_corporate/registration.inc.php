...
$langCourseName = "Naam van de module";
$langSubscribe = "Registreer";
$langSee = "Ga naar";
$langLastVisits = "Mijn laatste bezoeken";
$langIfYouWantToAddManyUsers = "Om een lijst van gebruikers aan uw module toe te voegen moet u een beheerder contacteren.";
$langPassTooEasy = "Dit wachtwoord is te eenvoudig. Kies een ander zoals bv. ";
$langGroupUserManagement = "Groepenbeheer";
$langAddedToCourse = "is nu geregistreerd voor uw module";
$langUserAlreadyRegistered = "Er is al een gebruiker met dezelfde naam en voornaam ingeschreven voor deze module. U kan deze gebruiker niet voor een tweede keer inschrijven.";
...
$langAddHereSomeCourses = "<font size=2 face=\'arial, helvetica\'><big>Mijn modules</big><br /><br />Duid de modules aan die u wenst te volgen en degene die u niet meer wenst te volgen (niet mogelijk voor de modules waarvan u beheerder bent). Klik dan op \'Ok\' onder de lijst.";
$langStudent = "gebruiker";
$langImportUserList = "Importeer een lijst van gebruikers";
$langAddAU = "Gebruikers toevoegen";
$langAddedU = "werd toegevoegd. Indien u zijn adres ingetikt hebt, zal de gebruiker een bericht krijgen met zijn gebruikersnaam.";
$langTheU = "De gebruiker";
$langRegYou = "heeft u ingeschreven op";
$langOneResp = "Een van de verantwoordelijken voor de Chamilomodule";
...
$langNowGoCreateYourCourse = "U kunt nu verdergaan om uw module aan te maken.";
$langNowGoChooseYourCourses = "U mag nu in de lijst de modules selecteren die u wenst te gebruiken.";
...
$langRegAdmin = "Modules aanmaken";
$langRegStudent = "Registreren voor modules";
...
$langIsTutor = "Leraar";
$langParamInTheCourse = "Rol binnen de module";
$langMember = "lid";
$langLock = "gesloten";
$langUnlock = "open";
$langHaveNoCourse = "geen module";
...
$langCourses4User = "Modules voor deze gebruiker";
$langCoursesByUser = "Modules van gebruiker";
$langSubscribeUserToCourse = "Schrijf gebruikers in in uw module";
...
$ProgressIntroduction = "Start met het kiezen van een sessie.<br />U kunt daarna uw vooruitgang volgen voor alle modules waarvoor u ingeschreven bent.";
$Select = "Kies";
...
$SubscribeUserToCourseAsTeacher = "Schrijf de gebruikers in deze module in als begeleider";
