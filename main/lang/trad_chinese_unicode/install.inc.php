...
$DokeosNeedFollowingOnServer = "要讓 Dokeos 運作，你的伺服器需要以下條件";
$WarningExistingDokeosInstallationDetected = "警告！<br />安裝器發現你的系統中已有一個 Dokeos 平台";
$NewInstallation = "新安裝";
...
$DirectoryAndFilePermissionsInfo = "執行某些 Dokeos 功能(如：學生上載檔案、首頁 html 檔...)時，部份目錄及其中的檔案須設定為可寫入。你或須要於你的伺服器上(本平台以外)進行手動設定。";
$NotWritable = "不可寫入";
$Writable = "可寫入";
$ExtensionLDAPNotAvailable = "LDAP 擴充套件未啟用";
$ExtensionGDNotAvailable = "GD 擴充套件未啟用 ";
$DokeosLicenseInfo = "Dokeos 是根據 GNU 通用公共許可證 (GPL) 條款發佈的免費軟體。";
$IAccept = "我接受";
