...
$HelpCookieUsageValidation = "Para que este local para trabalhar e ser capaz de medir o uso do conteúdo, esta plataforma usa cookies. <br/> <br/>\N Se necessário, a seção de Ajuda do navegador indica como configurar cookies. <br/> <br/>\nPara obter mais informações sobre cookies, você pode visitar o site <a href=\"http://www.aboutcookies.org/\"> Sobre cookies</a>.";
...
$Post = "Postar";
$Write = "Escrever";
$YouHaveNotYetAchievedSkills = "Você ainda não habilidades alcançar";
$Corn = "Milho";
$Gray = "Cinza";
...
$PleaseSubscribeMeToSession = "Por favor, considere me subscrever a sessão";
...
$AnswerVariations = "variações Pergunta";
...
$MobilePhoneNumberWrong = "Número de telemóvel está incompleto ou contém caracteres inválidos";
$CountryDialCode = "Incluir o código de discagem país";
$FieldTypeMobilePhoneNumber = "Número de telemóvel";
...
$ExerciseAverageInfo = "Média de melhores qualidades de cada tentativa de exercício";
...
$FirstAccessWasXSessionDurationYEndDateInZDays = "Este primeiro acesso do usuário para a sessão foi sobre %s. Com uma duração de sessão %s dias, a data de término está programado em %s dias.";
...
$TeacherXInSession = "Mestre em sessão: %s";
$DeleteAttachment = "Acessório Excluir";
...
$HumanResourcesManagerShouldNotBeRegisteredToCourses = "gestores de recursos humanos não devem ser registrados para cursos aos usuários correspondentes selecionadas não foram subscritas..";
$CleanAndUpdateCourseCoaches = "treinadores Limpo e cursos de atualização";
...
$DocumentsAdded = "Documentos acrescentado";
$NoUsersToAdd = "Não há utilizadores para adicionar";
...
$ShowSystemFolders = "Mostrar pastas de chamilo.";
...
$LoginDate = "Data de Entrada";
$ChooseStartDateAndEndDate = "Escolha datas de início e de fim";
$TestFeedbackNotShown = "Este teste é configurado para não mostrar feedback aos alunos Comentários não será visto no final do teste, mas pode ser útil para você, como professor, ao rever os detalhes das perguntas..";
$WorkAdded = "Trabalho acrescentado";
$FeedbackDisplayOptions = "Como devemos mostrar o feedback / comentário para cada questão? Esta opção define a forma como ele será mostrado para o aluno quando fazer o teste. Nós recomendamos que você tente diferentes opções, editando suas opções de teste antes de ter alunos tomá-lo.";
$InactiveUsers = "Usuários que está conta foi desativada";
$ActiveUsers = "Os usuários com uma conta ativa";
...
$NoSurveysAvailable = "Não há inquéritos disponíveis";
$DescriptionCopySurvey = "Duplicar uma cópia levantamento vazio em outro curso. Você precisa de 2 cursos para usar esta ferramenta: um curso original e um curso de destino.";
$CopySurvey = "Levantamento da Copia";
$ChooseSession = "Por favor, escolha uma sessão";
$SearchSession = "Sessões de pesquisa";
$ChooseStudent = "Por favor, escolha um aluno";
$SearchStudent = "Usuários da pesquisa";
$ChooseCourse = "Por favor, escolher um curso";
...
$DisplayTeacherInCourselistTitle = "Professor de exibição no nome do curso";
$DisplayTeacherInCourselistComment = "Professor de exibição na lista de cursos";
...
$DisplaySessionOverview = "visão geral Sessions";
...
$DateFormatLongNoDayJS = "MM DD, AA";
