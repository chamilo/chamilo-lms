        ...
        <div class="row">
            <div class="col-md-2">
                {% if session_category.show_actions %}
                    <a href="{{ _p.web_main ~ 'session/session_category_edit.php?id=' ~ session_category.id }}" class="thumbnail">
                        <img src="{{ "sessions_category.png"|icon(48) }}" width="48" height="48" alt="{{ session_category.title }}" title="{{ session_category.title }}">
                    </a>
                {% else %}
                    <img src="{{ "sessions_category.png"|icon(48) }}" width="48" height="48" alt="{{ session_category.title }}" title="{{ session_category.title }}">
                {% endif %}
