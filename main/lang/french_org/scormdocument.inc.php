...
/*
      +----------------------------------------------------------------------+
      | CLAROLINE version 1.3.0 $Revision: 1996 $                            |
      +----------------------------------------------------------------------+
      | Copyright (c) 2001, 2002 Universite catholique de Louvain (UCL)      |
      +----------------------------------------------------------------------+
      |   $Id: scormdocument.inc.php 1996 2004-07-07 14:53:05Z olivierb78 $         |
      +----------------------------------------------------------------------+
...
// DOCUMENT
$langDoc="Parcours";
$langBuilder="Cr&eacute;er un parcours";
$langDoc="Parcours";
$langDownloadFile= "Transférer un ZIP SCORM (1.2 ou 1.3) ou IMS";
$langDownload="Transf&eacute;rer";
$langScormBuilder="Cr&eacute;er un parcours";
$learning_path_access="Pour cr&eacute;er/modifier/montrer/cacher ou ajouter un parcours, cliquez sur Cr&eacute;er un parcours";
...
$langScormcontent="Ceci est un espace Scorm<br><input type=button name=scormbutton value='Exécuter' onclick='openscorm()'>";
$langScormcontentstudent="Ceci est un espace au format Scorm. Si vous souhaitez le lancer, cliquez ici : <input type=button name=scormbutton value='Exécuter' onclick='openscorm()'>";
