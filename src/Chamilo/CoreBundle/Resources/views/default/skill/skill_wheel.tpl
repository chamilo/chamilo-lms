{% include app.template_style ~ '/skill/skill_wheel.js.tpl' %}
        ...
        <div class="span3">
            <div class="well sidebar-nav-skill-wheel">
                ...
                <form id="skill_search" class="form-search">
                    ...
                    <br /><br />
                    <div class="btn-group">
                        <a class="btn load_root" rel="0" href="#">{{ "SkillRoot"|trans }}</a>
                        <!-- <a id="clear_selection" class="btn">{{ "Clear"|trans }}</a> -->
                    </div>
                ...
                <div class="page-header">
                    <h3>{{ 'ProfileSearch'|trans }}</h3>
                </div>
                {{ 'WhatSkillsAreYouLookingFor'|trans }}

                <ul id="profile_search" class="holder holder_simple">
                </ul>

                <form id="search_profile_form" class="form-search">
                    <input class="btn" type="submit" value="{{ "SearchProfileMatches"|trans }}">
                </form>

                <div id="profile-options-container" style="display:none">
                    {{ 'IsThisWhatYouWereLookingFor'|trans }}
                    <form id="save_profile_form_button" class="form-search">
                        <input class="btn" type="submit" value="{{ "SaveThisSearch"|trans }}">
                    </form>
                </div>
                ...
                <span class="label label-warning">{{ "SkillsYouCanLearn"|trans }}</span><br /><br />
                <span class="label label-important">{{ "SkillsSearchedFor"|trans }}</span><br /><br />
                <div><a class="btn btn-small" href="{{ _p.web }}user_portal.php">{{ "ReturnToCourseList"|trans }}</a></div>
            </div>
        </div>
...
<div id="dialog-form" style="">
    ...
    <form id="add_item" class="form-horizontal"  name="form">
        <fieldset>
            ...
            <div class="control-group">
                <label class="control-label">{{ 'ShortCode' | trans }}</label>
                <div class="controls">
             ...
             <div id="skill_row" class="control-group">
                <label class="control-label" for="name">{{'Parent'|trans}}</label>
                <div class="controls">
            ...
            <div id="gradebook_row" class="control-group">
                <label class="control-label" for="name">{{'Gradebook'|trans}}</label>
                <div class="controls">
