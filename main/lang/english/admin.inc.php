...
$DisplayTeacherInCourselistTitle = "Display trainer in training title";
...
$langImportUserListXMLCSV = "Import users";
...
$langAllowCoursesInCategory = "Allow the addition of trainings in this category ?";
...
$langStatOf = "Assessment Information for";
...
$SiteNameTitle = "Dokeos Portal Title";
...
$ShowStudentViewComment = "Enable User View?<br>This feature allows the trainer to see using the student view.";
...
$DropboxAllowStudentToStudentComment = "Allow userss to send documents to other users (peer 2 peer, P2P exchange). Users might use this for less relevant documents also (mp3, solutions, ...). If you disable this then the user can only send documents to the trainer.";
...
$GradebookActivation = "Assessment tool activation";
...
$CannotDeleteUserBecauseOwnsCourse = "This user cannot be deleted because he is still trainer in a course. You can either remove his trainer status from these trainings and then delete his account, or disable his account instead of deleting it.";
$AllowUsersToCreateCoursesTitle = "Allow non admin to create courses";
$AllowUsersToCreateCoursesComment = "Allow non administrators (trainer) to create new trainings in the portal";
