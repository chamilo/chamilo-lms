...
$langKwHelp = "<br/>Haga clic en el botón \'+\' para abrir, en el botón \'-\' para cerrar, en el botón \'++\' para abrir todo, en el botón \'--\' para cerrarlo todo.<br/>
Anule la selección de todas las palabras clave cerrando el árbol y abriéndolo de nuevo con el botón \'+\'.<br/>
Alt-clic \'+\' busca las palabras claves originales en el árbol.<br/><br/>Alt-clic selecciona las palabras clave sin términos más amplios o anula la selección de palabras clave con términos más amplios.<br/><br/>Si cambia de idioma de descripción, no podrá añadir palabras clave al mismo tiempo.<br/><br/>
";
