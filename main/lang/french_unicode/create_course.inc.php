...
$langCourseDescription = "Ecrivez ici la description qui apparaîtra dans le catalogue des cours (Le contenu de ce champ ne s\'affiche actuellement nulle part et ne se trouve ici qu\'en préparation à une version prochaine de Chamilo).";
