...
$strings['tour_home_topbar_logo_title'] = '平台标志';
$strings['tour_home_topbar_logo_content'] = '此标志会带你返回平台首页。';
$strings['tour_home_topbar_actions_title'] = '快捷操作';
$strings['tour_home_topbar_actions_content'] = '这里可以看到快捷图标，例如创建课程、引导帮助、工单和消息，具体取决于你的角色。';
$strings['tour_home_menu_button_title'] = '菜单按钮';
$strings['tour_home_menu_button_content'] = '使用此按钮可快速打开或关闭侧边菜单。';
$strings['tour_home_sidebar_title'] = '主菜单';
$strings['tour_home_sidebar_content'] = '此侧边菜单可根据你的权限访问平台的主要部分。';
$strings['tour_home_user_area_title'] = '用户区域';
$strings['tour_home_user_area_content'] = '你可以在这里访问个人资料、个人选项并退出登录。';
