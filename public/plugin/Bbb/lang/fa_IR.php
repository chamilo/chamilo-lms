...
$strings['Review meetings, recordings and available actions.'] = 'بررسی جلسات، ضبط‌ها و اقدامات موجود.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'فایل‌های PDF یا PPTX مورد نظر برای بارگذاری پیش‌فرض به‌عنوان اسلاید کنفرانس را انتخاب کنید.';
$strings['Max total: %d MB'] = 'حداکثر مجموع: %d مگابایت';
$strings['Pre-upload Documents'] = 'بارگذاری پیش‌فرض اسناد';
$strings['No documents found'] = 'هیچ سندی یافت نشد';
$strings['Failed to load documents'] = 'بارگذاری اسناد ناموفق بود';
$strings['No meetings or recordings are available yet.'] = 'هنوز هیچ جلسه یا ضبطی در دسترس نیست.';
$strings['Share the conference link with allowed participants.'] = 'لینک کنفرانس را با شرکت‌کنندگان مجاز به اشتراک بگذارید.';
$strings['presentation'] = 'ارائه';
$strings['video'] = 'ویدیو';
$strings['WebhooksDashboard'] = 'داشبورد وب‌هوک‌ها (سراسری)';
$strings['MeetingTitleContains'] = 'عنوان جلسه شامل';
$strings['FromUTC'] = 'از (UTC)';
$strings['ToUTC'] = 'تا (UTC)';
$strings['OnlyOnlineRows'] = 'فقط ردیف‌های آنلاین';
$strings['AllMeetings'] = 'همه جلسات';
$strings['Apply'] = 'اعمال';
$strings['ExportCSV'] = 'خروجی CSV';
$strings['AutoRefresh10s'] = 'به‌روزرسانی خودکار (۱۰ ثانیه)';
$strings['ActiveMeetings'] = 'جلسات فعال';
$strings['ConnectedNow'] = 'در حال اتصال';
$strings['JoinsToday'] = 'پیوستن امروز';
$strings['Events24h'] = 'رویدادها (۲۴ ساعت)';
$strings['OnlineTime'] = 'زمان آنلاین';
$strings['Conversation'] = 'گفتگو';
$strings['CameraShare'] = 'اشتراک‌گذاری دوربین';
$strings['Messages'] = 'پیام‌ها';
$strings['Reactions'] = 'واکنش‌ها';
$strings['Hands'] = 'دست‌ها';
$strings['Results'] = 'نتایج';
$strings['Status'] = 'وضعیت';
$strings['Joined'] = 'پیوسته';
$strings['Last'] = 'آخرین';
$strings['Running'] = 'در حال اجرا';
$strings['Finished'] = 'پایان‌یافته';
$strings['UsersColon'] = 'کاربران:';
$strings['OnlineColon'] = 'آنلاین:';
$strings['TalkColon'] = 'صحبت:';
$strings['CameraColon'] = 'دوربین:';
$strings['Updated'] = 'به‌روزرسانی‌شده';
$strings['FirstJoin'] = 'اولین پیوستن';
$strings['LastSeen'] = 'آخرین مشاهده';
$strings['Totals'] = 'مجموع';
$strings['Talking'] = 'در حال صحبت';
$strings['User'] = 'کاربر';
