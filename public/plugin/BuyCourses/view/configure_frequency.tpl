        ...
        {% for frequency in frequencies_list %}
            <tr class="sale-row">
                ...
                <div class="btn-group btn-group-xs" role="group" aria-label="...">
                    <a title="{{ 'DeleteFrequency'|get_plugin_lang('BuyCoursesPlugin') }}" href="{{ url('index') ~ 'plugin/BuyCourses/src/configure_frequency.php?' ~ {'action': 'delete_frequency', 'd': frequency.duration, 'n': frequency.name}|url_encode }}"
