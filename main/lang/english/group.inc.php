...
$langStudentRegAllowed = "Learners are allowed to self-register to groups";
$langGroupAllowStudentUnregistration = "Learners are allowed to unregister themselves from groups";
