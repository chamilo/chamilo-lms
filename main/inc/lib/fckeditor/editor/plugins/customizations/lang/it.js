...
FCKLang['BrowseServer']       = 'Cerca sul server' ;
FCKLang['Folder']             = 'Cartella' ;
FCKLang['CreateNewFolder']    = 'Crea una cartella' ;
FCKLang['UploadFile']         = 'Carica il file' ;
FCKLang['Upload']             = 'Carica' ;
FCKLang['UploadSelectFileFirst'] = 'Per favore, scegli un file prima di premere il pulsante di per caricarlo.' ;

FCKLang['ResourceTypeRoot']   = 'Root' ;
FCKLang['ResourceTypeAudio']  = 'Audio' ;
FCKLang['ResourceTypeFlash']  = 'Flash' ;
FCKLang['ResourceTypeImages'] = 'Immagini' ;
