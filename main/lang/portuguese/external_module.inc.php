...
$langExplanation = "A página deve estar em formato HTML (p. e. \\"my_page.htm\\"). Será acessível através duma link/ligação na página inicial. Se desejar enviar documentos que não sejam HTML (PDF, Word, Power Point, Vídeo, etc.) utilize a <a href=../document/document.php>ferra";
