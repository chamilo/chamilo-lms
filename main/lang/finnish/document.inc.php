...
$Options = "Vaihtoehdot";
$WelcomeOogieConverter = "Tervetuloa Oogie PowerPoint muuntimeen<ul type=\\"1\\"><li>Hae kovalevyltä .ppt tai .odp tiedosto<li>Lataa se Oogieen. Se muunnetaan Scorm oppimispoluksi.<li>Voit sen jälkeen lisätä äänikommentteja jokaiseen diaan ja lisätä harjoituksia ja testejä diojen vä";
