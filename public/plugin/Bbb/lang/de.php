...
$strings['NoRecording'] = 'Keine Aufnahme';
...
$strings['MeetingTitleContains'] = 'Meeting-Titel enthält';
$strings['FromUTC'] = 'Von (UTC)';
$strings['ToUTC'] = 'Bis (UTC)';
$strings['OnlyOnlineRows'] = 'Nur Online-Einträge';
$strings['AllMeetings'] = 'Alle Meetings';
$strings['Apply'] = 'Anwenden';
$strings['ExportCSV'] = 'CSV exportieren';
$strings['AutoRefresh10s'] = 'Automatische Aktualisierung (10s)';
$strings['ActiveMeetings'] = 'Aktive Meetings';
$strings['ConnectedNow'] = 'Aktuell verbunden';
$strings['JoinsToday'] = 'Eintritte heute';
$strings['Events24h'] = 'Ereignisse (24h)';
$strings['OnlineTime'] = 'Online-Zeit';
$strings['Conversation'] = 'Gespräch';
$strings['CameraShare'] = 'Kamera-Freigabe';
$strings['Messages'] = 'Nachrichten';
$strings['Reactions'] = 'Reaktionen';
$strings['Hands'] = 'Handzeichen';
$strings['Results'] = 'Ergebnisse';
$strings['Status'] = 'Status';
$strings['Joined'] = 'Beigetreten';
$strings['Last'] = 'Zuletzt';
$strings['Running'] = 'Läuft';
$strings['Finished'] = 'Beendet';
$strings['UsersColon'] = 'Benutzer:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Gespräch:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Aktualisiert';
$strings['FirstJoin'] = 'Erster Beitritt';
$strings['LastSeen'] = 'Zuletzt gesehen';
$strings['Totals'] = 'Gesamt';
$strings['Talking'] = 'Gespräch';
