...
$langCourseVisibilityClosed = "Popolnoma zaprt; tečaj je dostopen le upravniku tečaja.";
...
$langDescriptionCopyCourse = "Chamilo uvaja možnost podvojevanja vsebin celotnega ali dela obstoječega te&#269;aja v nek drug tečaj, ki je prvotno lahko prazen.<br><br>Edina predpogoja za prepis vsebin sta, da obstaja tečaj za prepis, ki vsebuje npr. nekaj dokumentov, vaj, forumov, ..";
$DescriptionRecycleCourse = "To orodje odstrani iz tečaja izbrane elemente ali vse elemente, ki jih tečaj vsebuje. Odstrani dokumente, forume, povezave, ... Izvedba te procedure se običajno upoabi po zaključku tečaja ali ob koncu akademskega leta. In seveda, pred “recikliranjem” posk";
