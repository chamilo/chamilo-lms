...
$FieldMadeChangeable = "O campo agora pode ser alterado pelo utilizador: o utilizador pode preencher ou modificar o campo ";
$CannotMakeFieldChangeable = "O campo não se pode transformar em alterável";
$FieldMadeUnchangeable = "O campo agora não pode ser alterado: o utilizador não pode preencher ou modificar o campo ";
...
$DefineSessionOptions = "Definir limites de acesso do professor";
...
$EnableSearchComment = "Seleccione \"Sim\" para habilitar esta funcionalidade. Esta aplicação depende da extensão Xapian para PHP, pelo que não funcionará se esta extensão não está instalada no seu servidor, como mínimo a versão 1.x ";
...
$ShowSessionCoachComment = "Mostrar o nome do professor da sessão global dentro da caixa de título da página da listagem de cursos ";
$ExtendRightsForCoachTitle = "Ampliar os direitos do tutor";
$ExtendRightsForCoachComment = "A activação desta opção dará aos tutores as mesmas permissões que tem um professor sobre as ferramentas de autoria ";
$ExtendRightsForCoachOnSurveyComment = "A activação desta opção dará aos tutores o direito de criar e editar questionários";
$ExtendRightsForCoachOnSurveyTitle = "Ampliar as permissões dos tutores nos questionários ";
$CannotDeleteUserBecauseOwnsCourse = "Este utilizador não se pode eliminar porque é docente de um curso ou mais. Pode alterar o seu perfil de docente destes cursos antes de eliminá-lo ou bloquear a sua conta. ";
...
$NoWillDeletePermanently = "Não (os arquivos são eliminados da aplicação e poderão ser recuperados manualmente pelo seu administrador) ";
$SelectAResponsible = "Seleccione um responsavel.";
$ThereIsNotStillAResponsible = "Não existem responsáveis";
$AllowStudentsToBrowseCoursesTitle = "Estudantes pode visualizar o catálogo de cursos ";
...
$MultipleAccessURLs = "Acessos múltiplos de URL";
$SearchShowUnlinkedResultsTitle = "Procura de texto completo: mostrar resultados não hiperligados ";
$SearchShowUnlinkedResultsComment = "No momento de mostrar os resultados da pesquisa de texto completo, como deveria comportar-se o sistema para as ligações que não estão acessíveis para o utilizador actual?";
$SearchHideUnlinkedResults = "Não mostrar";
$SearchShowUnlinkedResults = "Mostrá-los mas sem ligação para o recurso ";
$Templates = "Modelos";
$HideCampusFromPublicDokeosPlatformsList = "Não mostrar o meu campus na lista pública de plataformas Dokeos ";
$EnableVersionCheck = "Activar a verificação das versões.";
$AllowMessageToolTitle = "Activar aplicação de mensagens";
$AllowReservationTitle = "Activar sistema de reservas";
$AllowReservationComment = "O sistema de reservas permite-lhe reservar recursos para as aulas (salas, mesas, livros, ecrãs)";
...
$EditUsersToURL = "Editar utilizadores e URLs";
$AddUsersToURL = "Adicionar utilizadores a uma URL";
$URLList = "Lista de URLs";
$AddToThatURL = "Adicionar utilizadores a esta URL";
$SelectUrl = "Selecione um URL ( endereço )";
$UserListInURL = "Utilizadores registados nesta URL";
