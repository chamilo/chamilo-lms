...
$langDBSettingIntro = "Het installatiescript zal de Chamilodatabank(en) aanmaken. Merk op dat Chamilo standaard meerdere databanken aanmaakt. Als u enkel gebruik kan maken van één databank bij uw hosting provider, dan zal Chamilo niet kunnen werken met meerdere databanken en mo";
...
$DBSettingUpgradeIntro = "Het upgradescript zal de Chamilo database(s) recupereren en updaten. Het script zal hiervoor onderstaande instellingen gebruiken. Aangezien deze software op een grote reeks verschillende systemen draait en niet alle systemen getest zijn, is het aangewezen";
...
$DokeosArtLicense = "De afbeelding en media gallerijen in Chamilo gebruiken afbeelding die afkomstig zijn van Nuvalo, Crystal Clear en Tango. Andere afbeeldingen en media zoals de diagrammen en Flash animaties zijn afkomstig van Wikimedia en van de cursus van Ali Pakdel en De";
