...
$strings['Review meetings, recordings and available actions.'] = 'Toplantıları, kayıtları ve mevcut eylemleri inceleyin.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Konferans için slayt olarak önceden yüklemek istediğiniz PDF veya PPTX dosyalarını seçin.';
$strings['Max total: %d MB'] = 'Maksimum toplam: %d MB';
$strings['Pre-upload Documents'] = 'Belgeleri Önceden Yükle';
$strings['No documents found'] = 'Belge bulunamadı';
$strings['Failed to load documents'] = 'Belgeler yüklenemedi';
$strings['No meetings or recordings are available yet.'] = 'Henüz toplantı veya kayıt bulunmuyor.';
$strings['Share the conference link with allowed participants.'] = 'Konferans bağlantısını izin verilen katılımcılarla paylaşın.';
$strings['presentation'] = 'Sunum';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Webhooks Kontrol Paneli (Genel)';
$strings['MeetingTitleContains'] = 'Toplantı başlığı içerir';
$strings['FromUTC'] = 'Başlangıç (UTC)';
$strings['ToUTC'] = 'Bitiş (UTC)';
$strings['OnlyOnlineRows'] = 'Sadece çevrimiçi satırlar';
$strings['AllMeetings'] = 'Tüm toplantılar';
$strings['Apply'] = 'Uygula';
$strings['ExportCSV'] = 'CSV Dışa Aktar';
$strings['AutoRefresh10s'] = 'Otomatik yenile (10sn)';
$strings['ActiveMeetings'] = 'Aktif toplantılar';
$strings['ConnectedNow'] = 'Şu anda bağlı';
$strings['JoinsToday'] = 'Bugünkü katılımlar';
$strings['Events24h'] = 'Olaylar (24s)';
$strings['OnlineTime'] = 'Çevrimiçi süre';
$strings['Conversation'] = 'Konuşma';
$strings['CameraShare'] = 'Kamera paylaşımı';
$strings['Messages'] = 'Mesajlar';
$strings['Reactions'] = 'Tepkiler';
$strings['Hands'] = 'Eller';
$strings['Results'] = 'Sonuçlar';
$strings['Status'] = 'Durum';
$strings['Joined'] = 'Katıldı';
$strings['Last'] = 'Son';
$strings['Running'] = 'Çalışıyor';
$strings['Finished'] = 'Tamamlandı';
$strings['UsersColon'] = 'Kullanıcılar:';
$strings['OnlineColon'] = 'Çevrimiçi:';
$strings['TalkColon'] = 'Konuşma:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Güncellendi';
$strings['FirstJoin'] = 'İlk katılım';
$strings['LastSeen'] = 'Son görülme';
$strings['Totals'] = 'Toplamlar';
$strings['Talking'] = 'Konuşuyor';
$strings['User'] = 'Kullanıcı';
$strings['No recording'] = 'Kayıt yok';
