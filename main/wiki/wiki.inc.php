...
class Wiki
{
    ...
    **/
    ...
    <?php
        ...
        if(api_is_allowed_to_edit(false,true) || api_is_platform_admin()) {
            ...
            echo '</tr>';
            echo '<tr>';
            echo '<td>'.api_disp_html_area('task', '', '', '', null, array('ToolbarSet' => 'wiki_task', 'Width' => '100%', 'Height' => '200')).'</td>';
            echo '</tr>';
            echo '</table>';
            echo '</div>';
    ...
    */
     ...
     * @param string $action
     */
    function blockConcurrentEditions($userId, $action = null)
    {
