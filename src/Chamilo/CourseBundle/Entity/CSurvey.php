...
class CSurvey
{
     ...
     * @var string
     *
     * @ORM\Column(name="author", type="string", length=20, precision=0, scale=0, nullable=true, unique=false)
     */
    private $author;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="avail_from", type="date", precision=0, scale=0, nullable=true, unique=false)
     */
    private $availFrom;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="avail_till", type="date", precision=0, scale=0, nullable=true, unique=false)
     */
    private $availTill;
     ...
     * @var string
     *
     * @ORM\Column(name="is_shared", type="string", length=1, precision=0, scale=0, nullable=true, unique=false)
     */
    private $isShared;
     ...
     * @var integer
     *
     * @ORM\Column(name="invited", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $invited;
     ...
     * @var string
     *
     * @ORM\Column(name="invite_mail", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $inviteMail;
     ...
     * @var string
     *
     * @ORM\Column(name="reminder_mail", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="mail_subject", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
    private $mailSubject;
     ...
     * @var string
     *
     * @ORM\Column(name="anonymous", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
    private $anonymous;
     ...
     * @var boolean
     *
     * @ORM\Column(name="shuffle", type="boolean", precision=0, scale=0, nullable=false, unique=false)
     */
    private $shuffle;
     ...
     * @var boolean
     *
     * @ORM\Column(name="one_question_per_page", type="boolean", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="survey_version", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="survey_type", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $surveyType;
     ...
     * @var integer
     *
     * @ORM\Column(name="show_form_profile", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="form_fields", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $formFields;
