...
$langDBSettingIntro = "O script de instalación creará a(s) base(s) de datos principal(is) de Chamilo. Por favor, lembre que Clarolinenecesitará crear varias BBDD. Se o seu fornecedor de servizos só lle permite usar unha base de datos, Chamilo non funcionará a non ser que escoll";
...
$DirectoryAndFilePermissionsInfo = "Algúns directorios e os ficheiros que inclúen deben poder ser escritos polo servidor web para poder executar Chamilo (ficheiros enviados polos estudantes, ficheiros html das páxinas,...) Isto podería implicar unha modificación manual no seu servidor (fora";
...
$DBSettingUpgradeIntro = "O programa de actualización recuperará e actualizará as bases de datos de Chamilo. Para realizar isto, o programa utilizará as bases de datos e a configuración definidas debaixo. ¡ Debido a que o noso software funciona nunha ampla gama de sistemas e non f";
$ExtensionMBStringNotAvailable = "Extensión MBString non dispoñible";
$ExtensionMySQLNotAvailable = "Extensión MySQL non dispoñible";
$DokeosArtLicense = "As imaxes e as galerías de medios de Chamilo utilizan imaxes e iconas de Nuvola, Crystal Clear e Tango. Outras imaxes e medios, como diagramas e animacións flash, tomáronse prestadas de Wikimedia e dos cursos de Ali Pakdel e de Denis Hoa co seu consentime";
