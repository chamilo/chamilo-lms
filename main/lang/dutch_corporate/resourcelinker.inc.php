...
$AddToLinks = "Toevoegen aan de links van deze module";
...
$AddAssignmentPage = "Voeg de geüploade gebruikerspublicaties toe aan dit hoofdstuk.";
$Exercise = "Oefening";
$Link = "Link";
$AdValvas = "Ad valvas";
$Document = "Document";
...
$CourseDescription = "Modulebeschrijving";
$Groups = "Groepen";
$Users = "Gebruikers";
$IntroductionTextAdd = "Voeg een pagina toe die een inleiding bevat tot het hoofdstuk.";
$CourseDescriptionAdd = "Voeg een pagina toe die een modulebeschrijving bevat voor dit hoofdstuk.";
