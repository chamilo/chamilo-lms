...
$strings['Review meetings, recordings and available actions.'] = 'Xem lại các cuộc họp, bản ghi và các hành động có sẵn.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Chọn các tệp PDF hoặc PPTX bạn muốn tải trước làm slide cho hội nghị.';
$strings['Max total: %d MB'] = 'Tổng tối đa: %d MB';
$strings['Pre-upload Documents'] = 'Tải trước tài liệu';
$strings['No documents found'] = 'Không tìm thấy tài liệu';
$strings['Failed to load documents'] = 'Không tải được tài liệu';
$strings['No meetings or recordings are available yet.'] = 'Chưa có cuộc họp hoặc bản ghi nào.';
$strings['Share the conference link with allowed participants.'] = 'Chia sẻ liên kết hội nghị với những người tham gia được phép.';
$strings['presentation'] = 'Bai thuyet trinh';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Bảng điều khiển Webhook (Toàn cầu)';
$strings['MeetingTitleContains'] = 'Tiêu đề cuộc họp chứa';
$strings['FromUTC'] = 'Từ (UTC)';
$strings['ToUTC'] = 'Đến (UTC)';
$strings['OnlyOnlineRows'] = 'Chỉ hàng trực tuyến';
$strings['AllMeetings'] = 'Tất cả cuộc họp';
$strings['Apply'] = 'Áp dụng';
$strings['ExportCSV'] = 'Xuất CSV';
$strings['AutoRefresh10s'] = 'Tự động làm mới (10s)';
$strings['ActiveMeetings'] = 'Cuộc họp đang diễn ra';
$strings['ConnectedNow'] = 'Đang kết nối';
$strings['JoinsToday'] = 'Tham gia hôm nay';
$strings['Events24h'] = 'Sự kiện (24h)';
$strings['OnlineTime'] = 'Thời gian trực tuyến';
$strings['Conversation'] = 'Thảo luận';
$strings['CameraShare'] = 'Chia sẻ camera';
$strings['Messages'] = 'Tin nhắn';
$strings['Reactions'] = 'Phản ứng';
$strings['Hands'] = 'Giơ tay';
$strings['Results'] = 'Kết quả';
$strings['Status'] = 'Trạng thái';
$strings['Joined'] = 'Đã tham gia';
$strings['Last'] = 'Lần cuối';
$strings['Running'] = 'Đang chạy';
$strings['Finished'] = 'Đã kết thúc';
$strings['UsersColon'] = 'Người dùng:';
$strings['OnlineColon'] = 'Trực tuyến:';
$strings['TalkColon'] = 'Nói chuyện:';
$strings['CameraColon'] = 'Camera:';
$strings['Updated'] = 'Đã cập nhật';
$strings['FirstJoin'] = 'Tham gia lần đầu';
$strings['LastSeen'] = 'Lần cuối thấy';
$strings['Totals'] = 'Tổng';
$strings['Talking'] = 'Đang nói';
