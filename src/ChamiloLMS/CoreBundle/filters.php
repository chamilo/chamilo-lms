...
use ChamiloLMS\CoreBundle\Component\DataFilesystem\DataFilesystem;
...
/** @var ChamiloLMS\CoreBundle\Framework\Application $app */
$app->before(
    function () use ($app) {
        /** @var Request $request */
        $request = $app['request'];
        ...
        $app['translator'] = $app->share($app->extend('translator', function ($translator, $app) {
            ...
            if ($app['translator.cache.enabled']) {
                ...
                $translationPath = $app['path.base'].'src/ChamiloLMS/Resources/translations/';
