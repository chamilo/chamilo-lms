...
$CourseAccessConfigTip = "Por defecto, o seu curso soamente é accesiblepara vostede, vostede é o único usuario. Se vostede desexa un mínimo de confidencialidade, o más simple é abrira inscripción durante unha semana, pedir ós estudiantes que se inscriban eles mesmos,despois pechar";
...
$langDescriptionCopyCourse = "Chamilo introduce a posibilidade de duplicar todo ou parte dun curso xa existente noutro curso, que pode comezar baleiro.<br><br>A única condición previa para esta xestión consiste en ter un curso que conteña documentos, avisos, foros,... e un segundo cur";
$DescriptionRecycleCourse = "Esta ferramenta baleira o curso dos elementos seleccionados ou todos os elementos que contén. Elimina os documentos, foros, vínculos... Este procedemento pódese levar a cabo ao rematar unha formación ou un ano académico. Por suposto, antes de \\"reciclar\\"";
