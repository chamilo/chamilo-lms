...
$SendLegalSubject = "Your learner contract is ready to be signed";
$SendLegalDescriptionToUrlX = "Hello,

Your tutor sent you your learner contract. You can go sign it following this url: %s";
...
$TermYourProfileIsNotCompleted = "You must first fill your profile to enable the contract validation.";
