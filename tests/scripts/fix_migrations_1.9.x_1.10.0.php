...
Database::query("ALTER TABLE c_forum_thread_qualify CHANGE iid iid INT AUTO_INCREMENT NOT NULL, CHANGE c_id c_id INT NOT NULL, CHANGE id id INT DEFAULT NULL, CHANGE user_id user_id INT NOT NULL, CHANGE qualify qualify DOUBLE PRECISION NOT NULL DEFAULT 0, CHANGE qualify_time qualify_time DATETIME DEFAULT NULL");
...
Database::query("ALTER TABLE c_forum_thread_qualify_log CHANGE iid iid INT AUTO_INCREMENT NOT NULL, CHANGE c_id c_id INT NOT NULL, CHANGE id id INT DEFAULT NULL, CHANGE user_id user_id INT NOT NULL, CHANGE qualify qualify DOUBLE PRECISION NOT NULL DEFAULT 0, CHANGE qualify_time qualify_time DATETIME DEFAULT NULL");
