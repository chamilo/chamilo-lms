...
$NoWritePermissionPleaseReadInstallGuide = "Some files or folders don't have write permissions. To be able to install Chamilo, you should first change their permissions (using CHMOD under Linux). Please read the %s installation guide %s";
