...
$PortalTeachersLimitReached = "Désolé, cette installation de Chamilo est limitée en nombre de d'enseignants, et la limite a été atteinte. Pour augmenter le nombre d'enseignants autorisés sur cette installation, veuillez contacter votre fournisseur ou, si l'option est disponible, passer à un plan supérieur.";
