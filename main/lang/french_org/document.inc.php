...
$langScormcontentstudent="Ceci est un format d'espaces Scorm. Si vous souhaitez le lancer, cliquez ici : <input type=button name=scormbutton value='Exécuter' onclick='openscorm()'>";
...
$langCreatePath="Cr&eacute;er un parcours";
