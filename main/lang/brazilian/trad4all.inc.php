...
$EmailNotificationTemplate = "modelo de notificação e-mail";
...
$DescriptionDeleteCourse = "Clique neste link para uma remoção completa do curso a partir do servidor <br /> <br /> Tenha cuidado, não há rota de volta.";
...
$AddedToLPCannotBeAccessed = "Este exercício foi incluída em um rota de aprendizagem, para que ele não pode ser acessado por estudantes diretamente daqui. Se você quiser colocar o mesmo exercício disponível através da ferramenta de exercícios, por favor, faça uma cópia do exercício atual usando a cópia ícone.";
...
$AllowEmailEditorComment = "Se esta opção estiver ativa, clicando num endereço de email abrirá o editor de e-mail online.";
...
$LearnpathNoNext = "Este é o último objeto de aprendizagem.";
$LearnpathNoPrev = "Este é o primeiro objeto de aprendizagem.";
$LearnpathAddLearnpath = "Criar nova rota de aprendizagem";
$LearnpathEditLearnpath = "Editar learnpath";
...
$SplitStepsPerPage = "Uma página, um rota de aprendizagem";
$SplitStepsPerChapter = "Uma seção, um rota de aprendizagem";
$TakeSlideName = "Use os nomes de slides como curso de aprendizagem nomes de rota";
...
$OpenBadgesTitle = "Chamilo suporta os Emblemas por padrão";
...
$LearningPathGradebookWarning = "Aviso:.. É possível utilizar, no livro de notas, os testes que fazem parte de percursos de aprendizagem Se o próprio rota de aprendizagem já está incluído, este teste pode ser parte do livro de notas já A avaliação caminhos de aprendizagem é feita em com base em uma porcentagem progresso, enquanto a avaliação em testes é feita com base em uma avaliação Inquérito pontuação. baseia-se se o usuário tem respondido (1) ou não (0). Certifique-se de testar suas combinações de avaliações gradebook para evitar situações de microblog mente.";
...
$ExerciseEdited = "nome e as configurações de exame foram salvas.";
...
$CourseCreate = "Criar um curso Online";
$Todo = "Afazeres";
$UserName = "Nome de usuário";
...
$Next = "Avançar";
$Allowed = "Permitido";
$BackHome = "Propostas para uma melhoria da";
...
$ExerciseFinished = "Exame terminado";
$UserSex = "Sex";
$UserNativeLanguage = "língua materna";
$UserResidenceCountry = "País de residência";
$AddAnAttachment = "Adicionar anexo";
$FileComment = "comentário File";
$FileName = "Nome do arquivo";
$SessionsAdmin = "administrador Sessions";
$MakeChangeable = "Faça mutável";
$MakeUnchangeable = "Faça imutável";
$UserFields = "atributos Perfil";
$FieldShown = "O campo agora é visível para o usuário.";
$CannotShowField = "Não é possível tornar o campo visível.";
$FieldHidden = "O campo agora é invisível para o usuário.";
$CannotHideField = "Não é possível tornar o campo invisível";
$FieldMadeChangeable = "O campo é agora substituída pelo usuário: o usuário pode agora preencher ou editar o campo";
$CannotMakeFieldChangeable = "O campo não pode ser feita mutável.";
$FieldMadeUnchangeable = "O campo é feita agora imutável: o usuário não pode preencher ou editar o campo.";
$CannotMakeFieldUnchangeable = "O campo não pode ser feita imutável";
$Folder = "Pasta";
$CloseOtherSession = "O Char não está disponível porque outro treinamento foi aberto em outra página. Para evitar isso, certifique-se de permanecer dentro do mesmo curso para a duração da sua sessão no chat. Para participar da sessão de chat novamente, por favor, re-iniciar o chat a partir da homepage do curso.";
$FileUploadSucces = "O arquivo tenha sido carregado com sucesso.";
$Yesterday = "Ontem";
$Submit = "Enviar";
...
$Invitation = "Convite";
$SeeMoreOptions = "Mais opções";
$TemplatePreview = "preview Template";
$NoTemplatePreview = "Visualização não disponível";
...
$GradebookDescriptionLog = "description Avaliação";
...
$Refresh = "Atualizar";
$SystemAnnouncements = "Anúncios do Chamilo";
$HelpMaj = "Ajuda";
...
$TemplateTitleTextCenteredDescription = "É um texto com uma imagem centrada e lendas";
$TemplateTitleComparison = "Compare";
$TemplateTitleComparisonDescription = "text página 2 colunas";
$TemplateTitleDiagram = "Diagrama explicado";
$TemplateTitleDiagramDescription = "Imagem à esquerda, comentar sobre o direito";
$TemplateTitleImage = "Imagem sozinho";
$TemplateTitleImageDescription = "Imagem sozinho";
$TemplateTitleFlash = "animação Flash";
$TemplateTitleFlashDescription = "Animação + introdução de texto";
$TemplateTitleAudio = "comentário Audio";
$TemplateTitleAudioDescription = "image Audio + + texto: compreensão oral";
$TemplateTitleSchema = "Schema com áudio explicar";
$TemplateTitleSchemaDescription = "Um esquema explicar por um professor";
$TemplateTitleVideo = "página de vídeo";
$TemplateTitleVideoDescription = "vídeo sob demanda + texto";
$TemplateTitleVideoFullscreen = "Video página fullscreen";
$TemplateTitleVideoFullscreenDescription = "vídeo sob demanda em fullscreen";
$TemplateTitleTable = "página Table";
$TemplateTitleTableDescription = "Página Spreadsheet-like";
$TemplateTitleAssigment = "description Assignment";
$TemplateTitleAssigmentDescription = "Explicar objetivos, papéis, agenda";
...
$TemplateTitleGlossaryDescription = "Lista de termo da seção";
...
$Location = "URL/URI";
$LocationTip = "clique para abrir rota";
$Store = "Armazenar";
...
$CleanStudentResults = "clear resultados todos os alunos para este exercício";
...
$here = "aqui";
$GoAheadAndBrowseOurCourseCatalogXOnceRegisteredYouWillSeeTheCourseHereX = "<p> Vá em frente e ver o nosso catálogo de cursos%s para registrar a qualquer curso que você gosta Uma vez cadastrado, você verá o curso aparecerá %s, em vez de esta mensagem </p>..";
$HelloXAsYouCanSeeYourCourseListIsEmpty = "<p> Olá <strong> %s </strong> e bem-vindo,</p>\n<p> Como você pode ver, sua lista de cursos ainda está vazio. Isso é porque você não está registrado para nenhum curso!</p>";
$UnsubscribeUsersAlreadyAddedInCourse = "Desinscrever usuários já adicionaram";
$ImportUsers = "Importar usuários";
$HelpFolderLearningPaths = "informação visível para o professor SOMENTE:. Pasta\nEste contém documentos que são criados pela ferramenta de Aprendizagem Caminho Dentro desta pasta você pode editar o arquivo HTML que são geradas por importar o conteúdo do Caminho de Aprendizagem, como os importados por . Chamilo rápida, por exemplo Recomendamos escondendo essa pasta para seus alunos.";
...
$AssignCoach = "Atribuir treinador";
$chamilo = "Chamilo";
...
$ResetLP = "redefinir a aprendizagem rota";
...
$RedirectToALearningPath = "Redirecionar para um rota de aprendizagem selecionado";
...
$CourseThematicAdvance = "progresso Curso";
...
$CasUserAddEmailAttributeTitle = "Adicionar CAS email do usuário";
...
$ShibbolethMainActivateComment = "<p>Em primeiro lugar, você tem que configurar Shibboleth para o seu servidor web. </p> Para configurá-lo para Chamilo <h5> editar arquivo main/auth  shibboleth /config/aai.class.php</h5> <p> Modificar valores de resultado rota $ com o nome do seu Shibboleth atributos </p> <ul> <li> $ result- & gt; unique_id = 'mail'; </ li> <li> $ result- & gt; nome = 'cn'; </li> <li> $ result- & gt; = lastname 'uid'; </li> <li> $ result- & gt; email = 'mail'; </li> <li> $ resultando & gt; language = '-'; </ li> <li> $ result- & gt; gender = '-'; </ li> <li> $ result- & gt; address = '-'; </li> <li> $ result- & gt; staff_category = '-'; </ li> <li> $ result- & gt; home_organization_type = '-'; </li> <li> $ result- & gt; home_organization = '-'; </li> <li> $ result- & gt; afiliação = '-'; </li> <li> $ result- & gt; persistent_id = '-'; </ li> <li> ... </li> </ul> <br/> Vá para <a href='settings.php?category=Shibboleth'> Plugin </a> para adicionar um botão configurável \"Login Shibboleth\" para o seu campus Chamilo.";
$LdapDescriptionTitle = "Autenticação LDAP";
$FacebookMainActivateTitle = "Autenticação Facebook";
$FacebookMainActivateComment = "Primeiro, deve criar uma aplicação Facebook (ver <a href=\"https://developers.facebook.com/apps\">https://developers.facebook.com/apps</a>) com sua conta de Facebook. Nos parâmetros das aplicações de Facebook, o valor da URL do site deveria ter um parâmetro GET \"action=fbconnect\" (por exemplo, http://mychamilo.com/?action=fbconnect). Depois,<h5>edite o arquivo main/auth/external_login/facebook.conf.php</h5> e insira os valores \"appId\" e \"secret\" para &#36;facebook_config.<br/> Vá para Extensões para adicionar um botão \"Login Facebook\" configurável no seu campus Chamilo.";
...
$Incorrect = "Incorreto";
$YouNotYetAchievedCertificates = "Você não ter conseguido qualquer certificado apenas ainda Continue em seu rota de aprendizagem para obter um.!";
$SearchCertificates = "certificados de pesquisa";
$TheUserXNotYetAchievedCertificates = "Usuário %s tens não adquiriu qualquer certificado ainda";
...
$StudentPublicationSelectionForGradebookTitle = "Atribuição considerado para lançamento de notas";
...
$SendMailToStudent = "Enviar email para o aluno";
$SendMailToHR = "Enviar email para gerente de RH";
...
$Enable = "Ativar";
$Disable = "Desativar";
$AvoidChangingPageAsThisWillCutYourCurrentVideoChatSession = "Evite alterar página como isso irá cortar sua sessão atual do Chat de vídeo conferência.";
