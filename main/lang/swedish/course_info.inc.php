...
$CourseAccessConfigTip = "Som standard kommer din kurs att kunna nås av alla så länge som det är registrerade användare. I händelse av att du har något konfidentiellt, det enklaste är att öppna registrering underen vecka, och be studenterna att de registrerar sig själva, därefter";
...
$langTipLang = "Detta språk gäller för alla som besöker denna kurs.";
$langVid = "Video";
...
$langByDel = "Raderar du denna kurs kommer det att permanent radera alla dokument som den innehåller och avregistrera alla elever. (inte ta bort dem från andra kurser).<p>Vill du verkligen radera denna kurs?";
$langY = "JA";
$langN = "NEJ";
...
$langDescriptionCopyCourse = "I Chamilo finns möjlighet att kopiera en hel eller en del av en kurs till en annan kurs, oftast en tom kurs. Tänk på att inte den kurs man kopierar till får innehålla lika dana objekt (dokument, forum, mm) som orginalkursen.";
