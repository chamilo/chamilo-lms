@administration
Feature: Install portal locally

  Scenario: Local installation process
    ...
    Then I fill in the following:
      | dbUsernameForm | playwright |
      | dbPassForm | playwright |
      | dbNameForm | playwrightchamilo |
    ...
    Then I fill in the following:
      ...
      | mailerFromName  | Chamilo Playwright install |
    Then I press "step5"
    And I wait for the page to be loaded
