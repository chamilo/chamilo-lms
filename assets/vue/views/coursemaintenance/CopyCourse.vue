  ...
  <div class="space-y-6 cm-copy-course">
    ...
    <section v-if="step===1" class="grid grid-cols-1 gap-4 lg:grid-cols-2">
      <div class="rounded-lg border border-gray-25 p-4">
        ...
        <label class="mb-1 block text-xs font-medium text-gray-60">{{ t('Course to copy from') }}</label>
        <div class="space-y-2">
          <div class="relative">
            <input
          ...
          <select v-model="sourceCourseId" class="w-full rounded border border-gray-25 p-2 text-sm">
      ...
      <div class="rounded-lg border border-gray-25 p-4">
        ...
        <div class="space-y-3">
          <label class="flex items-center gap-2">
            <input type="radio" value="full_copy" v-model="copyOption" />
          ...
          <div class="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
            <label class="flex items-center gap-2">
              <input type="checkbox" v-model="includeUsers" />
              <span class="text-sm text-gray-90">{{ t('Include users (enrollments)') }}</span>
            </label>
            <label class="flex items-center gap-2">
              <input type="checkbox" v-model="resetDates" />
      ...
      <div class="col-span-full flex justify-end gap-3">
        ...
        <button class="btn-primary" @click="nextFromStep1" :disabled="loading || !sourceCourseId">
    ...
    <section v-if="step===2" class="space-y-4">
      ...
      <div class="flex justify-between">
        ...
        <button class="btn-primary" @click="doCopy" :disabled="loading">
