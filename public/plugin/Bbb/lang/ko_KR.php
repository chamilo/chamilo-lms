...
$strings['Participants'] = '참여자';
$strings['CountUsers'] = '사용자 수';
$strings['Review meetings, recordings and available actions.'] = '회의, 녹화 및 사용 가능한 작업을 검토합니다.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = '회의 슬라이드로 미리 로드할 PDF 또는 PPTX 파일을 선택하세요.';
$strings['Max total: %d MB'] = '최대 총 용량: %d MB';
$strings['Pre-upload Documents'] = '문서 미리 업로드';
$strings['No documents found'] = '문서를 찾을 수 없습니다';
$strings['Failed to load documents'] = '문서 로드 실패';
$strings['No meetings or recordings are available yet.'] = '아직 사용 가능한 회의나 녹화가 없습니다.';
$strings['Share the conference link with allowed participants.'] = '허용된 참가자와 회의 링크를 공유하세요.';
$strings['presentation'] = '프레젠테이션';
$strings['video'] = '비디오';
$strings['WebhooksDashboard'] = '웹훅 대시보드 (전역)';
$strings['MeetingTitleContains'] = '회의 제목 포함';
$strings['FromUTC'] = '시작 (UTC)';
$strings['ToUTC'] = '종료 (UTC)';
$strings['OnlyOnlineRows'] = '온라인 행만';
$strings['AllMeetings'] = '모든 회의';
$strings['Apply'] = '적용';
$strings['ExportCSV'] = 'CSV 내보내기';
$strings['AutoRefresh10s'] = '자동 새로고침 (10초)';
$strings['ActiveMeetings'] = '진행 중인 회의';
$strings['ConnectedNow'] = '현재 접속';
$strings['JoinsToday'] = '오늘 참여';
$strings['Events24h'] = '이벤트 (24시간)';
$strings['OnlineTime'] = '온라인 시간';
$strings['Conversation'] = '대화';
$strings['CameraShare'] = '카메라 공유';
$strings['Messages'] = '메시지';
$strings['Reactions'] = '반응';
$strings['Hands'] = '손 들기';
$strings['Results'] = '결과';
$strings['Status'] = '상태';
$strings['Joined'] = '참여';
$strings['Last'] = '마지막';
$strings['Running'] = '진행 중';
$strings['Finished'] = '완료';
$strings['UsersColon'] = '사용자:';
$strings['OnlineColon'] = '온라인:';
$strings['TalkColon'] = '발언:';
$strings['CameraColon'] = '카메라:';
$strings['Updated'] = '업데이트됨';
$strings['FirstJoin'] = '처음 참여';
$strings['LastSeen'] = '마지막 확인';
$strings['Totals'] = '합계';
$strings['Talking'] = '발언 중';
$strings['User'] = '사용자';
$strings['No recording'] = '녹화 없음';
