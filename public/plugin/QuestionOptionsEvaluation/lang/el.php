...
$strings['QuizQuestionsScoreRulesTitleConfirm'] = 'Η αλλαγή του τύπου αξιολόγησης δημιουργεί αλλαγές για κάθε ερώτηση στην άσκηση και εμποδίζει την αναίρεση αυτής της αλλαγής παρακάτω. Είστε σίγουροι ότι θέλετε να συνεχίσετε;';
$strings['EvaluationFormula'] = 'Τύπος αξιολόγησης';
$strings['NoFormula'] = 'Χωρίς τύπο';
$strings['Formula1'] = 'Επιτυχίες - Αποτυχίες';
$strings['Formula2'] = 'Επιτυχίες - Αποτυχίες / 2';
$strings['Formula3'] = 'Επιτυχίες - Αποτυχίες / 3';
