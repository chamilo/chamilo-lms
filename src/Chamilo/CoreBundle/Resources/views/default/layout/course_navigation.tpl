        ...
        <script>
            ...
            function swap_menu() {
                ...
                if (toolnavlist_el.style.display == 'none') {
                    ...
                    swap_menu_link_el.innerHTML = '{{'Hide'|trans}}';
                    ...
                    swap_menu_link_el.innerHTML = '{{'Show'|trans}}';
                    createCookie('menu_state',0,10);
                }
            }
            document.write('<div class="span12 pull-right"> <a class="btn" href="javascript: void(0);" id="swap_menu_link" onclick="javascript: swap_menu();">{{'Hide'|trans}}<\/a></div>');
            </script>
