 ...
 * @ExclusionPolicy("all")
 */
class LensProfileChromaticAberrationScale extends AbstractTag
{

    protected $Id = 'LensProfileChromaticAberrationScale';

    protected $Name = 'LensProfileChromaticAberrationScale';
