...
$strings['Review meetings, recordings and available actions.'] = 'Review meetings, recordings and available actions.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Select the PDF or PPTX files you want to pre-load as slides for the conference.';
$strings['Max total: %d MB'] = 'Max total: %d MB';
$strings['Pre-upload Documents'] = 'Pre-upload Documents';
...
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Webhooks Dashboard (Global)';
$strings['MeetingTitleContains'] = 'Meeting title contains';
$strings['FromUTC'] = 'From (UTC)';
$strings['ToUTC'] = 'To (UTC)';
$strings['OnlyOnlineRows'] = 'Only online rows';
$strings['AllMeetings'] = 'All meetings';
$strings['Apply'] = 'Apply';
$strings['ExportCSV'] = 'Export CSV';
$strings['AutoRefresh10s'] = 'Auto-refresh (10s)';
$strings['ActiveMeetings'] = 'Active meetings';
$strings['ConnectedNow'] = 'Connected now';
$strings['JoinsToday'] = 'Joins today';
$strings['Events24h'] = 'Events (24h)';
$strings['OnlineTime'] = 'Online time';
$strings['Conversation'] = 'Conversation';
$strings['CameraShare'] = 'Camera share';
$strings['Messages'] = 'Messages';
$strings['Reactions'] = 'Reactions';
$strings['Hands'] = 'Hands';
