 ...
 * @ExclusionPolicy("all")
 */
class CircGradBasedCorrMaskAlpha extends AbstractTag
{

    protected $Id = 'CircularGradientBasedCorrectionsCorrectionMasksAlpha';

    protected $Name = 'CircGradBasedCorrMaskAlpha';
