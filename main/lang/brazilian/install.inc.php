...
$DirectoryAndFilePermissionsInfo = "Alguns diretorios (pastas) e arquivos neles incluídos devem permitir a escrita pelo servidor web para que o Chamilo possa funcionar corretamente (arquivos enviados pelos estudantes, página html de entrada, ...). Esta operação de alteração das característi";
...
$DBSettingUpgradeIntro = "O script de atualização vai recuperar e atualizar os bancos de dados do Chamilo. Para isso, este script usará as bases de dados e configurações definidas abaixo. Em virtude da diversidade de sistemas em que Chamilo está instalado e porque nem sempre esses";
$ExtensionMBStringNotAvailable = "Extensão MBString não disponível";
$ExtensionMySQLNotAvailable = "Extensão MySQL não disponível";
$DokeosArtLicense = "As imagens e a galeria de mídia do Chamilo são retiradas da galeria de ícones Crystal Clear e Tango. Outras imagens e mídia, tal como diagramas e animações em flash, foram cedidas por Wikimedia e pelos cursos de Ali Pakdel e Denis Hoa com o seu consentime";
