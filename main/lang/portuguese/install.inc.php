...
$langDBSettingIntro = "O script de instalação irá criar a(s) base(s)-de-dados principal(s) do Chamilo. Por favor, tenha em atenção de que o Chamilo necessita de criar várias bases-de-dados. Se apenas tem autorizações para utilizar uma única base-de-dados nos servidores do seu f";
...
$DBSettingUpgradeIntro = "O script de actualização irá recuperar e actualizar as bases-de-dados do Chamilo. Para isso, este script irá utilizar as bases-de-dados e configurações definidas abaixo. Em virtude da diversidade de sistemas em que o Chamilo está instalado e porque nem se";
$ExtensionMBStringNotAvailable = "Extensão MBString não disponível";
$ExtensionMySQLNotAvailable = "Extensão MySQL não disponível";
$DokeosArtLicense = "As imagens e as galerias de media do Chamilo são das galeria de ícones da Nuvola, Crystal Clear e Tango. Outras imagens e media, tal como diagramas e animações em flash, são cedidas pela Wikimedia e pelos cursos de Ali Pakdel e Denis Hoa com o seu consent";
