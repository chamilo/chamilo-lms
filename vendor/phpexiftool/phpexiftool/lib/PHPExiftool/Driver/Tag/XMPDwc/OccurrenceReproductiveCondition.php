 ...
 * @ExclusionPolicy("all")
 */
class OccurrenceReproductiveCondition extends AbstractTag
{

    protected $Id = 'OccurrenceReproductiveCondition';
    ...
    protected $Description = 'Occurrence Reproductive Condition';
