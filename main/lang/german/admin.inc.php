...
$PlatformLanguageComment = "Die Sprache f�r die Plattform kann an anderer Stelle in der Administration eingestellt werden: <a href=\"languages.php\">Dokeos Plattform Sprache</a>";
$PlatformLanguageTitle = "Plattform Sprache";
...
$langPrivate = "Eingeschr�nkter Zugang, Einschreibung geschlossen (Die Seiten sind nur f�r angemeldete <a href=../user/user.php>Teilnehmer</a> zug�nglich.)";
...
$ImageResizeComment = "Benutzer Fotos k�nnen beim Upload in der Gr��e ver�ndert werden, falls PHP mit <a href=\\\"http://php.net/manual/en/ref.image.php\\\" target=\\\"_blank\\\">GD library</a> kompiliert wurde. Sollte DG nicht verf�gbar sein, wird diese Angabe ignoriert.";
...
$VersionCheckExplanation = "Um automatische Versionskontrolle zu nutzen, muss man das Campus bei dokeos.com registrieren. Die weitergegebene Information nach Klicken dieses Buttons dient lediglich internen Zwecken und lediglich Gesamtinformationen werden �ffentlich verf�gbar sein (Anzahl Campus Installationen insgesamt, Anzahl Kurse insgesamt, Anzahl Studenten insgesamt, usw) (vgl. <a href=\"http://www.dokeos.com/stats/\"> http://www.dokeos.com/stats/</a>. Nach der Registrierung erscheint das Campus auch auf der Worldwide List (<a href=\"http://www.dokeos.com/community.php\">http://www.dokeos.com/community.php</a>. 
...
$YesAddCSVHeader = "Ja, den CSV Header hinzuf�gen<br/>Diese Zeile definiert Felder und ist notwendig, wenn man die Datei in ein anderes Dokeos Campus importieren will.";
...
$EphorusDescription = "Beginnen Sie, den Ephorus Anti-Plagiat Dienst in Dokeos zu benutzen. <br/><strong>Mit Ephorus k�nnen Sie Internet Plagiate ohne zus�tzliche Bem�hungen verhindern.</strong><br/> Sie k�nnen unseren einzigartigen Open Standard Webservice benutzen, um ihre eigene Integration zu erstellen oder einen unserer Dokeos Integrationsmodule benutzen.";
$EphorusLeadersInAntiPlagiarism = "<STRONG>F�hrend bei �<br/>Anti Plagiat</STRONG>";
