...
/**
 * Builds the read-only score matrix behind the Vue Gradebook reports.
 *
 * Shared by the report provider, the graph provider and the export controller,
 * which is why it is a helper and not a method of any of them.
 */
