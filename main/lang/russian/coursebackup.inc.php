...
*/
$langSelectOptionForBackup = "Пожалуйста, выберите параметры резервного копирования";
$langLetMeSelectItems = "Позвольте мне выбрать компоненты курса";
$langCreateFullBackup = "Создать полную резервную копию этого курса";
$langCreateBackup = "создать резервную копию (архив)";
$langBackupCreated = "Резервная копия этого курса создана. Загрузка этого файла начнется через несколько секунд. Если загрузка не начинается, щелкните следующую ссылку";
$langSelectBackupFile = "выбрать файл резервной копии";
$langImportBackup = "Импортировать резервную копию";
$langImportFullBackup = "Импортировать всю резервную копию";
$langImportFinished = "Импортирование завершено";
$langEvents = "События";
$langAnnouncements = "Объявления";
$langDocuments = "Документы";
$langTests = "Тесты";
$langLearnpaths = "Учебные планы (программы)";
$langCopyCourse = "Копия курса";
$langSelectItemsToCopy = "Выбрать элементы для копирования";
$langCopyFinished = "Копирование завершено";
$langFullRecycle = "Полное обновление";
$langRecycleCourse = "Обновление курса";
$langRecycleFinished = "Обновление завершено";
$langRecycleWarning = "Предупреждение: используя этот инструмент, Вы удалите некоторые части вашего курса. Ин не возможно будет восстановить. Мы советуем сделать <a href=\"create_backup.php\">резервную копию</a> перед тем как использовать инструмент \"обновление\".";
