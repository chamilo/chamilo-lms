 ...
 * @ExclusionPolicy("all")
 */
class DCMinimumDistanceAboveSurfaceInMeters extends AbstractTag
{

    protected $Id = 'dctermsLocationMinimumDistanceAboveSurfaceInMeters';

    protected $Name = 'DCMinimumDistanceAboveSurfaceInMeters';
