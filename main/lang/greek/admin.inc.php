...
$ExportSession = "Εξαγωγή συνεδριών σε XML/CSV format";
...
$langRealCourseCode = "Πραγματικός κωδικός μαθήματος";
...
$CourseListInSession = "Μαθήματα στην συνεδρία";
...
$ForTheSession = "για την συνεδρία";
...
$CourseListIn = "Μαθήματα στην συνεδρία";
...
$ListSessionCategory = "Λίστα κατηγοριών συνεδριών";
