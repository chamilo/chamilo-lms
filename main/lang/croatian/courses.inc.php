...
$lang_or_search_from_the_course_code = "Ili pretraga prema ifri";
...
$langUnsubscribeNotAllowed = "Nije doputen ispis s kolegija.";
...
$CourseCategoryAbout2bedeleted = "elite li doista izbrisati ovu kategoriju kolegija? Kolegiji unutar ove kategorije bit &#263;e premjeteni izvan postoje&#263;ih kategorija";
$CourseCategories = "Kategorije kolegija";
$CoursesInCategory = "Kolegiji unutar kategorije";
$SearchCourse = "Pretrai kolegije";
$UpOneCategory = "<- Jedna kategorija gore";
$SearchResultsFor = "Rezultati pretrage za:";
$ConfirmUnsubscribeFromCourse = "elite li se sigurno ispisati s kolegija?";
$NoCourseCategory = "Nema kategorije kolegija";
$EditCourseCategorySucces = "Kolegij je dodan kategoriji";
$SubscribingNotAllowed = "Upis nije doputen";
$CourseSortingDone = "Razvrstavanje kolegija dovreno";
...
$ErrorContactPlatformAdmin = "Dogodila se nepoznata pogreka. Molim kontaktirajte upravitelja sustava.";
$CourseRegistrationCodeIncorrect = "ifra kolegija je neispravna";
$CourseRequiresPassword = "Kolegij zahtijeva zaporku";
$SubmitRegistrationCode = "Dostavi registracijsku ifru";
$CourseCategoryDeleted = "Kategorija je obrisana";
$CategorySortingDone = "Razvrstavanje kategorija je zavreno";
