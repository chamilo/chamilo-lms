...
$langModifInfo="Propriétés de l'espace";
...
qu'il contient et désinscrirez tous les membres qui y sont inscrits. <p>Voulez-vous réellement supprimer cet espace";
$langY="OUI";
$langN="NON";
...
$langRestoreDescription="Ce espace se trouve dans une archive que vous pouvez sélectionner ci-dessous.<br><br>
