<div id="sidebar-left" class="col-lg-2 col-sm-1">
    <nav class="nav nav-tabs nav-stacked main-menu">
        <div id="sidebar" class="sidebar-collapse">
            ...
            {# render controller("ChamiloCoreBundle:Front:showCourseSessionBlock") %}
            ...
            {#  Course block - admin #}
            {# render controller("ChamiloCoreBundle:Front:showCourseBlock") %}

            {#  Course block - teacher #}
            {# render controller("ChamiloCoreBundle:Front:showTeacherBlock") %}

            {#  Session block #}
            {# render controller("ChamiloCoreBundle:Front:showSessionBlock") %}

            {# render controller("ChamiloCoreBundle:Front:showNoticeBlock") %}

            {# render controller("ChamiloCoreBundle:Front:showHelpBlock") %}

            {% render controller("ChamiloCoreBundle:Front:showNavigationBlock") %}

            {% render controller("ChamiloCoreBundle:Front:showSkillsBlock") %}
