...
$langWarningResponsible  = "Use este script únicamente tras haber hecho una copia de seguridad. El equipo de Chamilo no es responsable si usted pierde o estropea sus datos.";
...
$langSingleDb = "Use una o varias bases de datos para Chamilo";
...
$DokeosNeedFollowingOnServer = "Para que Chamilo funcione, necesita de lo siguiente en el servidor";
$WarningExistingDokeosInstallationDetected = "Atención !<br>El instalador ha detectado una instalación previa de Chamilo en su sistema.";
...
$DirectoryAndFilePermissionsInfo = "Algunos directorios y los archivos que contienen deben tener permisos de escritura en el servidor web para que Chamilo pueda funcionar (archivos subidos por estudiantes, archivos html,...). Esto puede suponer un cambio manual en su servidor (debe realizarse fuera de esta interfaz).";
...
$DokeosLicenseInfo = "Chamilo es un software libre distribuido bajo licencia GNU General Public licence (GPL)";
$IAccept = "Acepto";
