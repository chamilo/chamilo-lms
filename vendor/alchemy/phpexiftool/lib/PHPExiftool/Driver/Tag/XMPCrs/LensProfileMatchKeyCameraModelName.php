 ...
 * @ExclusionPolicy("all")
 */
class LensProfileMatchKeyCameraModelName extends AbstractTag
{

    protected $Id = 'LensProfileMatchKeyCameraModelName';

    protected $Name = 'LensProfileMatchKeyCameraModelName';
