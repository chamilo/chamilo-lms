...
class CssParser
{
    ...
    public function add($key, $codestr): void
    {
        $key = strtolower($key);
    ...
    public function get($key, $property)
    {
        ...
        foreach ($this->css as $_tag => $value) {
            ...
            $tagmatch = (0 == strcmp($tag, $_tag)) | (0 == \strlen($_tag));
            $subtagmatch = (0 == strcmp($subtag, $_subtag)) | (0 == \strlen($_subtag));
            $classmatch = (0 == strcmp($class, $_class)) | (0 == \strlen($_class));
    ...
    private function assignValues($arr, &$val1, &$val2): void
    {
        $n = \count($arr);
        if ($n > 0) {
            $val1 = $arr[0];
