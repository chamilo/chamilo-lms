...
$strings['CertificateMode'] = 'מצב תעודה';
$strings['UseCourseCustomCertificate'] = 'השתמש בתעודה מותאמת אישית לקורס';
$strings['UseDefaultCustomCertificate'] = 'השתמש בתעודה מותאמת אישית ברירת מחדל של הפלטפורמה';

$strings['CreateCertificateWithTags'] = 'צור את התעודה באמצעות התגים הבאים';

$strings['DeleteCertificate'] = 'מחק תעודה';

$strings['SaveCertificate'] = 'שמור תעודה';

$strings['SelectOneOptionBeforeOpeningEditor'] = 'בחר אפשרות אחת ושמור הגדרות לפני פתיחת עורך התעודות.';

$strings['ChooseCustomCertificateModeHelp'] = 'בחר כיצד קורס זה אמור להשתמש בתעודות מותאמות אישית.';

$strings['CouldNotSaveCertificate'] = 'לא ניתן היה לשמור את תצורת התעודה.';
