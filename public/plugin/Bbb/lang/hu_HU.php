...
$strings['Review meetings, recordings and available actions.'] = 'Tekintse át az értekezleteket, felvételeket és elérhető műveleteket.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Válassza ki a PDF vagy PPTX fájlokat, amelyeket diaként szeretne előtölteni a konferenciához.';
$strings['Max total: %d MB'] = 'Maximális összesen: %d MB';
$strings['Pre-upload Documents'] = 'Dokumentumok előfeltöltése';
$strings['No documents found'] = 'Nem található dokumentum';
$strings['Failed to load documents'] = 'Nem sikerült betölteni a dokumentumokat';
$strings['No meetings or recordings are available yet.'] = 'Még nincsenek elérhető értekezletek vagy felvételek.';
$strings['Share the conference link with allowed participants.'] = 'Ossza meg a konferencia hivatkozását az engedélyezett résztvevőkkel.';
$strings['presentation'] = 'Prezentacio';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Webhookok vezérlőpult (Globális)';
$strings['MeetingTitleContains'] = 'Az értekezlet címe tartalmazza';
$strings['FromUTC'] = 'Kezdete (UTC)';
$strings['ToUTC'] = 'Vége (UTC)';
$strings['OnlyOnlineRows'] = 'Csak online sorok';
$strings['AllMeetings'] = 'Összes értekezlet';
$strings['Apply'] = 'Alkalmaz';
$strings['ExportCSV'] = 'CSV export';
$strings['AutoRefresh10s'] = 'Automatikus frissítés (10s)';
$strings['ActiveMeetings'] = 'Aktív értekezletek';
$strings['ConnectedNow'] = 'Jelenleg csatlakozva';
$strings['JoinsToday'] = 'Csatlakozások ma';
$strings['Events24h'] = 'Események (24ó)';
$strings['OnlineTime'] = 'Online idő';
$strings['Conversation'] = 'Beszélgetés';
$strings['CameraShare'] = 'Kamera megosztás';
$strings['Messages'] = 'Üzenetek';
$strings['Reactions'] = 'Reakciók';
$strings['Hands'] = 'Kezek';
$strings['Results'] = 'Eredmények';
$strings['Status'] = 'Állapot';
$strings['Joined'] = 'Csatlakozott';
$strings['Last'] = 'Utolsó';
$strings['Running'] = 'Fut';
$strings['Finished'] = 'Befejezett';
$strings['UsersColon'] = 'Felhasználók:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Beszéd:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Frissítve';
$strings['FirstJoin'] = 'Első csatlakozás';
$strings['LastSeen'] = 'Utoljára látva';
$strings['Totals'] = 'Összesen';
$strings['Talking'] = 'Beszél';
$strings['User'] = 'Felhasználó';
$strings['No recording'] = 'Nincs felvétel';
