...
$langExplanation = "Após clicar em OK, será criado um curso com uma seção de testes/exercícios, projeto de rota de aprendizagem, avaliações, cursos, caixa de documentos compartilhados, Agenda e muito mais. Ao registar-se como professor será atribuídos privilégios para poder";
...
$IntroductionWiki = "A palavra Wiki é uma abreviatura de WikiWikiWeb. Wikiwiki é uma palavra Hawaiana que significa rápido ou veloz. Num Wiki, os usuários podem escrever páginas conjuntamente. Se uma pessoa escreve algo errado, a seguinte pode corrigir. Esta última pessoa tam";
