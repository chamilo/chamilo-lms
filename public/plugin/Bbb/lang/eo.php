...
$strings['Review meetings, recordings and available actions.'] = 'Revizu kunvenojn, registradojn kaj disponeblajn agojn.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Elektu la PDF- aŭ PPTX-dosierojn, kiujn vi volas antaŭŝargi kiel lumbildojn por la konferenco.';
$strings['Max total: %d MB'] = 'Maksimume entute: %d MB';
$strings['Pre-upload Documents'] = 'Antaŭŝargi dokumentojn';
$strings['No documents found'] = 'Neniuj dokumentoj trovitaj';
$strings['Failed to load documents'] = 'Malsukcesis ŝargi dokumentojn';
$strings['No meetings or recordings are available yet.'] = 'Ankoraŭ ne disponeblas kunvenoj aŭ registradoj.';
$strings['Share the conference link with allowed participants.'] = 'Kundividu la konferencan ligilon kun permesitaj partoprenantoj.';
$strings['presentation'] = 'Prezentado';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Retkroĉiloj Stirpanelo (Ĝenerala)';
$strings['MeetingTitleContains'] = 'Kunveno-titolo enhavas';
$strings['FromUTC'] = 'De (UTC)';
$strings['ToUTC'] = 'Ĝis (UTC)';
$strings['OnlyOnlineRows'] = 'Nur konektitaj linioj';
$strings['AllMeetings'] = 'Ĉiuj kunvenoj';
$strings['Apply'] = 'Apliki';
$strings['ExportCSV'] = 'Eksporti CSV';
$strings['AutoRefresh10s'] = 'Aŭtomata aktualigo (10s)';
$strings['ActiveMeetings'] = 'Aktivaj kunvenoj';
$strings['ConnectedNow'] = 'Konektitaj nun';
$strings['JoinsToday'] = 'Aliĝoj hodiaŭ';
$strings['Events24h'] = 'Eventoj (24h)';
$strings['OnlineTime'] = 'Konektita tempo';
$strings['Conversation'] = 'Konversacio';
$strings['CameraShare'] = 'Kamerao-divido';
$strings['Messages'] = 'Mesaĝoj';
$strings['Reactions'] = 'Reagoj';
$strings['Hands'] = 'Manlevoj';
$strings['Results'] = 'Rezultoj';
$strings['Status'] = 'Stato';
$strings['Joined'] = 'Aliĝis';
$strings['Last'] = 'Lasta';
$strings['Running'] = 'Aktiva';
$strings['Finished'] = 'Finita';
$strings['UsersColon'] = 'Uzantoj:';
$strings['OnlineColon'] = 'Konektitaj:';
$strings['TalkColon'] = 'Parolas:';
$strings['CameraColon'] = 'Kamerao:';
$strings['Updated'] = 'Ĝisdatigita';
$strings['FirstJoin'] = 'Unua aliĝo';
$strings['LastSeen'] = 'Laste vidita';
$strings['Totals'] = 'Sumoj';
$strings['Talking'] = 'Parolanta';
$strings['User'] = 'Uzanto';
$strings['No recording'] = 'Neniu registraĵo';
