...
class CWiki
{
     ...
     * @var integer
     *
     * @ORM\Column(name="page_id", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $pageId;
     ...
     * @var string
     *
     * @ORM\Column(name="reflink", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
    private $reflink;
     ...
     * @var integer
     *
     * @ORM\Column(name="addlock", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $addlock;
     ...
     * @var integer
     *
     * @ORM\Column(name="editlock", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $editlock;
     ...
     * @var integer
     *
     * @ORM\Column(name="addlock_disc", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $addlockDisc;
     ...
     * @var integer
     *
     * @ORM\Column(name="visibility_disc", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="ratinglock_disc", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="assignment", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $assignment;
     ...
     * @var string
     *
     * @ORM\Column(name="progress", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $progress;
     ...
     * @var integer
     *
     * @ORM\Column(name="is_editing", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $isEditing;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="time_edit", type="datetime", precision=0, scale=0, nullable=false, unique=false)
     */
    private $timeEdit;
     ...
     * @var integer
     *
     * @ORM\Column(name="hits", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $hits;
     ...
     * @var string
     *
     * @ORM\Column(name="linksto", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $linksto;
     ...
     * @var string
     *
     * @ORM\Column(name="tag", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $tag;
     ...
     * @var string
     *
     * @ORM\Column(name="user_ip", type="string", length=39, precision=0, scale=0, nullable=false, unique=false)
     */
    private $userIp;
