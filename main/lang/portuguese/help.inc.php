...
$langCourseRolesRightsContent = "<p>Na página global das funções e direitos do seu curso, pode definir exactamente <em>quem está habilitado a fazer o quê e em que ferramentas</em>.</p> <p>O conceito básico é o seguinte: para cada ferramenta, pode especificar quem pode ter acesso aos conteúdos, adicionar novos itens e pastas, editar informação já existente, alterá-la ou apagá-la. No entanto, não tem de especificar estas funções e direitos para cada utilizador individual. No interior do seu curso os utilizadores têm funções atribuídas, tais como: visitante, membro normal do curso, professor assistente e administrador do curso. Para cada uma destas funções pode especificar as permissões para cada ferramenta. Pode, por exemplo, desejar que todos os utilizadores tenham acesso ao fórum, mas os meros visitantes não podem publicar mensagens no fórum - só os utilizadores registados na plataforma. Pode, por exemplo, desejar que o professor assistente adicione documentos ao seu curso, mas não possa apagá-los. E assim por diante.</p> <p> Na ferramenta utilizadores do seu curso, pode ver as funções dos utlizadores e editá-las, alterá-las (para isso basta usar o botão editar na lista de utilizadores). </p> <h3>Visão geral de todas as funções locais</h3> <p> Existem cinco funções locais no interior da plataforma Dokeos. São as seguintes as funções que pode atribuir aos utilizadores no interior do seu curso. <ul> <li><b>Visitante anónimo</b>: o visitante anónimo pode ser qualquer pessoa em qualquer parte do mundo que apenas tenta visitar e aceder ao seu curso. Por defeito, este tipo de utilizadores não têm direitos de nenhuma espécie e nem sequer podem visualizar os conteúdos do seu curso.</li> <li><b>Visitante registado na plataforma</b>: é o tipo de utilizador registado na plataforma Dokeos que visita o seu curso sem, contudo, nele estar inscrito.</li> <li><b>Utilizador registado no curso</b>: é a função atribuída por defeito a todos os utilizadores inscritos no seu curso. Normalmente, a maioria dos utilizadores mantém esta função, mas o administardor do curso pode atribuir a alguns deles a função de professor assistente para ajudarem na tarefa de desenvolver o curso.</li> <li><b>Professor Assistente</b>: a função de professor assistente tem imensas permissões. Na maior parte das ferramentas, o professor assistente pode visualizar os conteúdos, editar, alterar, adicionar, mas não pode apagar conteúdos. O professor assistente também não pode editar nem alterar as configurações globais do curso ou as configurações por defeito dos direitos e funções.</li> <li><b>Adimistrador do curso</b>: o administrador do curso tem todos os direitos sobre o curso e pode fazer tudo. O criador (autor) do curso automaticamente obtém estes direitos e esta função.</li> </ul> </p> <h3>Visão geral dos direitos</h3> <p> Na plataforma Doekos existem quatro direitos básicos: <ul> <li><b>Ver</b>: direito a visualizar uma ferramenta e todos os seus conteúdos</li> <li><b>Adicionar</b>: direito a adicionar novos conteúdos numa dada ferramenta; por exemplo, adicionar hiperlinks (ligações web), categorias, documentos, pastas, publicações dos estudantes, mensagens no fórum, ...</li> <li><b>Editar</b>: direito a editar (e alterar) conteúdos existentes numa dada ferramenta; por exemplo, editar (alterar) um hiperlink, o nome de um ficheiro ou pasta, o título de um documento, ...</li> <li><b>Apagar</b>: direito a apagar conteúdos existentes numa dada ferramenta; por exemplo, apagar hiperlinks, publicações dos alunos, documentos, mensagens do fórum, ...</li> </ul> </p> <h3>Visão geral dos lugares</h3> <p> Todos os cursos e todas as ferramentas no interior de cada curso é considerado um lugar separado na plataforma Dokeos. Alguns exemplos de lugares são: <ul> <li>O curso TESTE_CURSO</li> <li>A ferramenta documentos do curso TESTE_CURSO</li> <li>A ferramenta agenda do curso PSICOLOGIA101</li> </ul></p> <h3>Configuração das permissões</h3> <p>Enquanto administrador do curso pode especificar quem faz o quê em cada local (cf. exemplo acima). Para cada combinação da função e local, os quatro direitos podem ser atribuídos. Assim, por exemplo, pode atribuir o direito de visualização sobre a ferramenta documentos ao professor assistente; o direito de acrescentar na ferramenta ligações aos membros inscritos no seu curso, etc. </p>";
?>