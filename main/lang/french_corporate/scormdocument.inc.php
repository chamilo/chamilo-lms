...
/*
      +----------------------------------------------------------------------+
      | CLAROLINE version 1.3.0 $Revision: 1846 $                            |
      +----------------------------------------------------------------------+
      | Copyright (c) 2001, 2002 Universite catholique de Louvain (UCL)      |
      +----------------------------------------------------------------------+
      |   $Id: scormdocument.inc.php 1846 2004-06-22 14:36:28Z olivierb78 $         |
      +----------------------------------------------------------------------+
...
$langDoc="Parcours&nbsp;:&nbsp;cours&nbsp;au&nbsp;format&nbsp;scorm";
$langDownloadFile= "Transférer le ZIP SCORM (1.2 ou 1.3)";
$langDownload="Transférer";
$langScormBuilder="Construire&nbsp;un&nbsp;parcours&nbsp;:&nbsp;cours&nbsp;au&nbsp;format&nbsp;scorm";
...
$langFileExists="Impossible d'effectuer cette op&eacute;ration.<br>Un fichier portant ce nom existe déj&agrave;.";
$langIn="en";
