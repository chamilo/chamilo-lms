...
$ShowBackLinkOnTopOfCourseTreeComment = "Afficher un lien de retour en arrière au sommet de la liste. Le lien s'affiche également au bas de la liste dans tous les cas.";
$langUsed = "utilisé";
$langPresent = "Valider";
...
$PermissionsForNewFilesComment = "La possibilité de définir les permissions allouées aux nouveaux fichiers vous permet d'augmenter la sécurité contre les attaques de pirates envoyant des contenus dangereux sur votre serveur. La valeur par défaut (0550) devrait être suffisante pour garant";
...
$SplitUsersUploadDirectoryComment = "Sur les portails à usage très important, où un grand nombre d'utilisateurs sont enregistrés et envoient leur photo, le répertoire de téléchargement (main/upload/users/) pourrait contenir plus de fichiers que le système de fichiers du serveur ne peut gére";
...
$DropboxAllowStudentToStudentComment = "Permettre aux apprenants d'envoyer des documents aux autres apprenants (peer2peer). Attention: les apprenants pourraient utiliser cette fonctionnalité pour s'adresser des documents peu appropriés (mp3, solutions aux tests...). Désactiver cette fonctionn";
...
$PermissionsForNewDirsComment = "La possibilité de définir les permissions allouées aux nouveaux dossiers vous permet d'augmenter la sécurité contre les attaques de pirates envoyant des contenus dangereux sur votre serveur. La valeur par défaut (0550) devrait être suffisante pour garant";
...
$langVisioconfDescription = "Chamilo LIVE est un outil standardisé de vidéoconférence qui offre : diffusion de diapos, superposition avec un tableau blanc pour le dessin et l'écriture au vol, duplex audio et vidéo, demande de parole, discussion écrite par chat et liste des connectés";
$langPpt2lp = "Chamilo RAPID";
$langPpt2lpDescription = "Chamilo RAPID vous permet de transformer en quelques clics de souris une présentation PowerPoint en cours à la norme SCORM puis d'y ajouter du son, des tests, des activités de formation et des documents multimédia ainsi que des moments d'interaction ent";
...
$VersionCheckExplanation = "Afin d'activer la vérification automatique des versions, vous devez enregistrer votre portail sur Chamilo.org. Les informations que vous nous transmettez en cliquant sur ce bouton sont réservées à un usage interne; seules des informations statistiques gl";
...
$UseSessionModeComment = "Les sessions de formation permettent de gérer des groupes d'apprenants dans des programmes de formation sous la supervision de coaches et pendant une durée déterminée. Un outil particulièrement pertinent pour les grands groupes et les organisations géogr";
...
$PublicPagesComplyToWAIComment = "WAI (Web Accessibility Initiative) est une initiative visant à rendre le web plus accessible. En choisissant cette option, vous rendez les pages publiques de votre portail plus accessibles. Ceci signifie également que certains contenus des pages publiques";
...
$UploadExtensionsBlacklistComment = "La blacklist, ou liste noire, est un mode de filtrage qui permet d'éliminer (ou de renommer) les fichiers dont les extensions figurent dans la liste ci-dessous. Les extensions doivent être mentionnées sans leur point (.) de préfixe, et doivent être sépar";
$UploadExtensionsWhitelistComment = "La whitelist, ou liste blanche, est un mode de filtrage qui permet d'éliminer (ou de renommer) les fichiers dont les extensions ne figurent *PAS* dans la liste ci-dessous. Cette méthode est généralement considérée comme plus sûre mais plus contraignante";
$UploadExtensionsSkip = "Comportement de filtrage (éliminer/renommer)";
$UploadExtensionsSkipComment = "Si vous choisissez d'éliminer, les fichiers dont l'extension a été filtrée par la blacklist ou la whitelist ne seront pas envoyées sur votre campus. Si vous choisissez de renommer, leur extension sera remplacée par la valeur indiquée dans le paramètre d";
...
$EphorusDescription = "Démarrer l'utilisation de l'anti-plagiat Ephorus au sein de Chamilo.<br /><STRONG>Avec Ephorus, vous détectez le plagiat internet sans effort. </STRONG><br />Utilisez notre webservice standard et ouvert ou intégrez notre module Chamilo pour une détectio";
...
$Ppt2lpVoiceRecordingNeedsRed5 = "Chamilo RAPID contribue à faire de Chamilo AUTEUR un outil en ligne de production rapide de cours. Avec la possibilité de collaborer dans la production des ressources.";
$PlatformCharsetTitle = "Caractères";
$PlatformCharsetComment = "La palette de caractères est ce qui dirige la façon dont certaines chaînes de caractères de langues spécifiques sont affichées. Si vous utilisez le russe ou le japonais par exemple, vous aurez certainement besoin de modifier cette variable. Pour toutes le";
...
$ExtendedProfileRegistrationRequiredComment = "Lesquels des champs suivants du profil étendu sont requis lors de l'enregistrement des utilisateurs? Ceci nécessite que l'option du profil étendu à l'enregistrement soit activée et que les champs soient disponibles dans le formulaire d'inscription (vo";
$NoReplyEmailAddress = "Adresse e-mail \\"no-reply\\"";
$NoReplyEmailAddressComment = "C'est l'adresse de courriel qui sera utilisée lorsque des courriels sont envoyés depuis la plateforme en demandant spécifiquement de ne pas y répondre. Cette adresse devrait idéalement être configurée au niveau du serveur pour ignorer/supprimer automati";
...
$InstallDirAccessibleSecurityThreat = "Le répertoire main/install est toujours accessible aux utilisateurs web. Ceci peut représenter un danger en termes de sécurité. Nous recommandons la suppression de ce répertoire ou le changement des permissions de telle manière que les utilisateurs web ne";
...
$UserThemeSelectionComment = "Autoriser le choix du style visuel par les utilisateurs. Ce paramètre permettra à chaque utilisateur de choisir son propre style. Le style par défaut du portail restera toutefois inchangé. Si un cours ou une session dispose d'un style visuel qui lui est";
$AllowurlfopenIsSetToOff = "Le paramètre de configuration de PHP \\"allow_url_fopen\\" est désactivé, ce qui empêche le mécanisme d'enregistrement de votre portail de fonctionner correctement. Ce paramètre peut être modifié dans votre fichier de configuration de PHP (php.ini) ou dans";
...
$UserFieldsAddHelp = "L'ajout de rubriques de profil est aisé:<br />- sélectionnez un login interne en un mot et en minuscules,<br />- sélectionnez un type,<br />- choisissez un ttitre qui apparaîtra pour les utilisateurs (il est possible de faire usage de variables de langue";
$AllowCourseThemeTitle = "Autoriser thème graphique par formation";
$AllowCourseThemeComment = "Autoriser l'utilisation des thèmes graphiques par cours permet de sélectionner une feuille de style pour chaque cours et ainsi d'en modifier l'apparence pour l'utilisateur. Lorsque l'utilisateur entre dans une formation, le thème graphique du cours p";
...
$LDAPEnableComment = "Si vous disposez d\'un serveur LDAP, vous devriez d\'abord remplir les paramètres ci-dessous et modifier le fichier de configuration de Chamilo, comme indiqué dans le guide d\'installation, puis enfin de l\'activer. Cela permettra à vos utilisateurs de s\";
...
$LDAPFilledTutorFieldComment = "Une vérification sera faite sur le contenu du champ LDAP donné ci-dessous lorsque de nouveaux utilisateurs seront importés via LDAP. Si le champ n\'est pas vide, l\'utilisateur sera considéré comme un enseignant et inséré tel quel dans Chamilo. Si vous vo";
...
$LDAPFilledTutorFieldValueComment = "Lorsque la vérification du champ enseignant est faite sur le champ donné ci-dessus, la valeur donnée ci-dessous doit se trouver dans les sous-éléments du champ donné pour que l\'utilisateur soit considéré comme un enseignant. Si vous laissez ce champ vide";
...
$EnableSearchComment = "Sélectionnez \\"Oui\\" pour activer la fonctionnalité de recherche et d\'indexation full-text. Cette fonctionnalité nécessite l\'installation sur votre serveur de l\'extension Xapian pour PHP, en version 1.x ou supérieure. Cette fonctionnalité ne fonctionne";
...
$AllowSocialToolComment = "L\'outil de réseau social permet aux utilisateurs de définir des relations vis à vis d\'autres utilisateurs, et ainsi de former des groupes d\'amis. Combiné à l\'outil de messagerie, cet outil permet de communiquer de cette façon avec ses amis au sein du";
...
$AllowUseSubLanguageComment = "En activant cette option, vous rendrez possible la définition de variations pour chacun des termes de langage utilisé dans l\'interface de la plateforme, sous la forme d\'un langage basé sur et étendant un langage existant. Vous trouverez cette option dan";
...
$AllowTermsAndConditionsComment = "Activer la page de termes et conditions permet d\'introduire un aspect légal à l\'usage du campus. Ces termes et conditions peuvent être édités à partir de la page d\'administration (par langue) et pourront être affichés aux utilisateurs selon les options";
$Load = "Charger";
