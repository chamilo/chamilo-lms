...
$langCreateGroupsFromVirtualCoursesInfo = "Cette formation est une combinaison de formations réelles et de une ou plusieurs formations virtuelles. Si vous appuyez sur le bouton suivant, un nouveaux groupe sera créé d\'après ces formations (virtuelles). Tous les apprenants seront inscrits dans ce g";
...
$CreateSubgroupsInfo = "Cette options vous permet de créer de nouveaux groupes basés sur un groupe existant. Indiquez le nombre de groupes et choisissez un groupe existant. Le nombre de groupes désirés sera créé et tous les membres du groupe existant seront inscrits  dans ces no";
