...
$Options = "Opciones";
$WelcomeOogieConverter = "Bienveníu al conversor de PowerPoint Oogie<br>1. Compruebe\'l so discu duru y busque un archivu con estensión *.ppt o *odp<br>2.Unvíelu a Oogie, que lu va tresformar nun Itinerariu d\'aprendizaxe Scorm.<br>3. Va poder añadir comentarios d\'audiu a caúna l";
...
$TemplateTitleMrDokeosDescription = "Un diálogu esplicativu con Mr. Chamilo";
...
$HelpDefaultDirDocuments = "Esti direutoriu caltien los ficheros suministraos por defeutu. Puedes desaniciar o amestar otros ficheros, pero si un ficheru ta anubríu cuando ye inxertáu nun documentu web los escolinos tampoco podrán velu equí. Cuando inxertes un ficheru nun documentu";
$HelpSharedFolder = "Esti direutoriu caltien los ficheros que los estudiantes (y tú) unvían a un cursu a traviés del editor, si nun lo facen dende la ferramienta grupos. Por defeutu serán visibles por cualisquier mayestru, pero tarán anubríos pa otros estudiantes salvo qu\'ac";
