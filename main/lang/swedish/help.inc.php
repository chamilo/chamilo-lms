...
<ul>
  <li>Klicka på <img src=../img/renommer.gif width=20 height=20 align=baseline> knappen i
  ...
  <li>Klicka på <img src=../img/delete.gif width=20 height=20> 
	i kolumnen \'Radera\'.</li>
	</ul>
	<h4>Skapa ett dokument (eller mapp) osynligt för eleverna</h4>
	<ul>
	  
  <li>Klicka på <img src=../img/visible.gif width=20 height=20>i kolumnen \'Synlig/osynlig\'.</li>
	  <li>Dokumentet (eller mappen) existerar fortfarande men är är inte synlig för studenterna längre.</li>	  
  <li>För att göra det synligt igen, klicka på <img src=../document/../img/invisible.gif width=24 height=20> 
	i kolumnen \'Synlig/osynlig\'</li>
	</ul>
	<h4>Lägga till eller ändra på kommentar till ett dokument (eller en mapp)</h4>
	<ul>	  
  <li>Klicka på <img src=../document/../img/comment.gif width=20 height=20> 
	...
	<p>För att radera kommentar, klick på <img src=../document/../img/comment.gif width=20 height=20>, 
	...
	<ul>
	  <li>Klicka på <img src=../document/../img/dossier.gif width=20 height=20> \'Skapa en mapp\' (överst tillvänster)</li>
	...
	<ul>
	  <li>Klicka på knappen <img src=../document/../img/deplacer.gif width=34 height=16> 
	  ...
	  <li>Godkänn med att klicka på på <input type=submit value=OK name=submit232>.</li> </ul> <h4> <b> Skapa en  Learning Path</b> </h4>Denna Learning path kommer att se ut som en innehållsförteckning men kan innehålla mycket mer, se mer under Learning Path.";
