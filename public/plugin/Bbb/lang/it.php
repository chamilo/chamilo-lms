...
$strings['CountUsers'] = 'Conta utenti';
$strings['Review meetings, recordings and available actions.'] = 'Rivedi riunioni, registrazioni e azioni disponibili.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Seleziona i file PDF o PPTX da precaricare come slide per la conferenza.';
$strings['Max total: %d MB'] = 'Totale massimo: %d MB';
$strings['Pre-upload Documents'] = 'Pre-carica documenti';
$strings['No documents found'] = 'Nessun documento trovato';
$strings['Failed to load documents'] = 'Impossibile caricare i documenti';
$strings['No meetings or recordings are available yet.'] = 'Nessuna riunione o registrazione disponibile al momento.';
$strings['Share the conference link with allowed participants.'] = 'Condividi il link della conferenza con i partecipanti autorizzati.';
$strings['presentation'] = 'Presentazione';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Dashboard Webhook (Globale)';
$strings['MeetingTitleContains'] = 'Il titolo della riunione contiene';
$strings['FromUTC'] = 'Da (UTC)';
$strings['ToUTC'] = 'A (UTC)';
$strings['OnlyOnlineRows'] = 'Solo righe online';
$strings['AllMeetings'] = 'Tutte le riunioni';
$strings['Apply'] = 'Applica';
$strings['ExportCSV'] = 'Esporta CSV';
$strings['AutoRefresh10s'] = 'Aggiornamento automatico (10s)';
$strings['ActiveMeetings'] = 'Riunioni attive';
$strings['ConnectedNow'] = 'Connessi ora';
$strings['JoinsToday'] = 'Accessi oggi';
$strings['Events24h'] = 'Eventi (24h)';
$strings['OnlineTime'] = 'Tempo online';
$strings['Conversation'] = 'Conversazione';
$strings['CameraShare'] = 'Condivisione telecamera';
$strings['Messages'] = 'Messaggi';
$strings['Reactions'] = 'Reazioni';
$strings['Hands'] = 'Mani alzate';
$strings['Results'] = 'Risultati';
$strings['Status'] = 'Stato';
$strings['Joined'] = 'Partecipato';
$strings['Last'] = 'Ultimo';
$strings['Running'] = 'In corso';
$strings['Finished'] = 'Terminato';
$strings['UsersColon'] = 'Utenti:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Parlato:';
$strings['CameraColon'] = 'Telecamera:';
$strings['Updated'] = 'Aggiornato';
$strings['FirstJoin'] = 'Primo accesso';
$strings['LastSeen'] = 'Ultimo visto';
$strings['Totals'] = 'Totali';
$strings['Talking'] = 'In conversazione';
$strings['User'] = 'Utente';
$strings['No recording'] = 'Nessuna registrazione';
