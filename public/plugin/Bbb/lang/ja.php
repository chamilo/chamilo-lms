...
$strings['Review meetings, recordings and available actions.'] = '会議、録画および利用可能な操作を確認します。';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = '会議のスライドとして事前読み込みするPDFまたはPPTXファイルを選択してください。';
$strings['Max total: %d MB'] = '合計最大: %d MB';
$strings['Pre-upload Documents'] = 'ドキュメントの事前アップロード';
$strings['No documents found'] = 'ドキュメントが見つかりません';
$strings['Failed to load documents'] = 'ドキュメントの読み込みに失敗しました';
$strings['No meetings or recordings are available yet.'] = 'まだ会議や録画はありません。';
$strings['Share the conference link with allowed participants.'] = '許可された参加者に会議リンクを共有してください。';
$strings['presentation'] = 'プレゼンテーション';
$strings['video'] = 'ビデオ';
$strings['WebhooksDashboard'] = 'ウェブフック ダッシュボード (グローバル)';
$strings['MeetingTitleContains'] = '会議タイトルに含む';
$strings['FromUTC'] = '開始 (UTC)';
$strings['ToUTC'] = '終了 (UTC)';
$strings['OnlyOnlineRows'] = 'オンラインのみ';
$strings['AllMeetings'] = 'すべての会議';
$strings['Apply'] = '適用';
$strings['ExportCSV'] = 'CSVエクスポート';
$strings['AutoRefresh10s'] = '自動更新 (10秒)';
$strings['ActiveMeetings'] = 'アクティブな会議';
$strings['ConnectedNow'] = '現在接続中';
$strings['JoinsToday'] = '本日の参加';
$strings['Events24h'] = 'イベント (24時間)';
$strings['OnlineTime'] = 'オンライン時間';
$strings['Conversation'] = '会話';
$strings['CameraShare'] = 'カメラ共有';
$strings['Messages'] = 'メッセージ';
$strings['Reactions'] = 'リアクション';
$strings['Hands'] = '挙手';
$strings['Results'] = '結果';
...
$strings['Last'] = '最終';
$strings['Running'] = '実行中';
$strings['Finished'] = '終了済み';
$strings['UsersColon'] = 'ユーザー数:';
$strings['OnlineColon'] = 'オンライン:';
$strings['TalkColon'] = '発言:';
$strings['CameraColon'] = 'カメラ:';
$strings['Updated'] = '更新日時';
$strings['FirstJoin'] = '初回参加';
$strings['LastSeen'] = '最終閲覧';
$strings['Totals'] = '合計';
$strings['Talking'] = '発言中';
$strings['User'] = 'ユーザー';
