...
$strings['Review meetings, recordings and available actions.'] = 'Revisar reuniões, gravações e ações disponíveis.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Selecione os arquivos PDF ou PPTX que deseja pré-carregar como slides para a conferência.';
$strings['Max total: %d MB'] = 'Máximo total: %d MB';
$strings['Pre-upload Documents'] = 'Pré-carregar documentos';
$strings['No documents found'] = 'Nenhum documento encontrado';
$strings['Failed to load documents'] = 'Falha ao carregar documentos';
$strings['No meetings or recordings are available yet.'] = 'Nenhuma reunião ou gravação disponível ainda.';
$strings['Share the conference link with allowed participants.'] = 'Compartilhe o link da conferência com os participantes autorizados.';
$strings['presentation'] = 'Apresentacao';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Painel de Webhooks (Global)';
$strings['MeetingTitleContains'] = 'Título da reunião contém';
$strings['FromUTC'] = 'De (UTC)';
$strings['ToUTC'] = 'Até (UTC)';
$strings['OnlyOnlineRows'] = 'Apenas linhas online';
$strings['AllMeetings'] = 'Todas as reuniões';
$strings['Apply'] = 'Aplicar';
$strings['ExportCSV'] = 'Exportar CSV';
$strings['AutoRefresh10s'] = 'Atualização automática (10s)';
$strings['ActiveMeetings'] = 'Reuniões ativas';
$strings['ConnectedNow'] = 'Conectados agora';
$strings['JoinsToday'] = 'Entradas hoje';
$strings['Events24h'] = 'Eventos (24h)';
$strings['OnlineTime'] = 'Tempo online';
$strings['Conversation'] = 'Conversa';
$strings['CameraShare'] = 'Compartilhamento de câmera';
$strings['Messages'] = 'Mensagens';
$strings['Reactions'] = 'Reações';
$strings['Hands'] = 'Mãos levantadas';
$strings['Results'] = 'Resultados';
$strings['Status'] = 'Status';
$strings['Joined'] = 'Entrou';
$strings['Last'] = 'Último';
$strings['Running'] = 'Em andamento';
$strings['Finished'] = 'Finalizado';
$strings['UsersColon'] = 'Usuários:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Fala:';
$strings['CameraColon'] = 'Câmera:';
$strings['Updated'] = 'Atualizado';
$strings['FirstJoin'] = 'Primeira entrada';
$strings['LastSeen'] = 'Visto por último';
$strings['Totals'] = 'Totais';
$strings['Talking'] = 'Falando';
$strings['User'] = 'Usuário';
$strings['No recording'] = 'Sem gravação';
