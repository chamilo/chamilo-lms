...
$lang_short_help = "Per afegir un recurs cliqueu sobre el signe més (+). Per modificar un títol o descripció cliqueu la icona en forma de llapis. Per afegir requisits previs cliqueu la icona que mostra dos documents. Podeu comprovar allò que visualitzaran els estudiants clic";
...
$WelcomeWoogieConverter = "Benvingut al conversor Woogie<ul type=\\"1\\"><li>Escolliu un fitxer .doc, .sxw, .odt<li>Envieu-lo a Woogie i el convertirà en un itinerari formatiu SCORM <li>Podreu afegir comentaris d\'audio a cada pàgina i inserir exercicis i d\'altres activitats entre l";
...
$SearchFeatureSearchExplanation = "Per a buscar en la base de dades de lliçons usi la següent sintaxi::<br/>    <i>term tag:tagname -exclude +include \\"exact phrase\\"i><br/>Per exemple:<br/>    <i>cotxe tag:camió -ferrari +ford \\"alt consum\\".i><br/> Això mostrarà tots els resultats per a";
