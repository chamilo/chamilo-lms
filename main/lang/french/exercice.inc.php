...
$langHotspotChoose = "<div style=\"padding:2px 3px;\">• Pour crÃ©er une zone \" hotspot\": sÃ©lectionnez la forme Ã  cÃŽtÃ© de la couleur, ensuite dessinez le hotspot.</div><div style=\"padding:2px 3px;\">• Pour dÃ©placer un hotspot: sÃ©lectionnez la couleur, cliquez sur un autre endroit dans l'image et dessinez le hotspot.</div><div style=\"padding:2px 3px;\">• Pour ajouter un hotspot: cliquez le bouton [Ajouter zone].</div><div style=\"padding:2px 3px;\">• Pour fermer un polygone: clic-droit et sÃ©lectionnez \"Fermer le polygone\".</div>";
$Fault = "Incorrect";
