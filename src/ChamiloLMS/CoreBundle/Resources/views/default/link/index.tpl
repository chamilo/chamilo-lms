...
<div class="btn-toolbar actions-bar" >
    {% if is_allowed_to_edit %}
        <div class="btn-group edit">
            <a href="{{root}}&amp;action=add_category" class="btn new_folder" title="{{'AddCategory'|trans}}">
                <i class="size-32 icon-new-folder"></i>
            </a>
            <a href="{{root}}&amp;action=add_link" class="btn new_link" title="{{'AddLink'|trans}}">
                <i class="size-32 icon-new-link"></i>
            </a>
            <a href="javascript:void(0)" onclick="delete_all();return false;" class="btn delete_all" title="{{'DeleteAll'|trans}}">
            ...
            <a href="{{root}}&amp;action=export_csv" class="btn" title="{{'ExportAsCSV'|trans}}">
                <i class="size-32 icon-export-csv"></i>
            </a>
        </div>
    {% endif %}
    <div class="btn-group">
        <a href="javascript:void(0)" onclick="expand_all();return false;" class="btn" title="{{'showall'|trans}}">
            <i class="size-32 icon-expand"></i>
        </a>
        <a href="javascript:void(0)" onclick="collapse_all();return false;" class="btn" title="{{'shownone'|trans}}">
        ...
        {% for link in links %}
            ...
            <li id="link_{{link.id}}" class="link {{link_class}}" data-id="{{link.id}}" data-c_id="{{link.c_id}}" data-type="link" >
                <a class="icon" target="{{link.target}}" href="{{root}}&amp;action=go&amp;id={{link.id}}&amp;c_id={{link.c_id}}">
                    <img alt="{{'Links'|trans}}" src="{{ _p.web_img_path }}link.gif" />
                </a>
                ...
                {% if is_allowed_to_edit %}
                    <div style="float:right;">
                        ...
                        <a href="javascript:void(0)" onclick="delete_link('link_{{link.id}}', this);return false;" title="{{'Delete'|trans}}" class="">
