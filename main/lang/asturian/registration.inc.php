...
$langSend = "Unviar";
$langUserAddExplanation = "Caúna les ringleres del archivu qu\'unvie tien d\'incluyir, por necesidá, los 5 campos (y nengún más)<b>Nome    Apellíos   Nome d\'usuariu   Seña    Corréu electrónicu</b> separtaos per tabuladores y nesi orde. Los usuarios van recibir un corréu de confir";
...
$AccountsExternalAuthSource = "Chamilo nun pue xestionar de manera automática\'l so pidimientu porque polo menos una de les cuentes tien fonte d\'idientificación esterna. Por favor, tome les medíes pertienentes en toles sos cuentes (tamién nes que yá tienen autorización de la plataform";
