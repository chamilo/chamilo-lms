...
$langVersionTip = "yupaynin utaq nisqaynin";
$langStatusTip = "yupachasqamanta ajllay";
$langCreatedSize = "Kamarisqa, sayaynin";
$langCreatedSizeTip = "WWWW-KK-PP kamarichikusqanmanta, bytes nisqapi sayaynin";
$langAuthorTip = "VCARD nisqapi";
$langFormat = "Formato nisqa";
$langFormatTip = "ajllaypay sinrimanta";
$langLocation = "URL/URI";
$langLocationTip = "clik nisqallata ruwan ima kichanapaqqa";
$langStore = "Allchay";
$langDeleteAll = "Pichay llipin metadatos sutiyuqta";
