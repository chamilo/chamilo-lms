...
$UseLinkSyntax = "Os usuários selecionados receberão um email com o texto acima e uma única ligação que terão de clicar para preencher o questionário. Se desejar colocar a ligação em um outro lugar do texto tem de escrever o seguinte texto onde desejar no meio do texto: **";
...
$CompleteReportDetail = "Neste relatório pode-se ver todas as respostas de todos os utilizadores em todas as questões. Também tem a opção de ver somente uma seleção de questões. Pode exportar os resultados em formato CVS e usar este arquivo para processá-lo numa aplicação estatís";
