...
$strings['Review meetings, recordings and available actions.'] = 'Переглядайте зустрічі, записи та доступні дії.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Виберіть файли PDF або PPTX, які ви хочете попередньо завантажити як слайди для конференції.';
$strings['Max total: %d MB'] = 'Макс. загалом: %d МБ';
$strings['Pre-upload Documents'] = 'Попереднє завантаження документів';
$strings['No documents found'] = 'Документів не знайдено';
$strings['Failed to load documents'] = 'Не вдалося завантажити документи';
$strings['No meetings or recordings are available yet.'] = 'Зустрічей або записів ще немає.';
$strings['Share the conference link with allowed participants.'] = 'Поділіться посиланням на конференцію з дозволеними учасниками.';
$strings['presentation'] = 'Презентація';
$strings['video'] = 'Відео';
$strings['WebhooksDashboard'] = 'Панель вебхуків (глобальна)';
$strings['MeetingTitleContains'] = 'Назва зустрічі містить';
$strings['FromUTC'] = 'Від (UTC)';
$strings['ToUTC'] = 'До (UTC)';
$strings['OnlyOnlineRows'] = 'Лише онлайн-рядки';
$strings['AllMeetings'] = 'Усі зустрічі';
$strings['Apply'] = 'Застосувати';
$strings['ExportCSV'] = 'Експорт CSV';
$strings['AutoRefresh10s'] = 'Автооновлення (10с)';
$strings['ActiveMeetings'] = 'Активні зустрічі';
$strings['ConnectedNow'] = 'Підключено зараз';
$strings['JoinsToday'] = 'Приєднань сьогодні';
$strings['Events24h'] = 'Подій (24г)';
$strings['OnlineTime'] = 'Час онлайн';
$strings['Conversation'] = 'Розмова';
$strings['CameraShare'] = 'Поділитися камерою';
$strings['Messages'] = 'Повідомлення';
$strings['Reactions'] = 'Реакції';
$strings['Hands'] = 'Підняти руки';
$strings['Results'] = 'Результати';
$strings['Status'] = 'Статус';
$strings['Joined'] = 'Приєднався';
$strings['Last'] = 'Останній';
$strings['Running'] = 'Виконується';
$strings['Finished'] = 'Завершено';
$strings['UsersColon'] = 'Користувачі:';
$strings['OnlineColon'] = 'Онлайн:';
$strings['TalkColon'] = 'Говорять:';
$strings['CameraColon'] = 'Камера:';
$strings['Updated'] = 'Оновлено';
$strings['FirstJoin'] = 'Перше приєднання';
$strings['LastSeen'] = 'Останній раз бачили';
$strings['Totals'] = 'Всього';
$strings['Talking'] = 'Говорить';
$strings['User'] = 'Користувач';
$strings['No recording'] = 'Немає запису';
