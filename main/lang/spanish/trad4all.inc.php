...
$PersonalDataMainQuestion = "¿Qué es lo que consideramos datos personales?";
$PersonalDataCollectionQuestion = "¿Porqué recolectamos estos datos?";
$PersonalDataRecordingQuestion = "¿Dónde registramos los datos? (en qué sistema, alojado dónde, accesible para qué empresa que se encarga de los servidores, etc.)";
$PersonalDataOrganizationQuestion = "¿Cómo están estructurados los datos? ¿En qué medida la organización de los datos protege su seguridad?... ¿Tiene procesos establecidos que aseguran que un hacker no podrá recolectar todos los datos personales en el primer intento? ¿están cifrados?)";
$PersonalDataStructureQuestion = "¿Cómo se estructuran los datos en la aplicación? (una solo ficha para todos los datos, tiene alguna categorización / etiqueta, ...)";
$PersonalDataConservationQuestion = "¿Cuánto tiempo guardamos los datos? ¿Existen datos que expiran a pesar de que la cuenta siga activa? ¿Cuánto tiempo los guardamos después del último uso del sistema?";
$PersonalDataAdaptationQuestion = "¿Qué cambios podemos hacer a los datos? ¿Qué cambios se pueden hacer a los datos sin afectar el servicio?";
$PersonalDataExtractionQuestion = "¿Para qué extraemos datos (hacia otros procesos internos) y cuáles son?";
$PersonalDataQueriesQuestion = "¿Quién puede consultar los datos personales?, ¿Con qué propósito?";
$PersonalDataUseQuestion = "¿Cómo y para qué podemos usar los datos personales?";
$PersonalDataCommunicationQuestion = "¿Con quién podemos compartirlos?, ¿En qué oportunidades?, ¿A través de qué procesos (seguros o no)?";
$PersonalDataInterconnectionQuestion = "¿Tenemos otro sistema con el cual Chamilo interactúa? ¿Cuál es el proceso de interconexión? ¿Cuáles son los datos intercambiados y de qué manera?";
$PersonalDataLimitationQuestion = "¿Cuáles son los límites que respetaremos siempre al usar datos personales? ¿Hasta qué punto podemos llegar?";
$PersonalDataDeletionQuestion = "¿Después de cuánto tiempo borramos los datos? (evento, último uso, vigencia del contrato, etc.) ¿Cuáles son los procesos de eliminación?";
$PersonalDataDestructionQuestion = "¿Qué pasa si los datos son destruidos como consecuencia de una fallo técnico? (borrado no autorizado o pérdida de material, por ejemplo)";
$PersonalDataProfilingQuestion = "¿Con qué propósito hacemos un tratamiento de datos personales? ¿Filtramos el acceso que los usuarios tienen a ciertas partes de nuestra aplicación? (discriminación negativa o positiva)";
?>