...
$PersonalDataMainQuestion = "Que considérons-nous comme des données personnelles?";
$PersonalDataCollectionQuestion = "Pourquoi recueillons-nous ces données?";
$PersonalDataRecordingQuestion = "Où enregistrons-nous les données? (dans quel système, hébergé où, accessible par quelle entreprise qui gère les serveurs, etc.)";
$PersonalDataOrganizationQuestion = "Comment sont structurées les données? Dans quelle mesure l'organisation des données protège-t-elle votre sécurité? ... Avons-nous mis en place des processus garantissant qu'un pirate informatique ne sera pas en mesure de collecter toutes les données personnelles à la première tentative? Sont-elles cryptées?";
$PersonalDataStructureQuestion = "Comment les données sont-elles structurées dans l'application? (un onglet pour toutes les données, il y a une catégorisation / étiquette, ...)";
$PersonalDataConservationQuestion = "Combien de temps sauvegardons-nous les données? Y a-t-il des données qui expirent même si le compte est toujours actif? Combien de temps les gardons-nous après la dernière utilisation du système?";
$PersonalDataAdaptationQuestion = "Quels changements pouvons-nous apporter aux données? Quelles modifications peuvent être apportées aux données sans affecter le service?";
$PersonalDataExtractionQuestion = "Pourquoi y-a-il extraction de données (vers d'autres processus internes) et quelles sont ces données?";
$PersonalDataQueriesQuestion = "Qui peut consulter les données personnelles, dans quel but?";
$PersonalDataUseQuestion = "Comment et pourquoi pouvons-nous utiliser les données personnelles?";
$PersonalDataCommunicationQuestion = "Avec qui pouvons-nous les partager, dans quelles opportunités, à travers quels processus (sécurisés ou non)?";
$PersonalDataInterconnectionQuestion = "Avons-nous un autre système avec lequel Chamilo interagit? Quel est le processus d'interconnexion? Quelles sont les données échangées et de quelle manière?";
$PersonalDataLimitationQuestion = "Quelles sont les limites à respecter lors de l'utilisation de données personnelles? Jusqu'où pouvons-nous aller?";
$PersonalDataDeletionQuestion = "Après combien de temps effaçons-nous les données? (événement, dernière utilisation, validité du contrat, etc.) Quels sont les processus d'élimination?";
$PersonalDataDestructionQuestion = "Que se passe-t-il si les données sont détruites à la suite d'une défaillance technique? (suppression non autorisée ou perte de matériel, par exemple)";
$PersonalDataProfilingQuestion = "Dans quel but traitons-nous les données personnelles? Modifions-nous l'accès des utilisateurs à certaines parties de notre application? (discrimination négative ou positive)";
?>