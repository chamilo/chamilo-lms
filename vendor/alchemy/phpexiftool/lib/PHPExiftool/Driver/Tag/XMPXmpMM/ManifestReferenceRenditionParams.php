 ...
 * @ExclusionPolicy("all")
 */
class ManifestReferenceRenditionParams extends AbstractTag
{

    protected $Id = 'ManifestReferenceRenditionParams';

    protected $Name = 'ManifestReferenceRenditionParams';
