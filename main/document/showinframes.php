...
var_dump(api_get_setting('show_glossary_in_documents'));exit;
...
if (api_get_setting('show_glossary_in_documents') == 'ismanual') {
    ...
    $js_glossary_in_documents =	'//    $(document).ready(function() {
                                      ...
                                      { load: [
                                                {type:"script", id:"_fr1", src:"'.api_get_path(WEB_LIBRARY_PATH).'javascript/jquery.min.js"},
                                                {type:"script", id:"_fr4", src:"'.api_get_path(WEB_LIBRARY_PATH).'javascript/jquery-ui/smothness/jquery-ui-1.8.21.custom.min.js"},
                                                {type:"script", id:"_fr2", src:"'.api_get_path(WEB_LIBRARY_PATH).'javascript/jquery.highlight.js"},
