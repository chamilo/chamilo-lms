...
class TrackCourseRanking
{
     ...
     * @var integer
     *
     * @ORM\Column(name="accesses", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $accesses;
     ...
     * @var integer
     *
     * @ORM\Column(name="total_score", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $totalScore;
     ...
     * @var integer
     *
     * @ORM\Column(name="users", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $users;
