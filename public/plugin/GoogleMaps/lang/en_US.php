...
<br><br>
Follow the link below to see the map : <a href='".api_get_path(WEB_PLUGIN_PATH)."GoogleMaps/src/map_coordinates.php'>".api_get_path(WEB_PLUGIN_PATH).'google_maps/src/map_coordinates.php</a>';
