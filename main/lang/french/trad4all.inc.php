...
$PersonalDataResponsibleOrganization = "Organisation responsable du traitement";
$PersonalDataTreatment = "Traitement des données";
$PersonalDataCollection = "Collecte des données personnelles";
$PersonalDataRecording = "Enregistrement des données personnelles";
$PersonalDataOrganization = "Organisation des données personnelles";
$PersonalDataStructure = "Structuration des données personnelles";
$PersonalDataConservation = "Conservation des données personnelles";
$PersonalDataAdaptationOrModification = "Adaptation ou modification des données personnelles";
$PersonalDataExtraction = "Extraction des données personnelles";
$PersonalDataConsultation = "Consultation des données personnelles";
$PersonalDataUsage = "Utilisation des données personnelles";
$PersonalDataCommunicationAndSharing = "Communication et diffusion des données personnelles";
$PersonalDataInterconnection = "Interconnexion des données personnelles";
$PersonalDataLimitation = "Limitation des données personnelles";
$PersonalDataDeletion = "Effacement des donnée personnelles";
$PersonalDataDestruction = "Destruction des donnée personnelles";
$PersonalDataProfiling = "Profilage des donnée personnelles";
