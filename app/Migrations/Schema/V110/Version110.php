...
class Version110 extends AbstractMigrationChamilo
{
    ...
    public function preUp(Schema $schema)
    {
        ...
        $this->addSql("UPDATE session SET session.id_coach = (SELECT u.user_id FROM admin a INNER JOIN user u ON (u.id = a.user_id AND u.active = 1) LIMIT 1) WHERE id_coach NOT IN (SELECT user_id FROM user)");
    }
