...
$langSend = "Senden";
$langUserAddExplanation = "Jede Zeile der Datei darf nur genau 5 Felder enthalten: <b>Nachname   Vorname                   Login   Passwort                   Email</b> getrennt durch Tabulatoren und in dieser Reihenfolge.                Die Teilnehmer/innen erhalten eine Bestätigun";
$langUserMany = "Teilnehmerliste durch Textdatei einfügen";
$langOneByOne = "Teilnehmer manuell eintragen";
$langNow = "jetzt";
$langTutor = "Tutor";
$langTitular = "Autor/in";
$langAddHereSomeCourses = "<font size=2 face=\'Arial, Helvetica\'><big>Kursliste bearbeiten</big><br/><br/>Markieren Sie die Kurse, die Sie belegen wollen.<br>Löschen Sie die Markierung für Kurse, die Sie nicht mehr belegen wollen.<br> Klicken Sie dann auf den OK Button auf der Lis";
...
$langSettings = "mit den folgenden Einstellunge";
