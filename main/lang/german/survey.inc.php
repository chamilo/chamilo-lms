...
$UseLinkSyntax = "Die ausgewählten Benutzer erhalten eine E-Mail mit dem obigen Text und einem unverwechselbaren Link, den sie zum Ausfüllen der Umfrage anklicken müssen. Wollen Sie den Link an eine andere Stelle im Text plazieren, so fügen Sie den nachfolgenden Text an ir";
...
$CompleteReportDetail = "In diesem Report erhält man einen Überblick über alle Antworten von allen Benutzern für alle Fragen. Man hat auch die Option, nur eine Auswahl von Fragen anzuschauen. Die Ergebnisse können im CSV Format exportiert werden zur Weiterverarbeitung in einer St";
