...
$Administrator = "مدیر";
$AddPicture = "عکستان را اضافه کنید";
$ChangePicture = "عکستان را تغییر دهید";
$DeletePicture = "عکستان را حذف کنید";
...
$GroupDescription = "توضیحات در مورد گروه";
$NumberOfParticipants = "تعداد شرکت کنندگان";
$NumberOfUsers = "تعداد کاربران";
$Maximum = "حداکثر";
$MaximumOfParticipants = "حداکثر شرکت کنندگان";
$Participants = "اعضا";
...
$ImportFileLocation = "محل فایل سی اس وی یا ایکس ام ال";
$FileType = "نوع\nفایل";
$OutputFileType = "نوع فایل خروجی";
...
$OtherCategory = "طبقه های دیگر";
$SendMailToUsers = "ارسال ایمیل به کاربران";
$ExampleXMLFile = "مثالی برای یک فایل ایکس ام ال";
$ExampleCSVFile = "مثالی برای یک فایل سی وی اس";
...
$AddAnnouncement = "افزودن یک اطلاعیۀ جدید";
$AnnouncementAdded = "اطلاعیه مورد نظر افزوده شد";
$AnnouncementUpdated = "اطلاعیه مورد نظر به روز گردید";
$AnnouncementDeleted = "اطلاعیه مورد نظر حذف گردید";
$Content = "محتوا";
...
$CourseVisibilityClosed = "عدم دسترسی، قابل دسترسی تنها برای اداره کننده درس";
...
$ConfigureExtensions = "چامیلو حرفه ای";
