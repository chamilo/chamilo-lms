...
use Chamilo\CoreBundle\Entity\CurriculumItemRelUser;
use Chamilo\CoreBundle\Entity\CurriculumItem;
use Chamilo\CoreBundle\Entity\Repository\CurriculumItemRelUserRepository;
use Chamilo\CoreBundle\Form\CurriculumItemRelUserCollectionType;
...
class CurriculumUserController
{
    ...
    {
        return 'Chamilo\CoreBundle\Entity\CurriculumItemRelUser';
    }
    ...
    {
        return 'Chamilo\CoreBundle\Form\CurriculumItemRelUserCollectionType';
    }
    ...
    public function indexAction()
    {
        ...
        $qb = $this->getManager()
            ->createQueryBuilder()
            ->select('node, i, u')
            ->from('Chamilo\CoreBundle\Entity\CurriculumCategory', 'node')
    ...
    */
    ...
    {
        return $this->get('orm.em')->getRepository('Chamilo\CoreBundle\Entity\CurriculumCategory');
    }

    private function getCurriculumItemRepository()
    {
        return $this->get('orm.em')->getRepository('Chamilo\CoreBundle\Entity\CurriculumItem');
    }
