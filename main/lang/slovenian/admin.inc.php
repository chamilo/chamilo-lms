...
$langAdministrationTools  = "Upravljanje";
$langState  = "Stanje sistema";
$langDevAdmin  = "Upravljanje razvoja";
$langLinksToClaroProjectSite  = "Povezava na spletno stran projekta";
$langStatistiques  = "Statistika";
$langNbProf  = "Število uèiteljev";
$langNbStudents  = "Število teèajnikov";
$langNbLogin  = "Število dostopov";
$langToday    = "Danes";
$langLast7Days  = "Zadnjih 7 dni";
$langLast30Days  = "Zadnjih 30 dni";
$langNbAnnoucement  = "Število najav";
$langCheckDatabase  = "Preveri glavno podatkovno bazo";
$langPleaseCheckConfigForMainDataBaseName  = "Preveri prosim te vrednosti<br>Ime glavne podatkovne baze v <br>";
$langBaseFound  = "Našel<br>Preverjanje tabel te baze";
$langNeeded  = "potrebno";
$langNotNeeded  = "ni potrebno";
$langArchive    = "arhiv";
$langUsed       = "uporabljeno";
$langPresent   = "OK";
$langCreateMissingNow  = "Želiš tabele tvoriti sedaj ?";
$langMissing    = "manjka";
$langCheckingCourses  = "Preverjanje teèajev";
$langExist      = "obstaja";
$langCreateClaroTables  = "Tvorba tabele za glavno podatkovno bazo";
$langTableStructureDontKnow  = "Struktura te tabele je neznana";
...
$langSecureDocument = "Zašèiti mapo dokumentov";
$langProtectedDocument = "Ustvari .htaccess datoteko v mapi /document/ za prepreèitev ne-avtoriziranih dostopov";
$langNotProtectedDocument = "dovoli dostop do mape /document/ brez predhodne registracije teèaja";
...
$langFromHomepageWithoutLogin = "iz domaèe strani portala tudi brez prijave";
$langSiteReservedToPeopleInMemberList = "dostop je možen le za uporabnike s seznama uporabnikov";
$langCode = "Koda";
...
$langAtLeastOneUser = "Izbrati moraš vsaj enega uporabnika !";
...
$ActivateRolesRightsInterface = "Vloge in pravice";
$ActivateRolesRightsInterfaceComment = "Aktiviraj vmesnik vlog in pravic";
$EditRoleInfo = "Uredi informacije o vlogah";
$AddRight = "dodaj";
$CreateNewGlobalRoleInfo = "Nova globalna vloga";
$CreateNewLocalRoleInfo = "Nova lokalna vloga";
$InitialRightsBasedOnLocalRole = "NOva lokalna vloga na osnovi obstoje&#269;ih pravic vloge ";
...
$CreateNewLocalRoleInfo = "Informacije o novi lokalni vlogi";
...
$UserRolesRights = "Uporabniške vloge in pravice";
$ManageRoles = "Upravljaj vloge";
$RolesRightsOverview = "Pregled vlog in pravic";
$SeeAllRightsAllLocationsForSpecificRole = "Poglej vse pravice in lokacije za specifièno vlogo";
