...
*/
$MoveTo = "Pārvietot uz";
$DownloadFile = "Augšupielādēt failu serverī";
$NameDir = "Jaunās direktorijas nosaukums";
$Size = "Izmērs";
$Rename = "Pārsaukt";
$Copy = "Kopēt kursa saturu";
$To = "uz";
$NoSpace = "Augšupielāde netika veikta ! <br>Iespējams, ka: <br>1) Jums pieejamā datu kvota ir pārsniegta; vai<br> 2) datu vieta uz servera ir pilna.";
$DownloadEnd = "Augšupielāde ir pabeigta";
...
$DownloadAndZipEnd = "ZIP fails augšuplādēts un atarhivēts";
$Root = "pamatdirektorija";
$CreateDoc = "Izveidot jaunu mājas lapu / mācību lapas šablonu";
$Down = "Zemāk";
$FileError = "Augšupielādējamā faila formāts nav derīgs";
$MaxFileSize = "Maksimāli pieļaujamais faila izmērs ir";
$FileName = "Faila nosaukums";
$NoFileName = "Lūdzu, norādiet faila nosaukumu";
$NoText = "Lūdzu, ievadiet tekstuālo / HTML informāciju";
$AreYouSureToDelete = "Vai tiešām vēlaties dzēst?";
$Scormcontent = "Pieeja <i>Scorm</i>  sistēmai<br><input type=button name=scormbutton value='Sākt darbu !' ='openscorm()'>";
$Scormcontentstudent = "Pieeja <i>Scorm</i> formāta kursam. Pieejai klikšķiniet uz šīs pogas: <input type=button name=scormbutton value='Sākt darbu !' ='openscorm()'>";
$Publish = "Publicēt";
$MissingImagesDetected = "Konstatēti iztrūksto";
$CreateDocument = "Izveidot dokumentu";
$EditDocument = "Labot";
$Documents = "Dokumenti";
$OrganiseDocuments = "Izveidot satura koku";
$EditTOC = "Labot satura koku";
$Chapter = "Nodaļa";
...
$AddMetadata = "Skatīt/Labot META datus";
$GoMetadata = "AIZIET";
