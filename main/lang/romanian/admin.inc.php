...
$DokeosAdminWebLinks = "Legaturi Chamilo";
...
$langUpgrade = "Upgrade pentru Chamilo";
$langWebsite = "Site Chamilo";
...
$langYourDokeosUses = "Platforma ta Chamilo foloseste in prezent";
...
$PermissionsForNewFilesComment = "Posibilitatea de a defini setari pentru permisiuni care sa fie atribuite fiecarui fisier nou creat va permite sa imbunatatiti securitatea impotriva atacurilor hackeri-lor ce ar putea incarca continut periculos in portalul dvs. Setarea implicita (0550) ar";
$langStudent = "Student";
$Guest = "Vizitator";
...
$SplitUsersUploadDirectoryComment = "La portalele cu rata de utilizare foarte mare, in care multi utilizatori sunt inregistrati si trimit imaginile lor, directorul de upload (main/upload/users/) ar putea contine prea multe fisiere pentru ca sistemul de fisiere sa le mai poata manevra (limita";
...
$PermissionsForNewDirsComment = "Posibilitatea de a defini setari pentru permisiuni care sa fie atribuite fiecarui director nou creat va permite sa imbunatatiti securitatea impotriva atacurilor hackerilor ce ar putea incarca un continut periculos pentru portalul dvs. Setarea implicita (0";
...
$DefaultDokeosStyle = "Stilul Chamilo implicit";
...
$PleaseVisitDokeos = "Va rugam vizitati Chamilo";
...
$VersionCheckExplanation = "Pentru activarea verificarii versiunii automate va trebui sa va inregistrati campusul pe chamilo.com. Informatia obtinuta apasand pe acest buton este pentru utilizarea interna si numai datele sustinute vor fi publicate si disponibile (numarul total de cam";
...
$UploadExtensionsBlacklistComment = "Lista neagra este utilizata pentru a filtra extensiile fisierelor prin indepartarea (sau redenumirea) oricarui fisier a carui extensie figureaza in lista neagra de mai jos. Extensiile trebuie sa fie precizate fara punctul de la inceput (.) si separate pri";
$UploadExtensionsWhitelistComment = "Lista alba este utilizata pentru a filtra extensiile fisierelor prin indepartarea (sau redenumirea) oricarui fisier a carui extensie *NU* figureaza in lista alba de mai jos. Este acceptat in general ca aceasta este o abordare mai sigura dar mai restrictiv";
$UploadExtensionsSkip = "Comportamentul filtrarii (sari/redenumeste)";
$UploadExtensionsSkipComment = "Daca alegeti sa sariti, fisierele filtrate prin lista neagra sau lista alba nu vor fi incarcate in sistem. Daca alegeti sa le redenumiti, extensia lor va fi inlocuita de cea definita in setarile pentru inlocuirea extensiilor. Atentie, redenumirea nu va pr";
...
$PlatformCharsetComment = "Setul de caractere precizeaza modul in care anumite limbi pot fi afisate in Chamilo. Daca utilizati caractere ale limbii ruse sau japoneze, de exemplu, ar trebui sa-l modificati. Pentru caracterele limbi engleze, latine si vest-europene, valoarea implicit";
...
$InstallDirAccessibleSecurityThreat = "Directorul principal/de instalare al sistemului dvs Chamilo este inca accesibil utilizatorilor web. Aceasta poate fi o amenintare cu privire la securitatea instalarii dvs. Va recomandam sa indepartati acest director sau sa schimbati permisiunile sale astf";
...
$UserThemeSelectionComment = "Permite utilizatorilor sa-si selecteze tema vizuala din cadrul profilului lor. Aceasta va modifica modul in care Chamilo le apare, dar va lasa intact stilul implicit al portalului. Daca un anumit curs sau o sesiune are atribuita o anumita tema, aceasta va";
$AllowurlfopenIsSetToOff = "Setarea PHP \\"allow_url_fopen\\" este off. Aceasta previne functionarea corecta a mecanismului de inregistrare. Aceasta ssetare poate fi modificata in fisierul de configurare PHP (php.ini) sau in configurarea Hostului virtual in Apache, utilizand directiva";
...
$UserFieldsAddHelp = "Adaugarea unui camp utilizator este foarte simpla:<br/>-alegeti un cuvant, identificator cu litere mici, <br/>- selectati un tip,<br/>- alegeti un text care ii va aparea utilizatorului (daca utilizati un nume translatat existent, cum ar fi BirthDate sau U";
$AllowCourseThemeTitle = "Activeaza teme pentru cursuri";
$AllowCourseThemeComment = "Activarea temelor grafice pentru cursuri face posibila modificarea foii de stil utilizate de un curs cu orice foaie de stil disponibila in Chamilo. Cand un utilizator intra intr-un curs, foaia de stil a cursului va avea prioritate fata de foaia de stil a";
...
$ShowClosedCoursesComment = "Afiseaza cursurile inchise in pagina de logare si pagina de start a cursului? Pe pagina initiala a campusului va aparea un icon langa curs pentru a te inscrie rapid la curs. Aceasta va aparea numai pe pagina initiala a campusului cand userul este logat si";
$LDAPConnectionError = "Eroare de conectare LDAP";
$LDAP = "LDAP";
$LDAPEnableTitle = "Activeaza LDAP";
$LDAPEnableComment = "Daca aveti un server LDAP, va trebui sa-i configurati setarile de mai jos si sa modificati fisierul de configurare asa cum se descrie in ghidul de instalare, apoi sa il activati. Aceasta va permite utilizatorilor sa se autentifice utilizand numele de util";
...
$LDAPFilledTutorFieldComment = "Se va face o verificare asupra acestui camp de contact LDAP la inserarea unui nou utilizator. Daca acest camp nu este gol, utilizatorul va fi considerat tutore si va fi inserat astfel in Chamilo. Daca doriti ca toti utilizatorii sa fie recunoscuti ca util";
...
$LDAPFilledTutorFieldValueComment = "Cand se face o verificare a campului tutor de mai sus, aceasta valoare trebuie sa apartina unui dintre campurile sub-elementare ale campului tutor pentru ca utilizatorul sa fie considerat ca si profesor. Daca lasati acest camp gol, singura conditie este c";
...
$Templates = "Sabloane";
$HideCampusFromPublicDokeosPlatformsList = "Nu arata portalul meu in lista Chamilo de portale.";
...
$DokeosClassic2D = "Chamilo clasic 2D";
$DokeosBlue = "Chamilo albastru";
