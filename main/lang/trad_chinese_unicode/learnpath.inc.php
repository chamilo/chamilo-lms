...
$lang_published = "發布";
$lang_add_learnpath_module = "添加模塊";
$lang_add_learnpath_chapter_to_path = "添加一個新的模塊到這個學習路徑";
$lang_learnpath_module_added = "學習路徑模塊已經成功創建，現下你可以透過點擊十字圖示添加模塊";
$lang_edit_learnpath_module = "修改";
$lang_delete_learnpath_module = "刪除";
$lang_learnpath_module_edited = "學習路徑模塊已經被成功修改";
$lang_learnpath_module_deleted = "學習路徑模塊和其中的所有步驟已刪除";
$lang_nochapters = "沒有添加模塊。";
$lang_add_learnpath_item = "添加步驟到該模塊";
$lang_learnpath_item_deleted = "學習路徑步驟已刪除";
$lang_assign_learnpath_items_to = "請分發這些學習路徑到模塊中︰";
...
$langTitleManipulateModule = "處理當前模塊";
...
$langNewForumCreated = "論壇已創建。";
$langNewThreadCreated = "論壇主題已創建。";
$langFirstPosition = "開始";
$langNewQuiz = "添加測驗";
$langCreateTheForum = "添加論壇";
$langAddLpIntro = "<strong>歡迎</strong>來到學習路徑創作工具。<br />您將一步一步來創建學習路徑，它的架構將顯示在左邊的選單。";
$langAddLpToStart = "標題";
$langCreateTheLink = "插入鏈接";
$langMoveCurrentLink = "移動當前鏈接";
$langEditCurrentLink = "修改鏈接";
$langUrl = "Url";
$langMoveCurrentStudentPublication = "移動學生作業";
$langEditCurrentStudentPublication = "修改學生作業";
$langAllowMultipleAttempts = "允許多次嘗試";
$langPreventMultipleAttempts = "不允許多次嘗試";
$langMakeScormRecordingExtra = "額外記錄";
$langMakeScormRecordingNormal = "正常記錄";
$langDocumentHasBeenDeleted = "由於文擋已刪除所以不能顯示";
$langEditCurrentForum = "修改當前論壇";
$langNoPrerequisites = "無必前提";
$langMoveChapter = "移動章節";
$langMoveModule = "移動模塊";
$langNotImportScormAicc = "匯入 Scorm/Aicc 不成功";
?>