...
$lang_doc_unvisible = "Your file is only visible for the trainer(s) of this course and will therefore not be visible for you.";
...
$WeightInTheGradebook = "Weight in the assessment";
...
$AllFilesInvisible = "All files are now invisible";
$FileInvisible = "The file is now invisible";
$AllFilesVisible = "All files are now visible";
