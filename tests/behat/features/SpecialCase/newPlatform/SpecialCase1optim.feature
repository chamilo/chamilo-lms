Feature: Special admin settings flows
  ...
  Scenario: Platform settings — active tools and LP forum
    ...
    # And I press "submit"
    # And I wait very long for the page to be loaded
    # When I am on "/admin/course-list?keyword=Tools Visibility Course"
    # And I wait very long for the page to be loaded
    # And I zoom out to maximum
  ...
  # Verify force_edit_exercise_in_lp: exercise added to LP remains editable
    ...
    And I press "submit"
    And I wait very long for the page to be loaded
    And I am on "/admin/course-list?keyword=Force Edit Course"
    And I wait very long for the page to be loaded
    Then I should see "Force Edit Course"
    When I am on "/admin/course-list?keyword=Force Edit Course"
    And I wait very long for the page to be loaded
    And I zoom out to maximum
  ...
  Scenario: Session settings — session admin
    ...
    # When I am on "/admin/course-list?keyword=French for Beginners"
    # And I wait very long for the page to be loaded
    # And I zoom out to maximum
