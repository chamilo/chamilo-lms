...
$langDBSettingIntro = "Namestitveni skript bo tvoril glavno podatkovno bazo Chamilo/Claroline. Chamilo/Claroline  mora tvoriti				veè podatkovnih baz (DB) (v kolikor spodaj ne izbereš opcije \"Ena\" ). Èe administrator sistema dovoli 				za vašo spletno stran le eno DB, Chamilo/Claroline ne bo delovala.";
...
$langSingleDb = "Uporabi eno ali veè DB za Chamilo";
...
$WarningExistingDokeosInstallationDetected = "Opozorilo!<br>Namestitveni proces je zaznal obstojeèo Chamilo platformo na vašem sistemu.";
...
$YouHaveMoreThanXCourses = "Trenutno imate veè kot %d teèajev na vaši Chamilo platformi ! Le %d teèajev le bilo nadgrajenih. Za nadgradnjo ostalih teèajev %s kliknite tule %s";
...
$NoWritePermissionPleaseReadInstallGuide = "Nekatere datoteke ali mape nimajo pravice pisalnega dostopa. Da bi Chamilo uspešno namestili, najprej spremenite dostopne pravice (uporabite CHMOD). Veè informacij najdete v %s namestitvenem vodièu %s";
...
$UpgradeFromDokeos16x = "Nadgradi iz Chamilo 1.6.x";
$UpgradeFromDokeos18x = "Nadgradi iz Chamilo 1.8.x";
?>