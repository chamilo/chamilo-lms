...
$langNoScript = "Izvajanje skript v vašem brskalniku je onemogočeno. Zanemarite vsebino zaslona pod tem besedilom, ne bo delovalo...";
$langLanguageTip = "jezik, v katerem je napisan ta učni objekt";
...
$langDescriptionTip = "opi ali komentar, in jezik, uporaabljen za opisovanje tega učnega objekta";
...
$langKwNote = "Pri spremembi opisnega jezika hkrati ne dodajaj ključnih besed.";
$langClickKw = "Kliknite ključno besedo v drevesu za izbiro oz. preklic izbire.";
$langKwHelp = "<br/>Klik na \'+\' za odpiranje, \'-\' za zapiranje, \'++\' odpre vse, \'--\' zapre vse.<br/> <br/> Počisti izbrane ključne besede s tem, da zaprete drevo in ga ponovno odprete s \'+\' .<br/> <br/>Alt-klik \'+\' poišče originalne kljune besede v drevesu.<br/><br/> Alt-klik ključna beseda izbere ključno besedo brez širšega pomena ali pa prekliče izbiro.<br/> <br/> V primeru, da spreminjate opisni jezik, hkrati ne dodajajte ključnih besed.<br/> <br/>";
$langLocation = "URL/URI";
$langLocationTip = "klikni za odpiranje objekta";
$langStore = "Shrani";
$langDeleteAll = "Odstrani vse metapodatke";
$langConfirmDelete = "Ali *resnično* želite odstraniti vse metapodatke?";
$langWorkOn = "na dan";
