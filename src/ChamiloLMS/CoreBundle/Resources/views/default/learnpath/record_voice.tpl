...
<div id="rtc">
    ...
    <br />
    <a id="record" class="btn btn-danger" >{{ 'RecordAudio' | trans }}</a>
    <button id="stop" class="btn" disabled="">{{ 'StopRecordingAudio' | trans }}</button>
</div>

<div id="wami" style="float:left">
    <a id="record-wami" class="btn btn-info">{{ 'ActivateAudioRecorder' | trans }}</a>
    <br />
...
<div id="nanogong">
    ...
    <form name="form_nanogong">
        ...
        <button class="upload" type="submit" value="{{ 'Send' | trans }}" onclick="submitVoice()">
            {{ 'Send' | trans }}
        </button>
    </form>
...
function submitVoice() {
    // lang vars
    var lang_no_applet = "{{ 'NanogongNoApplet' | trans }}";
    var lang_record_before_save = "{{ 'NanogongRecordBeforeSave' | trans }}";
    var lang_give_a_title = "{{ 'NanogongGiveTitle' | trans }}";
    var lang_failled_to_submit = "{{ 'NanogongFailledToSubmit' | trans }}";
    var lang_submitted = "{{'NanogongSubmitted' | trans }}";
    // user and group id
...
$(document).ready(function() {
    ...
    if (rtcEnabled && isChrome) {
        ...
        $('#record-result').html("{{ 'RecordIsNotAvailable' | trans }}");
    }
