...
class PermissionFixtures extends Fixture implements FixtureGroupInterface, DependentFixtureInterface
{
    ...
    public static function getPermissions(): array
    {
        return [
            ...
            ['title' => 'View report catalog', 'slug' => 'report:viewcatalog', 'description' => 'View the report catalog and report role matrix'],
            ['title' => 'View platform reports', 'slug' => 'report:viewplatform', 'description' => 'View platform-wide reports'],
            ['title' => 'View security audit reports', 'slug' => 'report:viewsecurity', 'description' => 'View security and audit reports'],
            ['title' => 'View course reports', 'slug' => 'report:viewcourse', 'description' => 'View course-scoped reports'],
            ['title' => 'View learning analytics reports', 'slug' => 'report:viewlearninganalytics', 'description' => 'View learning analytics reports'],
            ['title' => 'View gradebook reports', 'slug' => 'report:viewgradebook', 'description' => 'View gradebook reports'],
            ['title' => 'View export reports', 'slug' => 'report:viewexports', 'description' => 'View reporting exports'],
    ...
    public static function getPermissionsMapping(): array
    {
        return [
            ...
            'report:viewcatalog' => ['ADM', 'GLO', 'SSM'],
            'report:viewplatform' => ['ADM', 'GLO', 'SSM'],
            'report:viewsecurity' => ['ADM', 'GLO'],
            'report:viewcourse' => ['TEA', 'ADM', 'GLO', 'SSM'],
            'report:viewlearninganalytics' => ['TEA', 'ADM', 'GLO', 'HRM', 'SSM', 'STB'],
            'report:viewgradebook' => ['TEA', 'ADM', 'GLO', 'HRM', 'SSM', 'STB'],
            'report:viewexports' => ['ADM', 'GLO', 'SSM'],
