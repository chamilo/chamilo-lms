...
$NoSurveysSelected = "Нет выбранных опросников";
$SurveyUpdatedSuccesfully = "опросник успешно обновлен";
...
$OrReturnToSurveyOverview = "или вернуться к общему обзору опросника";
...
$AdditonalUsers = "Дополнительные пользователи";
$AdditonalUsersComment = "Вы можете пригласить дополнительных (тех, кто не на курсе) пользователей заполнить этот опросник добавив их адрес эл. почты здесь, разделяя их с помощью , или ;";
$MailTitle = "Заглавие сообщения";
$MailText = "Текст сообщения";
