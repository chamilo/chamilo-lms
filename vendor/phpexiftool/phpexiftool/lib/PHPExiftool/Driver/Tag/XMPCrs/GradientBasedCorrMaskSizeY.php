 ...
 * @ExclusionPolicy("all")
 */
class GradientBasedCorrMaskSizeY extends AbstractTag
{

    protected $Id = 'GradientBasedCorrectionsCorrectionMasksSizeY';

    protected $Name = 'GradientBasedCorrMaskSizeY';
