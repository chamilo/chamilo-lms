...
$langDefaultTextInBlanks = "<table cellspacing=\\"0\\" cellpadding=\\"10\\" border=\\"1\\" width=\\"720\\" style=\\"\\" height:=\\"\\"> <tbody> <tr> <td colspan=\\"2\\"> <h3>Exemplo de atividade: preencher o formulário de cálculo do Índice de Massa Corporal</h3> </td> </tr> <tr> <td style=\\"text-";
...
$langHotspotChoose = "<div style=\\"padding:2px 3px;\\">&bull; Para criar um hotspot: selecione uma forma junto à cor e depois desenhe o hotspot.</div><div style=\\"padding:2px 3px;\\">&bull; Para mover um hotspot, selecione a cor, clique em um outro ponto da imagem e desenhe o ho";
$Fault = "Incorreto";
...
$DirectFeedbackCantModifyTypeQuestion = "O tipo de teste não pode ser modificado, uma vez que foi configurado para ser uma autoavaliação. A autoavaliação permite a possibilidade de atribuir feedback direto ao usuário, mas não é compatível com todos os tipos de questões, como tal, não é possível";
