 ...
 * @ExclusionPolicy("all")
 */
class GradientBasedCorrMaskBottom extends AbstractTag
{

    protected $Id = 'GradientBasedCorrectionsCorrectionMasksBottom';

    protected $Name = 'GradientBasedCorrMaskBottom';
