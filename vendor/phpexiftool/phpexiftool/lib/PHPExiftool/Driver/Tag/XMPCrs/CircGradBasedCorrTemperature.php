 ...
 * @ExclusionPolicy("all")
 */
class CircGradBasedCorrTemperature extends AbstractTag
{

    protected $Id = 'CircularGradientBasedCorrectionsLocalTemperature';

    protected $Name = 'CircGradBasedCorrTemperature';
