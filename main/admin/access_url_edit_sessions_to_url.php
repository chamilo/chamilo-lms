...
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_add_sessions_to_url.php">'.Display::return_icon('view_more_stats.gif',get_lang('AddSessionsToURL'),'').' ' .get_lang('AddSessionsToURL').'</a>';
echo '</div>';
