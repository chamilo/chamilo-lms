...
$strings['CertificateMode'] = 'Режим сертифіката';
$strings['UseCourseCustomCertificate'] = 'Використовувати спеціальний сертифікат для курсу';
$strings['UseDefaultCustomCertificate'] = 'Використовувати стандартний сертифікат платформи';

$strings['CreateCertificateWithTags'] = 'Створити сертифікат за допомогою цих тегів';

$strings['DeleteCertificate'] = 'Видалити сертифікат';

$strings['SaveCertificate'] = 'Зберегти сертифікат';

$strings['SelectOneOptionBeforeOpeningEditor'] = 'Виберіть один варіант і збережіть налаштування перед відкриттям редактора сертифікатів.';

$strings['ChooseCustomCertificateModeHelp'] = 'Виберіть, як цей курс має використовувати спеціальні сертифікати.';

$strings['CouldNotSaveCertificate'] = 'Не вдалося зберегти конфігурацію сертифіката.';
