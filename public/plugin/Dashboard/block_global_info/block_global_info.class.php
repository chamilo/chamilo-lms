...
class BlockGlobalInfo extends Block
{
    ...
    public function get_global_information_data()
    {
        ...
        return [
            ...
            [get_lang('Number of open courses'), '<a href="/admin/course-list?keyword_visibility='.COURSE_VISIBILITY_OPEN_PLATFORM.'">'.Statistics::countCoursesByVisibility([COURSE_VISIBILITY_OPEN_PLATFORM]).'</a>'],
            [get_lang('Number of private courses'), '<a href="/admin/course-list?keyword_visibility='.COURSE_VISIBILITY_REGISTERED.'">'.Statistics::countCoursesByVisibility([COURSE_VISIBILITY_REGISTERED]).'</a>'],
            [get_lang('Number of closed courses'), '<a href="/admin/course-list?keyword_visibility='.COURSE_VISIBILITY_CLOSED.'">'.Statistics::countCoursesByVisibility([COURSE_VISIBILITY_CLOSED]).'</a>'],
            [get_lang('Number of hidden courses'), '<a href="/admin/course-list?keyword_visibility='.COURSE_VISIBILITY_HIDDEN.'">'.Statistics::countCoursesByVisibility([COURSE_VISIBILITY_HIDDEN]).'</a>'],
        ];
    }
}
