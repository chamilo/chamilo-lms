...
*/
$OpenBadgesBannerText = "Você pode gerar emblemas para as habilidades aprendidas por seus usuários, para lhes dar reconhecimento por seu esforço, através do qual eles serão capazes de mostrar as habilidades adquiridas e competências com ícones que serão mostrados em seu perfil de usuário. Para obter mais informações sobre o OpenBadges, consulte http://openbadges.org/.";
$OpenBadgesIntroduction = "Agora você pode projetar emblemas e habilidades adquiridas para a aprendizagem através de seus cursos neste campus virtual.";
...
$HyperbolicCotangentCoth = "Hiperbólica cotangente:\t\tcoth(x)";
...
$SocialWriteNewComment = "Escreva um novo comentário";
$SocialWallWhatAreYouThinkingAbout = "No que você está pensando?";
...
$QuestionEditionNotAvailableBecauseItIsAlreadyAnsweredHoweverYouCanCopyItAndModifyTheCopy = "A edição da pergunta não está disponível porque a mesma já foi respondida. No entanto, você pode copiá-la e, então, modificá-la.";
...
$YourLanguageNotThereContactUs = "Não encontrou seu idioma na lista? Contate-nos através do e-mail info@chamilo.org ou contribua como um tradutor.";
...
$IfYouWantOnlyIntegerValuesWriteBothLimitsWithoutDecimals = "Se você quer apenas valores inteiros, escreva ambos os limites sem casas decimais";
$GiveAnswerVariations = "Por favor, escrever quantas variações de pergunta que você quer";
...
$MobilePhoneNumberWrong = "Número de telefone/celular está incompleto ou possui caracteres inválidos";
$CountryDialCode = "Inclua o código de discagem do país";
...
$UserNeverAccessedSessionDefaultDurationIsX = "Este usuário nunca acessou esta sessão antes. A duração está definida para %s dias (a partir da primeira data de acesso).";
...
$UsersWithoutTask = "Alunos que não enviaram trabalhos";
...
$EditingThisEventWillRemoveItFromTheSerie = "Editar este evento irá removê-lo da série de eventos";
...
$PDFsMustLookLike = "PDFs deve ser parecidos:";
$ImportZipFileLocation = "Localização do arquivo zip de importação";
$YouMustImportAZipFile = "Você deve importar um arquivo zip";
$ImportPDFIntroToCourses = "Importar PDF de introduções aos cursos";
$SubscribeTeachersToSession = "Inscrever professores à sessão (s)";
$SubscribeStudentsToSession = "Inscrever estudantes à sessão (s)";
...
$RecordYourVoice = "Gravar sua voz";
$RecordIsNotAvailable = "Sem gravações disponíveis";
...
$ImportSessionDrhList = "Importar lista de diretores de RH nestas sessões";
...
$SearchSessions = "Procurar sessões";
...
$ForumContent = "<p>O fórum é uma ferramenta de discussão para trabalho escrito. Diferentemente do e-mail, o fórum é para o público, semi-público ou discussão em grupo.</p>Para usar o fórum Chamilo, os membros podem simplesmente usar seu navegador - não há a necessidade de usar um software separado.</p>Para organizar os fóruns, clique na ferramenta Fóruns. As discussões são organizadas hierarquicamente de acordo com a seguinte estrutura:</p><b> Categoria> Fórum> Tópico> Post </b></p> Para garantir, os membros podem participar do fórum de maneira fácil e eficaz. É essencial, em primeira instância, ser participante do Chamilo para criar categorias e fóruns e para criação de tópicos e mensagens. Por padrão, o fórum contém uma única categoria (público), um tópico exemplo e um exemplo de post. Você pode adicionar fóruns para a categoria, mudar seu título ou criar outras categorias dentro do qual você poderia, então, criar novos fóruns. Não confunda categorias e fóruns, e lembre- que uma categoria que não contém qualquer fórum é inútil e não será exibido. </p>\n<p> A descrição do fórum pode incluir uma lista de seus membros, uma definição de seu propósito, um alvo, uma tarefa, um tema etc.</p><p> Fóruns Grupo não devem ser criados através da ferramenta Fórum, mas através da ferramenta Grupos, onde você pode determinar se seus fóruns de grupos devem ser públicos ou privados, ao mesmo tempo proporcionando um local para a partilha de grupos de documentos. </p><b> Dicas de Ensino </b> </p> Um fórum de aprendizagem não é exatamente o mesmo que os fóruns que você está acostumado a ver na internet. Por um lado, não é possível para os alunos alterar as suas mensagens depois de terem sido publicadas, já que o curso é logicamente arquivado para permitir o rastreamento do que foi dito no passado. Além disso, os fóruns permitem ao Chamilo usos específicos, relevantes ao ensino. Por exemplo, alguns professores/formadores publicam correções diretamente nos fóruns da seguinte maneira: <li> Um aluno é convidado a postar um relatório diretamente para o fórum, </li> O professor corrige-o clicando em Editar (lápis amarelo) e faz marcações usando o editor de gráficos (cor, sublinhado, etc.) </li> Finalmente, outros alunos se beneficiam ao ver as correções que foram feitas na produção de um deles, </ li> Observe que o mesmo princípio pode ser aplicado entre aprendizes, mas vai exigir seu copiar/colar a mensagem de seu colega porque os alunos/formandos não pode editar um mensagens uns aos outros.<li></ul>";
...
$AllowMemberLeaveGroup = "Permitir que membros deixem o grupo";
...
$IfSessionExistsUpdate = "Se existe uma sessão, atualize-a";
...
$ExerciseAikenErrorNoAnswerOptionGiven = "O arquivo importado tem pelo menos uma pergunta sem resposta (ou as respostas não incluem uma letra prefixada). Por favor, certifique-se que cada pergunta tenha pelo menos uma resposta e uma letra prefixada e um ponto ou um parentese, como este: A. uma resposta";
$ExerciseAikenErrorNoCorrectAnswerDefined = "O arquivo importado deve conter pelo menos uma pergunta sem alguma resposta definida. Por favor tenha certeza que todas as perguntas possuam uma RESPOSTA: [Letra] linha.";
$SearchCourseBySession = "Procurar curso por sessão";
$ThereWasAProblemWithYourFile = "Houve um problema desconhecido com seu arquivo. Por favor, revise o formato e tente novamente.";
