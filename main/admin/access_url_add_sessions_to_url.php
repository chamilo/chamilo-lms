...
echo '<a href="'.api_get_path(WEB_CODE_PATH).'admin/access_url_edit_sessions_to_url.php">'.Display::return_icon('edit.gif',get_lang('EditSessionToURL'),'').' '.get_lang('EditSessionToURL').'</a>';
echo '</div>';
