...
$AllowUsersToCreateCoursesTitle = "السماح لغير المسؤولين من انشاء مقررات";
$AllowUsersToCreateCoursesComment = "السماح لغير المسؤولين (المدرسين) من انشاء مقررات جديدة في النظام";
...
$NoWillDeletePermanently = "كلا - سوف يتم حذف الملفات من النظام ولكن يمكن استرجاعها يدويا من خلال مسؤول الخادم";
...
$AllowReservationComment = "يسمح نظام الحجز بحجز الموارد للمقررات (مثل الجداول والغرف والكتب...) فانه يجب عليك تمكينها من خلال المسؤول لكي يتم اظهارها في قائمة المستخدم";
...
$ClickToRegisterAdmin = "انقر هنا لتسجيل المسؤول في كافة المواقع";
$AdminShouldBeRegisterInSite = "يجب تسجيل المسؤول هنا";
$URLNotConfiguredPleaseChangedTo = "URL لم يتم تهيئة الرابط، يرجى اضافة الرابط";
$AdminUserRegisteredToThisURL = "URL تم تخصيص المسؤول الى الرابط التالي";
...
$LanguageDirectoryNotWriteableContactAdmin = "مسار اللغة الذي يستخدم في النظام لحفظ اللغات والذي لا يمكن التعديل عليه، يرجى مراسلة مسؤول النظام لغرض ابلاغه بهذه الرسالة";
...
$ShowCoursesDescriptionsInCatalogTitle = "عرض وصف المقررات في القائمة";
$ShowCoursesDescriptionsInCatalogComment = "عرض وصف المقررات بشكل نافذة منبثقة عند النقر على ايقونة المعلومات في قائمة المقررات";
...
$LPName = "اسم المقرر";
$AuthoringOptions = "خيارات انشاء المحتوى";
...
$NameOfLang['asturian'] = "asturian اللغة الاستورية";
