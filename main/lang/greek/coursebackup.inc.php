...
*/
$langSelectOptionForBackup = "Παρακαλώ επιλέξτε μία μορφή αντιγράφου ασφαλείας";
...
$langImportFinished = "Η εισαγωγή τελείωσε";
$langEvents = "Συμβάντα";
$langAnnouncements = "Ανακοινώσεις";
$langDocuments = "Έγγραφα";
$langTests = "Τεστ";
$langLearnpaths = "Σειρές μαθημάτων";
$langCopyCourse = "Αντιγραφή σειράς μαθημάτων";
$langSelectItemsToCopy = "Επιλογή εκπαιδευτικών αντικειμένων προς αντιγραφή";
$langCopyFinished = "Η αντιγραφή τελείωσε";
$langFullRecycle = "Διαγραφή όλων";
$langRecycleCourse = "Αδειάστε αυτή τη σειρά μαθημάτων";
$langRecycleFinished = "Η ανακύκλωση τελείωσε";
$langRecycleWarning = "Προειδοποίηση: με τη χρήση αυτού του εργαλείου, θα διαγράψετε τα εκπαιδευτικά αντικείμενα στην εκπαίδευσή σας (training). ΔΕΝ υπάρχει δυνατότητα αντιστροφής/ αναίρεσης. Σας συμβουλεύουμε να πάρετε ένα αντίγραφο ασφαλείας (http://translate.chamilo.org/create_backup.php) από πριν.";
...
$langNoResourcesToBackup = "Δεν υπάρχουν πόροι για τους οποίους να ληφθεί αντίγραφο ασφαλείας";
$langNoResourcesInBackupFile = "Δεν υπάρχουν καθόλου πόροι στο αντίγραφο ασφαλείας";
$langSelectResources = "Επιλογή πόρων";
$langNoResourcesToRecycles = "Δεν υπάρχουν πόροι προς ανακύκλωση";
$langIncludeQuestionPool = "Να συμπεριληφθεί η κοινή βάση (pool) των ερωτήσεων";
$langLocalFile = "τοπικό αρχείο";
