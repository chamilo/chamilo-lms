...
class CLpIvObjective
{
     ...
     * @var integer
     *
     * @ORM\Column(name="lp_iv_id", type="bigint", precision=0, scale=0, nullable=false, unique=false)
     */
    private $lpIvId;
     ...
     * @var string
     *
     * @ORM\Column(name="objective_id", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
    private $objectiveId;
     ...
     * @var float
     *
     * @ORM\Column(name="score_raw", type="float", precision=10, scale=0, nullable=false, unique=false)
     */
    private $scoreRaw;
     ...
     * @var float
     *
     * @ORM\Column(name="score_max", type="float", precision=10, scale=0, nullable=false, unique=false)
     */
    private $scoreMax;
     ...
     * @var float
     *
     * @ORM\Column(name="score_min", type="float", precision=10, scale=0, nullable=false, unique=false)
     */
    private $scoreMin;
