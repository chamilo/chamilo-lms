...
$(function() {
    ...
    $(".chzn-select").chosen({
        ...
        no_results_text: '\u005B\u003DSearchNoResultsFound\u003D\u005D',
        placeholder_text_multiple: '\u005B\u003DSelectSomeOptions\u003D\u005D',
        placeholder_text_single: '\u005B\u003DSelectAnOption\u003D\u005D',
        width: "100%"
    });
        ...
        $('video:not(.skip), audio:not(.skip)').mediaelementplayer({
            ...
            var $originalNode = $(originalNode),
                ...
                qMarkersRolls.forEach(function (qMarkerRoll) {
                    var url = 'http://localhost:8030/main/exercise/exercise_submit.php?&'
                        + $.param({
