...
$strings['Max total: %d MB'] = 'Maksimalno ukupno: %d MB';
$strings['Pre-upload Documents'] = 'Unaprijed učitaj dokumente';
$strings['No documents found'] = 'Nema pronađenih dokumenata';
$strings['Failed to load documents'] = 'Učitavanje dokumenata nije uspjelo';
$strings['No meetings or recordings are available yet.'] = 'Još nema dostupnih sastanaka ili snimaka.';
$strings['Share the conference link with allowed participants.'] = 'Podijelite link konferencije sa dozvoljenim učesnicima.';
$strings['presentation'] = 'Prezentacija';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Nadzorna ploča webhookova (Globalno)';
...
$strings['Joined'] = 'Pridružio se';
$strings['Last'] = 'Zadnji';
$strings['Running'] = 'U toku';
...
$strings['No recording'] = 'Nema snimka';
