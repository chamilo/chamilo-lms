...
$strings['uuid_namespace_help'] = "Namespace para los identificadores unicos universales (UUID) usados como IDs de statements.<br>Esto es generado automáticamente por Chamilo LMS. <strong>No reemplazarlo.</strong>";
