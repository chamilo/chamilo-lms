...
$PermissionsForNewFilesComment = "De mogelijkheid om permissies toe te wijzen aan elk nieuw bestand, kan de veiligheid verhogen tegen aanvallen van hackers die gevaarlijke bestanden uploaden in uw portaal. De standaardinstelling (0550) beveiligt uw server voldoende op een aanvaardbaar niv";
$langStudent = "Student";
$Guest = "Gast";
...
$SplitUsersUploadDirectoryComment = "Op intensief gebruikte portalen met veel geregistreerde gebruikers die afbeeldingen uploaden in de uploadfolder (main/upload/users/), kan het voorkomen dat het bestandssysteem het aantal bestanden niet meer aankan (deze fout werd gemeld op een Debian serv";
...
$DropboxAllowStudentToStudentComment = "Studenten mogen documenten versturen naar andere studenten (peer 2 peer, P2P-uitwisseling). Studenten kunnen dit ook voor minder relevante documenten gebruiken (MP3\'s, oplossingen, ...). Als u dit uitschakelt, kunnen studenten enkel naar de lesgevers doc";
...
$PermissionsForNewDirsComment = "De mogelijkheid om permissies toe te wijzen aan elke nieuwe folder, kan de veiligheid verhogen tegen aanvallen van hackers die gevaarlijke bestanden uploaden in uw portaal. De standaardinstelling (0770) beveiligt uw server voldoende op een aanvaardbaar ni";
...
$ImageResizeComment = "Gebruikersafbeeldingen kunnen verkleind worden bij het uploaden als PHP gecompileerd is met de <a href=\\"http://php.net/manual/en/ref.image.php\\" target=\\"_blank\\">GD-bibliotheek</a>. Als GD niet beschikbaar is, wordt deze instelling genegeerd zonder waar";
...
$langVisioconfDescription = "Chamilo Live Conferencing® is een visioconference tool met functionaliteit zoals: tonen van dia presentaties, whiteboard om te tekenen en te schrijven, audio/video duplex, chat. Het vereist juist de Flash® speler en laat drie manier van werken toe: 1 op 1";
...
$VersionCheckExplanation = "Om de automatische versiecontrole te activeren dient u uw campus te registreren op chamilo.com. De bekomen informatie is enkel voor intern gebruik en enkel geaggregeerde informatie zal publiekelijk beschikbaar zijn (totaal aantal campussen, totaal aantal";
...
$PublicPagesComplyToWAIComment = "WAI (Web Accessibility Initiative) is een intitiatief dat webpagina\'s toegankelijker wil maken. Door deze optie te selcteren zullen de publiek toegankelijke pagina\'s van Chamilo toegankelijker worden. Hierdoor kan de inhoud van publiek toegankelijke pag";
...
$UploadExtensionsBlacklistComment = "De blacklist wordt gebruikt om bestands-extensies om te geven die moeten worden gefilterd door ze te verwijderen (of te hernoemen). De extensies moeten  worden ingegeven zonder het voorafgaande punt (.) en worden gescheiden door middel van punt-komma (;).";
$UploadExtensionsWhitelistComment = "De whitelist wordt gebruikt om extensies te filteren (verwijderen of hernoemen) die niet in de whitelist voorkomen. Deze vorm wordt algemeen als veiliger beschouwd, maar is veel gerestricteerder. De extensies moeten worden ingegeven zonder het punt (.) en";
$UploadExtensionsSkip = "Filtergedrag (sla over/hernoem)";
$UploadExtensionsSkipComment = "Indien u kiest om over te slaan, worden bestanden, gefilterd door de blacklist of whitelist, niet geüpload naar het systeem.Als u kiest om te hernoemen, wordt de extensies vervangen door diegene die is opgegeven in het systeem. Let op dat hernoemen geen e";
...
$PlatformCharsetComment = "De tekenset (karakterset) bepaalt de manier waarop specifieke talen in Chamilo kunnen weergegeven worden. Gebruikt u bijvoorbeeld Russische of Japanse tekens, dan kan het aangewezen zijn dit aan te passen. Maar voor alle Engelse, Latijnse en Westeuropese";
...
$NoReplyEmailAddressComment = "Dit is het e-mail-adres dat gebruikt wordt wanneer een e-mail moet verstuurd worden waarin uitdrukkelijk wordt verzocht die niet te beantwoorden. Meestal wordt dit e-mail-adres zodanig geconfigureerd op uw server dat inkomende mails worden genegeerd/verwi";
...
$InstallDirAccessibleSecurityThreat = "De map main/install van uw Chamilo-systeem is nog steeds toegankelijk voor webgebruikers. Dit houdt een beveiligingsrisico in voor uw installatie. Wij adviseren u deze map te verwijderen, of de permissies ervan te wijzigen zodat webgebruikers geen toegang";
...
$UserThemeSelectionComment = "Gebruikers toestaan een eigen visueel thema te kiezen in hun profiel. Daardoor zal Chamilo er voor hen anders uitzien, zonder de standaardstijl van het portaal te wijzigen. Heeft een specifieke cursus of sessie een eigen thema, dan krijgt dit voorrang bov";
$AllowurlfopenIsSetToOff = "De PHP-instelling \\"allow_url_fopen\\" staat op \\"off\\". Daardoor kan het registratiemechanisme niet correct functioneren. Deze instelling kan gewijzigd worden in uw PHP-configuratiebestand (php.ini) of in de Apache Virtual Host configuratie, via de instru";
...
$UserFieldsAddHelp = "Een gebruikersveld toevoegen is gemakkelijk <br />- kies een identificatie dat bestaat uit één woord en uitsluitend kleine letters zonder speciale karakters<br />- kies de tekst die moet verschijnen voor de gebruiker (als u een bestaande taalvariabele geb";
$AllowCourseThemeTitle = "Het gebruik van cursusstijlbladen mogelijk maken";
$AllowCourseThemeComment = "Door het toe te laten om cursusstijlbladen te gebruiken kan de cursusbeheerder elk stijlblad van Chamilo gebruiken als layout voor zijn/haar cursus. Als een gebruiker de cursus betreed zal het stijlblad van de cursus voorrang hebben op het stijlblad van d";
...
$ShowClosedCoursesComment = "Moeten gesloten cursussen weergegeven worden op de loginpagina en de campus startpagina? Op de campus startpagina zal er voor de ingelogde gebruikers eveneens een icoontje verschijnen om in te schrijven voor deze cursus als dit toegelaten is en de gebruik";
$LDAPConnectionError = "LDAP verbindingsfout";
$LDAP = "LDAP";
$LDAPEnableTitle = "Activeer LDAP";
$LDAPEnableComment = "Als u een LDAP server wilt gebruiken als authenticatie voor Chamilo dan kunt u de instellingen hieronder gebruiken om dit te configureren. U zult ook nog het Chamilo configuratiebestand dienen aan te passen zoals beschreven staan in de installatiegids. Me";
...
$LDAPFilledTutorFieldComment = "Een controle wordt uitgevoerd op dit contact veld van de LDAP server voor het toevoegen van nieuwe gebruikers. Als dit veld niet leeg is dan zal de gebruiker beschouwd worden als lesgever en als dusdanig toegevoegd worden in Chamilo. Als u wilt dat al uw";
...
$VisioUseRtmptComment = "Het rmtpt protocol maakt het mogelijk om de videoconferentiesoftware te gebruik vanachter een firewall door de communicatie over poort 80 te laten lopen. Dit zal echter de stream vertragen. Het is dus aangeraden om dit enkel te gebruiken als dit noodzakel";
...
$LDAPFilledTutorFieldValueComment = "Als een check wordt gedaan op het hierboven gegeven begeleiderveld, dan dient deze waarde in een van de begeleider subvelden te vinden zijn voordat de gebruiker beschouwd wordt als lesgever. Als u dit veld leeg laat dan is de enige voorwaarde dat dit veld";
...
$AllowReservationComment = "Met het reserveringssysteem kunt u materiaal dat u voor uw trainingen er beschikking hebt laten reserveren. We denken hierbij aan bijvoorbeeld lokalen, tafels, projectoren, draagbare computers, ... U dient deze functionaliteit te activeren via het platfor";
...
$AllowUseSubLanguageComment = "Wanneer u deze optie inschakelt, kunt u afwijkende vertalingen definiëren voor specifieke termen die op het platform gebruikt worden. Deze extra vertalingen vormen dan een extensie van de reeds bestaande taal. Deze optie is terug te vinden in de talen-sec";
