...
$GradebookWelcomeMessage = "Bem-vindo à ferramenta de Avaliações. Esta ferramenta permite avaliar as competências na sua organização. Permite gerar relatórios de Competências, combinando os resultados de diversas actividades de aprendizagem - actividades em sala com actividades on-l";
...
$PresenceSheetFormatExplanation = "Deve utilizar a folha de presença disponível acima para download. Esta folha contém uma lista de presença de todos os formandos neste curso. A primeira coluna do ficheiro XLS é o código oficial do candidato/formando, seguido pelo último e primeiro nome de";
