...
$Options = "Opcije";
$WelcomeOogieConverter = "Dobrodošli v OOgie, pretvornik za datoteke v PowerPoint obliki <ul type=\\"1\\"><li>Prebrskajte za datotekami .ppt ali .odp</li><li>Naložite jih v Oogie. Ta jih bo pretvoril v Scorm obliko učne poti.</li><li>Po naložitvi imate možnost vsakemu diapozitivu do";
...
$HelpDefaultDirDocuments = "Ta mapa vsebuje privzeti arhiv. Vsebino lahko odstranite ali pa dodate novo. V primeru, da so datoteke označene kot skrite in kot take vstavljene v spletni dokument, jih tečajniki ne bodo videli v svojem področju dokumentov. Ko vstavljate datoteko v splet";
$HelpSharedFolder = "Ta mapa vsebuje datoteke, ki jih tečajniki (ali vi sami) prenesete v področje tečaja preko urejevalnika (če jih niso/niste prenesli preko orodij skupine). Privzeto bodo vidne vsem učiteljem in skrite tečajnikom (razen v primeru direktnega dostopa do datot";
