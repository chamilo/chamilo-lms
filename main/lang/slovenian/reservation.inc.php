...
$ItemRightDeleted = "Dovoljenja elementa so bila odstranjena.";
$MItemRights = "Pravice elementa";
$MReservationRight = "Dovoljenja rezervacij";
$ItemRightEdited = "Dovoljenja elementa so bila ažurirana.";
$NoRights = "Brez pravic";
$MItemRights2 = "Dovoljenja elementa";
$MAddClassgroup = "Dodaj razred/skupino";
$EditItemRight = "Uredi dovoljenja elementa";
$DeleteItemRight = "Odstrani dovoljenja elementa";
$MBookingPeriodsRight = "Dovoljenja rezervacijskega obdobja";
$ViewItemRight = "Poglej dovoljenja elementa";
$DeleteSelectedItemRights = "Odstrani dovoljenja za izbran element";
$SetEditRights = "Nastavi dovoljenje za urejanje";
$UnsetEditRights = "Odstrani dovoljenje za urejanje";
$SetDeleteRights = "Dodeli dovoljenje za brisanje";
$UnsetDeleteRights = "Odstrani dovoljenje za brisanje";
$SetMresRights = "Dodeli dovoljenje za rezervacijo";
$UnsetMresRights = "Odstrani dovoljenje za rezervacijo";
$SetViewRights = "Dodeli dovoljenje za vpogled";
$UnsetViewRights = "Odstrani dovoljenje za vpogled";
$SetAllRights = "Dodeli vsa dovoljenja";
$UnsetAllRights = "Odstrani vsa dovoljenja";
$ItemCourse = "Element tečaja";
$MItemRight = "Dovoljenja elementa";
$EditItem2 = "Uredi element";
$ItemManagerHeader = "Upravljalec elementa";
$LangClass = "Razred";
$MReservationPeriodsRight = "Dovoljenja rezervacijskega obdobja";
$AddNewItem = "Dodaj nov element";
$ItemName = "Ime elementa";
$ItemDescription = "Opis elementa";
$ItemExist = "Element že obstaja";
$EditItem = "Uredi element";
$ItemEdited = "Element je bil ažuriran";
$CategoryFilter = "Filter kategorije";
$ItemCreator = "Avtor elementa";
$DeleteSelectedItems = "Odstrani izbrane elemente";
$BookingPeriodTimepickerLimitation = "Omejitve izbirnika časa pri rezervacijah";
$Blackout = "Prazno";
$EveryDay = "Vsak dan";
$EveryWeek = "Vsak teden";
$EveryMonth = "Vsak mesec";
$ReservationForDenied = "Rezervacija je bila zavrnjena";
$BookingPeriodTooSmall = "Rezervacijsko obdobje je prekratko.";
$BookingPeriodTooBig = "Rezervacijsko obdobje je predolgo.";
$PermissionsStored = "Dovoljenja so bila shranjena";
$PermissionGranted = "Dovoljenja so odobrena";
$PermissionRevoked = "Dovoljenje je preklicano";
$RoleGranted = "Vloga je odobrena";
$RoleRevoked = "Vloga je preklicana";
$ErrorPleaseGiveRoleName = "Prosim, dodelite vlogi ime";
$RoleDeleted = "Vloga je bila odstranjena";
$AddRole = "Dodaj vlogo";
$RoleComment = "Vloga je element ki dovoljuje dodeljevanje prednastavljenih pravic uporabniku ali skupini uporabnikov.";
$DefaultRole = "Privzeta vloga";
$PermissionsOfRole = "Dovoljenja za vlogo";
$IsPlatformRoleNotEditable = "Je vloga platforme ne-spremenljiva?";
$UserPermissions = "Uporabnikova dovoljenja";
?>