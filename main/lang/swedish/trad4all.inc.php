...
$RegisteredGuestCourseMemberRoleDescription = "Användare som är registrerad på plattformen, som besöker en kurs(er) som han inte prenumererar på";
$NormalCourseMemberRoleDescription = "En registrerad användare, (student, trainee) som prenumererar på kursen";
