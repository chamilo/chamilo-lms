...
$langAccountExist = "Esta cuenta existe.<BR>Un mensaje se envió al administrador.<BR>";
$langAccountNotExist = "No se encontró la cuenta.<BR>Un mensaje se envió al administrador. El puede buscar manualmente.<BR>";
