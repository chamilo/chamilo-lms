...
$Upload = "Upload";
$FilingName = "Name";
$FilingOtherAs = "neues Verzeichnis ==>";
$FilingSelected = "Empfangene / Gesendete (original)";
$FilingRefile = "Ausgewählten Dateien sortieren";
$FilingFolders = "Nur Verzeichnis anzeigen";
$BackList = "Zurück zur eigenen Dateikiste";
$ShowFeedback = "Antworten zeigen";
$GiveFeedback = "Antwort schreiben/bearbeiten";
$JustUploadInList = "Versenden mit";
...
$FileSize = "Dateigröße";
$Title = "Titel";
$FirstDate = "Erster Versand";
$LastDate = "Letzter Versand";
...
$SentTo = "Gesendet an";
$SentBy = "Erstellt von";
$WorkDelete = "Datei aus Liste löschen";
$AllDocuments = "Alle Dateien";
...
$InvalidUserDetected = "Ungültige Benutzer erkannt";
$InvalidGroupDetected = "Ungültige Gruppe erkannt";
