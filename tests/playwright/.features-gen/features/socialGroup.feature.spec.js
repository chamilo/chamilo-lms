...
test.describe('Social Group', () => {
  ...
  test('Invite a friend to group', { tag: ['@slow-scenario'] }, async ({ Given, When, Then, And, page }) => { 
    await Given('I am a platform administrator', null, { page }); 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":18,"pickleLine":75,"tags":["@slow-scenario"],"steps":[{"pwStepLine":19,"gherkinStepLine":76,"keywordType":"Context","textWithKeyword":"Given I am a platform administrator","stepMatchArguments":[]},{"pwStepLine":20,"gherkinStepLine":77,"keywordType":"Context","textWithKeyword":"And I have a friend named \"fbaggins\"","stepMatchArguments":[{"group":{"start":22,"value":"\"fbaggins\"","children":[{"start":23,"value":"fbaggins","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":21,"gherkinStepLine":78,"keywordType":"Action","textWithKeyword":"When I invite the friend to the social group I just created","stepMatchArguments":[]},{"pwStepLine":22,"gherkinStepLine":79,"keywordType":"Outcome","textWithKeyword":"Then I should see \"Users already invited\"","stepMatchArguments":[{"group":{"start":13,"value":"\"Users already invited\"","children":[{"start":14,"value":"Users already invited","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":23,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"And I should not see an error","stepMatchArguments":[]}]},
]; // bdd-data-end