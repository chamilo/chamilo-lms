...
$langHotspotChoose = "<div style=\"padding:2px 3px;\">??萄遣?梢?儭啣???豢??憿??脣???????敶Ｙ?嗅??怠?箇?梢?</div><div style=\"padding:2px 3px;\">?蝘餃???梢?儭啣???豢??憿??脣???????敶Ｙ?嗅??怠?箸?啁???梢?</div><div style=\"padding:2px 3px;\">?????憭???敶ｇ萼暺????喲?萇?嗅??豢??????憭???敶↘/div><div style=\"padding:2px 3px;\"></div>";
$Fault = "不正確";
$Hotspot = "圖像區";
$ClickNumber = "按數字";
