...
$langAnnEmpty = "Abisu guztiak garbitu dira";
...
$langEmailSent = "eta erregistrodun ikasleei bidali zaie";
$EmailOption = "Bidali abisu hau posta elektronikoaren bidez hautatutako taldeei/erabiltzaileei";
$langOn = "Honen gainean:";
$langRegUser = "gunean erregistraturiko erabiltzaileak";
$langUnvalid = "posta elektronokiko helbiderik ez dute edo ez du balio";
$langModifAnn = "Aldatu abisu hau";
$langModify = "Editatu";
$langDelete = "ezabatu";
$langTitle = "Gaia";
$langHelp = "laguntza";
$langOk = "Onartu";
$langAddIntro = "Gehitu atariko testu bat";
$langBackList = "Itzuli zerrendara";
$langSelMess = "Ohartarazi erabiltzaile batzuei";
$EmailTitle = "Mezuaren gaia";
$langUserlist = "Erabiltzaile eta talde zerrenda";
$langSelectedUsers = "Hautatutako erabiltzaileak";
$langSubmit = "Bidali";
$langPleaseEnterMessage = "Mezuaren testua sartu behar duzu";
$langPleaseSelectUsers = "Erabiltzaile baten bat hautatu behar duzu";
$Teachersubject = "Mezua erabiltzaileei bidali zaie";
$langMessages = "Mezuak";
$langMessageToSelectedUsers = "Mezuak hautatutako erabiltzaileentzat";
$langIntroText = "Mezu bat bidaltzeko, hautatu erabiltzaileen taldeak (aurretik G marka dutenak) edo ezkerreko zerrendan dauden banako erabiltzaileei (U marka dutenak)";
$langDown = "behera";
$langMsgSent = "Mezua hautatutako ikasleei bidali zaie";
$langSelUser = "hautatu guneko erabiltzaileak";
$langMessageToSelectedGroups = "Mezua hautatutako taldeentzat";
$langSelectedGroups = "hautatu diren taldeak";
$langMsg = "Mezuak";
$langYes = "bai";
$MsgText = "Mezua";
