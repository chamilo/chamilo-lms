svgEditor.readLang({
	...
	ui: {
		...
		"panel_drag": "Arrastrar izquierda/derecha para cambiar el tamaño del panel"
	},
	properties: {
		"id": "Identificación del elemento",
	...
	tools: { 
		...
		"align_to_page": "Alinear el elemento a la página",
		...
		"mode_rect": "Rectángulo",
		"mode_square": "Cuadrado",
		"mode_fhrect": "Rectángulo a mano alzada",
		"mode_ellipse": "Elipse",
		"mode_circle": "Círculo",
		"mode_fhellipse": "Elipse a mano alzada",
		"mode_path": "Trazado",
		"mode_shapelib": "Biblioteca de figuras",
		...
		"del": "Eliminar elemento(s)",
		"group": "Agrupar objetos",
		"make_link": "Crear (hiper)enlace",
		"set_link_url": "Enlace mediante URL (dejar vacío para quitar)",
		...
		"imagelib": "Biblioteca de imágenes",
		...
		"openclose_path": "Abrir/cerrar sub-path",
		"source_save": "Código fuente",
		"cut": "Cortar",
		"copy": "Copiar",
		"paste": "Pegar",
	...
	config: {
		...
		"editor_img_url": "URL de la imagen",
		...
		"units_and_rulers": "Unidades & Reglas",
		"show_rulers": "Mostrar reglas",
		"base_unit": "Unidad de base:",
		"grid": "Cuadrícula",
		"snapping_onoff": "Ajuste si/no",
		"snapping_stepsize": "Tamaño de los pasos de ajuste:"
	},
	shape_cats: {
		"basic": "Básico",
		"object": "Objetos",
		...
		"music": "Música",
		"misc": "Miscelánea",
		"raphael_1": "Set 1 de raphaeljs.com",
		"raphael_2": "Set 2 de raphaeljs.com"
	},
	imagelib: {
		"select_lib": "Seleccione una biblioteca de imágenes",
		"show_list": "Muestrar la lista de bibliotecas",
		"import_single": "Importación simple",
		"import_multi": "Importación múltiple",
		"open": "Abrir como un nuevo documento"
	},
	notification: {
		...
		"QwantToOpen":"¿Quiere abrir un nuevo archivo?\nEste cambio no podrá deshacerse y volver atrás !",
		...
		"enterNewLinkURL": "Introduzca el nuevo enlace URL",
		"errorLoadingSVG": "Error: No se pueden cargar los datos SVG",
		"URLloadFail": "No se puede cargar desde la URL",
