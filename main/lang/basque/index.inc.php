...
*/
$langInvalidId = "Konexioak huts egin du - identifikatzailea edo pasahitza okerrak dira";
$langWelcome = "Ongi etorri!";
$langPass = "Pasahitza";
$langEnter = "Itzuli ikastaro zerrendara";
$langReg = "Erregistroa";
$langMenu = "Menua";
$langAdvises = "Aholkuak";
$langCourseDoesntExist = "Abisua: ikastaro hau ez da";
$langGetCourseFromOldPortal = "klikatu hemen ikastaro hau zure atari zaharretik ekartzeko";
$langOtherCourses = "beste ikastaro batzuk";
$langSupportForum = "Laguntzeko foroa";
$langCategories = "kategoriak";
$langBackToHomePage = "Itzuli orri nagusira";
$lang_No_course_publicly_available = "Ez dago ikastaro publiko erabilgarririk";
$langLostPassword = "Pasahitza ahaztuta?";
$lang_edit_my_course_list = "Editatu ikastaro zerrenda";
$langAgenda = "Agenda";
$langValvas = "Azken abisuak";
$langUp = "Gora";
$langCatList = "Kategoriak";
$langCourseList = "Ikastaro zerrenda";
$langHelptwo = "Laguntza";
$langRegAll = "Erregistroa";
$EussMenu = "menua";
$Opinio = "Iritzia";
$Intranet = "Intranet";
$Englin = "Ingelesa";
$langInvalidForSelfRegistration = "Konexioak huts egin du - erregistraturik ez bazaude, erregistratzeko datu orria bete dezakezu";
$langSubCat = "azpi-kategoriak";
$langMenuGeneral = "Orokorra";
$langMenuUser = "Erabiltzailearen menua";
$langMenuAdmin = "Plataformaren kudeatzailea";
$langUsersOnLineList = "Online erabiltzaile zerrenda";
$langTotalOnLine = "Online. guztira";
$langRefresh = "Freskatu";
$langMe = "ni";
$langSystemAnnouncements = "Sistemaren berriak";
$langHelpMaj = "Laguntza";
$langNotRegistered = "Erregistratu gabe";
$langAdmin = "Plataformaren kudeatzailea";
$Login = "Identifikatzailea (Saioa hasi)";
$langRegisterForCourse = "Inskribatu ikastaroan";
$langUnregisterForCourse = "Kendu inskripzioa ikastarotik";
$langCombinedCourse = "Ikastaro konbinatua";
$Platform = "Plataforma";
$Refresh = "Freskatu";
$TotalOnLine = "erabiltzaileak online, guztira";
$langCourseClosed = "(ikastaroa une honetan itxita dago)";
$ViewOpenCourses = "Ikusi irekitako ikastaroak";
$langCompetences = "Gaitasunak";
$langDiplomas = "Diplomak";
$langTeach = "Zer irakatsi dezake";
$langProductions = "Produkzioak";
$langSendChatRequest = "Bidali txateatzeko eskaera pertsona honi";
$langRequestDenied = "Gonbiteari uko egin dio";
