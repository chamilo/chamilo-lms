...
$langAddPageToSite = "Yapay hoq raphita k'itiman";
$langCouldNotSendPage = "Kay khipuqa manan kashanchu HTML nisqapi chay rayku mana apachimunmanchu.Sichus munanki  servidornisqaman  HTML nisqamanta  hoqniraq kjiputa (PDF, Power Point, Word...) Hapipay kayta <a href=../document/document.php>Qelqa khipukunata</a>";
$langSendPage = "Apachiy raphita";
$langPageTitleModified = "Raphiq sutinchayninqa t'ijrachikunña";
$langPageAdded = "Raphiqa yapachisqaña";
$langAddPage = "Yapay hoq raphita";
$Choose = "Maskharillay";
?>