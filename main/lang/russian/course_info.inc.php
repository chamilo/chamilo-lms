...
$langByDel = "Удаляя данный сайт, вы удалите все учебные материалы, ссылки, которые он содержит. Кроме того, будет закрыт доступ всем членам курса, которые были на него подписаны (но Вы их не удаляете из других курсов). <p>Вы действительно хотите очистить все пространс";
$langY = "ДА";
$langN = "НЕТ";
...
$langDescriptionCopyCourse = "Докеос дает возможность дублировать (дкопировать) частично или весь существующий курс в другой курс, который изначальна может быть пустым.<br /><br />Едиственным условием для такого обращения является то, что нужно иметь курс, который содержал бы какие-нибудь";
