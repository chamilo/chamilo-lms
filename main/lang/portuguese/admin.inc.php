...
$langUpgradeBase = "Actualizar da base-de-dados";
...
$DefaultDocumentQuotumComment = "Qual é o espaço disponível em disco? Pode definir o espaço a ultrapassar para cursos específicos através de: Administração de plataforma > Cursos > modificar";
...
$NoSearchResults = "Não há resultados da pesquisa";
...
$DropboxMaxFilesizeTitle = "Caixa de entrega: Tamanho máximo do ficheiro de um documento";
...
$MaxImageWidthTitle = "Tamanho máximo em largura da imagem do utilizador";
$MaxImageWidthComment = "Tamanho de largura máximo em pixels de uma imagem do utilizador. Esta opção só se aplica se as imagens do utilizador estiverem definidas para serem redimensionada no momento do envio/upload.";
$MaxImageHeightTitle = "Tamanho máximo em altura da imagem do utilizador";
$MaxImageHeightComment = "Tamanho de altura máximo em pixels de uma imagem do utilizador. Esta opção só se aplica se as imagens do utilizador estiverem definidas para serem redimensionada no momento do envio/upload.";
...
$EnableToolIntroductionTitle = "Activar introdução da ferramenta";
$EnableToolIntroductionComment = "Activar introduções nas página de cada ferramenta";
$BreadCrumbsCourseHomepageTitle = "Breadcrumb (ligações/links auxiliares de navegação) da página inicial/homepage do curso";
$BreadCrumbsCourseHomepageComment = "O breadcrumb é o sistema horizontal de ligações/links de navegação, normalmente localizado na parte esquerda do topo da página. Esta opção selecciona aquilo que deseja que apareça no breadcrumb das páginas iniciais/homepages dos cursos.";
$Comment = "Comentário";
$Version = "Versão";
...
$VideoClassroomUrl = "Caminho/atalho para a sala de aula da conferência ao vivo";
$ReconfigureExtension = "Reconfigurar extensão";
$ServiceReconfigured = "Serviço reconfigurado";
$ChooseNewsLanguage = "Seleccionar idioma das notícias/novidades";
...
$EphorusDescription = "Comece a utilizar o serviço anti-plágio Ephorus no Dokeos.<br /> <STRONG>Com o Ephorus, impedirá o plágio através da Internet sem qualquer esforço adicional.</STRONG><br /> Pode utilizar o nosso serviço web para construir a sua própria integração ou utilizar um dos módulos de integração do Dokeos.";
...
$TabsGradebookEnableUpperLimit = "Activar mostrar da pontuação máxima";
