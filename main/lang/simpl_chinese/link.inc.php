...
$langCsvFileNotFound = "导入的CSV文件不能被打开（例如：空或太大）";
$langCsvFileNoSeps = "导入的CSV文件正在使用或 ; 作为行的分隔符";
$langCsvFileNoURL = "导入的CSV文件必须有网址和标题列";
$langCsvFileLine1 = "... -第一行=";
$langCsvLinesFailed = "导入链接到行失败（无网址或标题）。";
$langCsvLinesOld = "现有链接已更新（相同网址与分类）。";
$langCsvLinesNew = "链接已创建。";
$langCsvExplain = "文件的特征是：  <BLOCKQUOTE><PRE><B>URL</B>;category;<B>title</B>;description;<B>http://www.aaa.org/...</B>;Important links;<B>Name 1</B>;Description 1;<B>http://www.bbb.net/...</B>;;<B>Name 2</B>;\\"Description 2\\";</PRE></BLOCKQUOTE>如果网页或分类与已经存在的那些链接相同，它的标题和描述已";
