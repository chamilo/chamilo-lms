...
$langManifestSyntax = "(error de sintaxis en el fichero manifest...)";
$langEmptyManifest = "(el fichero manifest está vacío...)";
$langNoManifest = "(no existe el fichero manifest...)";
...
$langImport = "Importar";
$langRemove = "Borrar entradas de metadatos (MDE)";
