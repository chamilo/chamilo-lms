...
$ReturnToLearningPaths = "Terug naar cursussen";
$UploadMp3audio = "Upload mp3 audio";
$UpdateAllAudioFragments = "Geluidsfragment toevoegen";
$LeaveEmptyToKeepCurrentFile = "Laat het importeerveld leeg om huidige audio te behouden";
$RemoveAudio = "Verwijder audio";
$SaveAudio = "Doorgaan";
$ChangesStored = "Audio toegevoegd";
$ViewScoreChangeHistory = "Bekijk scoregeschiedenis";
$ImageWillResizeMsg = "Leraarsafbeelding zal herschalen indien nodig";
...
$UnknownPackageFormat = "Het formaat van dit pakket wordt niet herkend. Controleer dat dit een geldig pakket is.";
...
$ModifyPrerequisites = "Bewaar ingangseisinstellingen";
$CreateLearningPath = "Doorgaan";
$AddExercise = "Voeg oefening toe aan cursus";
...
$ObjectiveRawScore = "Doelstelling ruwe score";
$ObjectiveMaxScore = "Doelsteling maximum score";
$ObjectiveMinScore = "Doelstelling minimum score";
$LPName = "Cursusnaam";
$AuthoringOptions = "Opstelopties";
...
$EnableTimeLimits = "Stel beschikbaarheidsgrenzen in";
$PublicationDate = "Datum van publicatie";
$UseMaxScore100 = "Gebruik standaardmaximumscore van 100";
$EnableLPAutoLaunch = "Gebruik leerpad auto-start";
$DisableLPAutoLaunch = "Gebruik leerpad auto-start niet";
$ViewModeEmbedFrame = "Huidig zicht: extern invoegen. Gebruik alleen om externe webpagina's in te voegen.";
$LPNotVisibleToStudent = "Leerlingen kunnen dit leerpad niet zien";
$EditCurrentModule = "Bewerk huidige module";
$SearchFeatureTerms = "Termen voor de zoekmachine";
$PrerequisiteDeletedError = "Fout: het onderdeel wat als ingangseis gebruikt wordt is verwijderd.";
?>