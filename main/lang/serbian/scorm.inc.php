...
$langScormRestarted = "Sve lekcije su za sada nedovrene.";
$langScormNoNext = "ovo je poslednja lekcija";
$langScormNoPrev = "Ovo je prva lekcija";
$langScormTime = "Vreme";
$langScormNoOrder = "Nije zadat redosled, moete da kliknete na bilo koju lekciju.";
$langScormScore = "Rezultat";
$langScormLessonTitle = "Naslov lekcije";
$langScormStatus = "Status";
$langScormToEnter = "Za unos";
$langScormFirstNeedTo = "potrebno Vam je prvo izvrenje";
$langScormThisStatus = "Ova lekcija je sad";
$langScormClose = "Zavri";
$langScormRestart = "Restartuj";
$langScormCompstatus = "Zavrena";
$langScormIncomplete = "Nezavrena";
...
$langScormNoItems = "Ovaj sadraj nema stavke.";
$langScormNoStatus = "Nema statusa za ovaj sadraj";
$langScormLoggedout = "odjavljen iz Scorm okruenja";
