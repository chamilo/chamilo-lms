...
$strings['QuizQuestionsScoreRulesTitleConfirm'] = 'Изменение формулы оценки вносит изменения для каждого вопроса в упражнении и не позволяет отменить это изменение ниже. Вы уверены, что хотите продолжить?';
$strings['EvaluationFormula'] = 'Формула оценки';
$strings['NoFormula'] = 'Без формулы';
$strings['Formula1'] = 'Успехи - Неудачи';
$strings['Formula2'] = 'Успехи - Неудачи / 2';
$strings['Formula3'] = 'Успехи - Неудачи / 3';
