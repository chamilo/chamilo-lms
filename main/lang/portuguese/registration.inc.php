...
$langUserAddExplanation = "Cada linha do ficheiro para enviar deve necessáriamente conter apenas os 5 campos seguintes: <b>Primeiro nome   Último nome   Login/acesso   Senha/password   E-mail</b> separados por tabulações e nessa ordem. Os utilizadores receberão um e-mail de confirm";
...
$AccountsExternalAuthSource = "O Chamilo não consegue responder automaticamente ao pedido porque pelo menos uma das contas possui uma fonte de autenticação externa. Por favor, tome as medidas adequadas para todos os utilizadores (incluindo os que possuem autenticação da plataforma) e n";
