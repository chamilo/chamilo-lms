...
// chat.php
 ...
 $langHome='Accueil';
 $langTextEditorDefault='<h2>Editeur de texte</h2>Coupez et collez ici un texte provenant de MS Word&reg; et éditez-le. Les autres participants verront vos modifications en direct.';
 $langLinks='Liens';
