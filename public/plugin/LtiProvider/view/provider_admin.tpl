...
{{ 'LtiProviderDescription'|get_plugin_lang('LtiProviderPlugin') }}
    ...
    <div class="btn-toolbar">
        <a href="{{ url('index') }}plugin/LtiProvider/provider_settings.php" class="btn btn-link pull-right ajax" data-title="{{ 'ConnectionDetails'|get_plugin_lang('LtiProviderPlugin') }}">
            <span class="fa fa-cogs fa-fw" aria-hidden="true"></span> {{ 'ConnectionDetails'|get_plugin_lang('LtiProviderPlugin') }}
        </a>
        <a href="{{ url('index') }}plugin/LtiProvider/create.php" class="btn btn-primary">
        ...
        <table class="table table-striped table-hover admin-tools">
            ...
            {% set url_params = {'id': platform.getId}|url_encode() %}
                <tr>
                    ...
                    <td>
                        <a href="{{ url('index') }}plugin/LtiProvider/edit.php?{{ url_params }}">
                            {{ 'edit.png'|img(22, 'Edit'|get_lang) }}
                        </a>
                        <a href="{{ url('index') }}plugin/LtiProvider/delete.php?{{ url_params }}">
