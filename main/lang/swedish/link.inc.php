...
$langLinkMod = "Modifiera länk";
$langLinkModded = "Länken är modifierad";
$langLinkDel = "Länk raderad";
...
$langCsvImport = "Importera en CSV-fil";
$langCsvFileNotFound = "Importerad CSV kunde inte öppnas (den kan vara tom, för stor el. likn.)";
$langCsvFileNoSeps = "Importerad CSV fil måste använda , eller ; som separator.";
$langCsvFileNoURL = "Importerad CSV fil måste åtminstone ha kolumner URL och en titel.";
$langCsvFileLine1 = "... - rad 1 =";
