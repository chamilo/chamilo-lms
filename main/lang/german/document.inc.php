...
$Options = "Optionen";
$WelcomeOogieConverter = "Willkommen beim Oogie PowerPoint-Konverter<ul type=\\"1\\"><li>Auf der Festplatte nach einer .ppt oder .odp Datei suchen</li><li>In Oogie importieren; die Datei wird in einen Scorm Lernpfad umgewandelt.</li><li>Dann ist es möglich, jedem Bild Audio-Kommenta";
...
$HelpDefaultDirDocuments = "Dieses Verzeichnis beinhaltet das Standard-Archiv. Hier können Dateien gelöscht oder hinzugefügt werden. Wenn eine Datei aber als versteckt gekennzeichnet ist und in einen Kurs eingefügt wird, sehen die Lernenden dieses Objekt nicht. Verzeichnisse können";
$HelpSharedFolder = "Dieses Verzeichnis beinhaltet die Dateien, welche alle Kursteilnehmer über den Editor in den Kurs einbringen. Üblicherweise sind diese für jeden Kursleiter sichtbar, nicht jedoch für andere Kursteilnehmer. Wenn dieser Ordner sichtbar gemacht wird, hat jed";
