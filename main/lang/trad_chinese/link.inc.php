...
$langCsvFileNotFound = "匯入的CSV檔案不能被打開（例如︰空或太大）";
$langCsvFileNoSeps = "匯入的CSV檔案正在使用或 ; 作為行的分隔符";
$langCsvFileNoURL = "匯入的CSV檔案必須有網址和標題列";
$langCsvFileLine1 = "... -第一行=";
$langCsvLinesFailed = "匯入鏈接到行失敗（無網址或標題）。";
$langCsvLinesOld = "現有鏈接已更新（相同網址與分類）。";
$langCsvLinesNew = "鏈接已創建。";
$langCsvExplain = "檔案的特徵是︰  <BLOCKQUOTE><PRE><B>URL</B>;category;<B>title</B>;description;<B>http://www.aaa.org/...</B>;Important links;<B>Name 1</B>;Description 1;<B>http://www.bbb.net/...</B>;;<B>Name 2</B>;\\"Description 2\\";</PRE></BLOCKQUOTE>如果網頁或分類與已經存在的那些鏈接相同，它的標題和描述已";
