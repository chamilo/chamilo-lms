...
$DirectoryAndFilePermissionsInfo = "En del mappar och filer i vissa mappar måste vara skrivbara för webbservern för att Chamilo ska kunna fungera (användarnas filuppladdning, skapandet av kursdelar, mm). Det kan innebära att rättigheterna måste ställas in manuellt (utanför installationsprog";
...
$DBSettingUpgradeIntro = "Uppgraderingsskriptet kommer att återskapa och uppdatera databasen(erna) för Chamilo. För att göra det kommer skriptet använda databasen och inställningarna angivna nedan. Eftersom Chamilo körs i så många olika miljöer och alla kanske inte är testade, rek";
$ExtensionMBStringNotAvailable = "MBString för PHP ej tillänglig";
$ExtensionMySQLNotAvailable = "MySQL-modul för PHP ej tillänglig";
$DokeosArtLicense = "Bilder och mediagallerier i Chamilo använder bilder från Nuvola, Crystal Clear och TangoŽs ikongallerier. Andra bilder och media som diagram och Flash-animationer är lånade från Wikimedia och Ali Pakdel\'s och Denis Hoa\'s kurser med deras tillåtelse och";
