...
<div class="btn-toolbar actions-bar" >
    {% if is_allowed_to_edit %}
        ...
        <a href="{{root}}&amp;action=add" class="notebook btn new term" title="{{'Add'|trans}}">
            <i class="size-32 icon-new-note"></i>
        </a>
            <a href="{{root}}&amp;action=import_csv" class="btn" title="{{'ImportCSV'|trans}}">
    ...
    <div class="btn-group sort">
        ...
        class="btn"
        title="{{'SorteByCreatedDate'|trans}}">
        ...
        class="btn"
        title="{{'SorteByUpdatedDate'|trans}}">
