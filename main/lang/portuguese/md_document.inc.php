...
$langKwHelp = "<br/> Clique no botão '+' para abrir, no botão '-' para fechar, no botão '++' para abrir todos, no botão '--' para fechar todos.<br/> <br/> Elimine todas as palavras-chave seleccionadas fechando a árvore e abrindo-a novamente com o botão '+'.<br/> Alt-clique '+' procura a palavra-chave original na árvore.<br/> <br/> Alt-clique palavra-chave selecciona uma palavra-chave sem termos alargados ou descelecciona uma palavra-chave com termos alargados.<br/> <br/> Se modificar a descrição do idioma, não adicione palavras-chave ao mesmo tempo.<br/> <br/>";
...
$langCourseKwds = "Este documento cont�m as palavras-chave do curso";
