<?php
	...
	*/
	...
	//Title part
	$finalOutH .= '<div class="row">';
	$finalOutH .= '<div class="col-md-12" style="padding-left:30px;" >';
	$finalOutH .= '<h3 class="topTitleFlexContent" >{namecourse}</h3>';
	$finalOutH .= '</div></div>';

	//First part
	$finalOutH .= '<div class="row">';
	
	$finalOutH .= '<div class="col-md-4" style="text-align:center;" >';
	$finalOutH .= '<img id="displayImgCourse" src="{urlplug}img/quizz.png" />';
	$finalOutH .= '</div>';

	$finalOutH .= '<div class="col-md-8">';
	...
	$finalOutH .= '<div class="col-md-1" style="height:90%;" >&nbsp;</div>';

	$finalOutH .= '<div class="col-md-6" style="padding:15px;border-left:solid 4px #CEECF5;" >';
	...
	$finalOutH .= '<div class="col-md-5" style="border-left:solid 4px #CEECF5;" >';
	
	$finalOutH .= '<p style="padding-bottom:2px;" >';
	$finalOutH .= '<b><u>Outils</u></b></p>';
	
	$finalOutH .= tuileCarre('forum.png','Forum');
	$finalOutH .= tuileCarre('gradebook.png','GradeBook');
	$finalOutH .= tuileCarre('documents.png','Documents');

	$finalOutH .= tuileCarre('group.png','Group');
	$finalOutH .= tuileCarre('chat.png','Chat');
	$finalOutH .= tuileCarre('works.png','Works');
	...
	function tuileCarre($img,$title){

		$finH = '<div id="button'.$title.'" class="buttonSpeed" style="margin-top:15px;display:block;" >';
		$finH .= '<a class="linkimage'.$title.'" target="_self" title="Forum">';
		$finH .= '<img src="{urlplug}img/'.$img.'" alt="'.$title.'" title="'.$title.'" >';
		$finH .= '</a>';
		$finH .= '<h4>';
		$finH .= '<a class="linkbutton'.$title.'" title="'.$title.'">'.$title.'</a>';
		$finH .= '</h4>';
		$finH .= '</div>';
