...
$langWarningResponsible = "Используйте этот текст только после создания резервной копии. Команда Chamilo не несет ответственности в случае потери или искажения данных";
...
$langMainDB = "Главная база данных системы Chamilo";
...
$langDBSettingIntro = "Установленный шрифт создаст главную(ые) базу(ы) данных Chamilo. Примине во внимание, что Chamilo создаст несколько баз данных. Если Вам разрешено использовать только одну базу данных Вашим главным сервером, Chamilo не будет работать, пока Вы не выберите опцию \"Одна база данных\".";
$langStep1 = "Шаг 1";
$langStep2 = "Шаг 2";
...
$langSingleDb = "Использовать одну или несколько баз данных (БД) для Chamilo";
...
$langDokeosURL = "URL адрес Chamilo";
...
$DokeosNeedFollowingOnServer = "Для того, чтобы работать в Chamilo, Вам нужно следующее на Вашем сервере";
$WarningExistingDokeosInstallationDetected = "Предупреждение!<br />Исталлятор обнаружил существующую платформу Chamilo в Вашей системе.";
...
$DokeosLicenseInfo = "Chamilo - компьютерная программа в свободном доступе, распространяемая под контролем GNU General Public licence (GPL).";
$IAccept = "Я принимаю";
$ConfigSettingsInfo = "Следующие величины будут записаны в Ваш файл конфигурации";
$DokeosInstallation = "Установка Chamilo";
$InstallDokeos = "Установить Chamilo";
...
$Version_ = "Версия";
$UpdateFromDokeosVersion = "Обновить с Chamilo";
$WelcomToTheDokeosInstaller = "Добро пожаловать в Инсталлятор Chamilo";
