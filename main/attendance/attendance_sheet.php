                        ...
                        foreach ($attendant_calendar as $calendar) {
                            ...
                            if (api_is_allowed_to_edit(null, true)) {
                                if (!$is_locked_attendance || api_is_platform_admin()) {
                                    ...
                                    echo $presence ? Display::return_icon('checkbox_on.png', get_lang('Presence'), null, ICON_SIZE_SMALL) : Display::return_icon('checkbox_off.png', get_lang('Presence'), null, ICON_SIZE_SMALL);
                                }
                            } else {
                                switch ($presence) {
                                    case 1:
    ...
    <table class="data_table">
        ...
        if (!empty($users_presence)) {
            ...
            foreach ($users_presence[$user_id] as $presence) {
                ...
                <tr class="<?php echo $class ?>">
                    <td>
                        <?php echo $presence['presence'] ? Display::return_icon('checkbox_on.png', get_lang('Presence'), null, ICON_SIZE_SMALL) : Display::return_icon('checkbox_off.png', get_lang('Presence'), null, ICON_SIZE_SMALL) ?>
