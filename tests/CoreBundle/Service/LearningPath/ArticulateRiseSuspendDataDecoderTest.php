...
final class ArticulateRiseSuspendDataDecoderTest extends TestCase
{
    ...
    public function testItDetectsRiseV2WhenCoursePackageVersionIsOnlyInWrapper(): void
    {
        $suspendData = '{"v":2,"d":[123,34,112,114,111,103,114,101,115,115,34,58,256,112,266,52,48,125,125],"cpv":"b7-Vukjt"}';

        self::assertSame(40, $this->decoder->extractProgress($suspendData));
        self::assertTrue($this->decoder->isRiseSuspendData($suspendData));
    }
