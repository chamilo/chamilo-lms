...
$Options = "خيارات";
$WelcomeOogieConverter = " مرحبا في أووجيز محول ملفات باوربونت <ul type=\\"1\\"><li> قم بتصفح القرص الصلب على جهازك للبحث عن ملفات بامتداد .ppt أو .odp <li> قم بتحميلها على أووجيز. سيتم تحويلها إلى تنسيق سكورم مسار التعلم. <li> ستتمكن عندها  من إدراج تعليقات صوتية على كل شريحة عرض ك";
