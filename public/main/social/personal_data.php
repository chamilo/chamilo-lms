...
$officerName = api_get_setting('privacy.data_protection_officer_name');
$officerRole = api_get_setting('privacy.data_protection_officer_role');
$officerEmail = api_get_setting('privacy.data_protection_officer_email');
