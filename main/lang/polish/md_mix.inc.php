...
$langAdvanced = "Buduj";
$langSearch = "Szukaj";
$langSearchCrit = "Jedno słowo w linijce!";
$langNoKeywords = "Ten kurs nie posiada słów kluczowych";
$langKwCacheProblem = "'Cache' słów kluczowych nie może zostać otwarte";
$langCourseKwds = "Ten dokument zawiera słowa kluczowe kursu";
$langKwdsInMD = "słowa kluczowe wykorzystywane w MD";
$langKwdRefs = "referencje dla słów kluczowych";
$langNonCourseKwds = "Słowa kluczowe nie związane z kursem";
$langKwdsUse = "Słowa kluczowe kursu (wytłuszczenie = nie używane)";
