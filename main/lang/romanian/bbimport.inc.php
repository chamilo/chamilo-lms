...
$langPackageAlreadySelected = "Tocmai ai selectat un pachet";
$langFirstSelectPackage = "Trebuie mai intai sa selectezi pachetul si sa il deschizi inainte sa continui cu procesul de importare.";
$langCourseToMigrate = "Curs pentru migrare";
$langSelectPackage = "Selecteaza un pachet";
$langOpenPackageForImporting = "Deschide acest pachet pentru importare";
$langInformation = "Informatie despre procesul de importare";
$langChooseImportOptions = "Alege optiunile de importare";
