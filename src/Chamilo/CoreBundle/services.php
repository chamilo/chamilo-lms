...
/*
use Chamilo\CoreBundle\Component\Auth\CourseVoter;
use Chamilo\CoreBundle\Component\Auth\CourseAccessDecisionManager;
...
if (isset($app->getConfiguration()->main_database)) {
    ...
    $mappings = array(
        array(
            ...
            'path' => $app['path.base'].'src/Chamilo/Entity',
            // 'orm.default_cache' =>
        ),
        array(
            'use_simple_annotation_reader' => false,
