...
$LangDoc = "tiedosto";
$LangPlataformAdmin = "Alustan ylläpitäjä";
$Groups = "Ryhmät";
...
$langcourse_description = "Kurssin kuvaus";
$langcalendar_event = "Kalenteri";
$Document = "Dokumentit";
$langlearnpath = "Oppimispolku";
$Link = "Linkit";
$langannouncement = "Ilmoitukset";
$langbb_forum = "Keskustelut";
$langdropbox = "Dropbox";
$langquiz = "Testit";
$langgroup = "Ryhmät";
$langChat = "Chat";
$langconference = "Konferenssi";
$langstudent_publication = "Opiskelijoiden julkaisut";
$langtracking = "Seuranta";
$langhomepage_link = "Lisää linkki tälle sivulle";
$langcourse_setting = "Kurssin asetukset";
