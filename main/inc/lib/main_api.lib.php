...
// TODO: Multibyte capability to be checked.
/**
 * truncates a string
 *
...
// TODO: Multibyte capability to be added anyway.
...
function api_is_allowed($tool, $action, $task_id = 0) {
	...
	if (is_array($_SESSION['total_permissions'][$_course['code']][$tool])) {
		return in_array($action, $_SESSION['total_permissions'][$_course['code']][$tool]);
	}

	// TODO: Here the finction returns null. Is this intended behaviour?
}
...
function api_get_tools_lists($my_tool = null) {
	...
	if (in_array($my_tool, $tools_list)) {
		return $my_tool;
	}
	return '';
}
