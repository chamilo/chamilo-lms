...
$strings['QuizQuestionsScoreRulesTitleConfirm'] = 'تغییر فرمول ارزیابی، تغییراتی برای هر سؤال در تمرین ایجاد می‌کند و جلوگیری از لغو این تغییر در زیر را به همراه دارد. آیا مطمئن هستید که می‌خواهید ادامه دهید؟';
$strings['EvaluationFormula'] = 'فرمول ارزیابی';
$strings['NoFormula'] = 'بدون فرمول';
$strings['Formula1'] = 'موفقیت‌ها - شکست‌ها';
$strings['Formula2'] = 'موفقیت‌ها - شکست‌ها / ۲';
$strings['Formula3'] = 'موفقیت‌ها - شکست‌ها / ۳';
