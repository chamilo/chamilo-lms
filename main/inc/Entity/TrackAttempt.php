 ...
 * @ORM\Entity(repositoryClass="Entity\Repository\TrackAttemptRepository")
 */
class TrackAttempt
{
    /**
     ...
     * @var float
     *
     * @ORM\Column(name="marks", type="float", precision=0, scale=0, nullable=false, unique=false)
     */
    private $marks;
