    ...
    <div class="row-fluid">
        ...
        <div class="span3">
            <div class="well sidebar-nav-skill-wheel ">
                ...
                <span class="label label-info">{{ "SkillsYouAcquired"|trans }}</span><br />
                <span class="label label-warning">{{ "SkillsYouCanLearn"|trans }}</span><br />
