...
$strings['Review meetings, recordings and available actions.'] = 'סקור פגישות, הקלטות ופעולות זמינות.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'בחר את קובצי ה-PDF או ה-PPTX שברצונך לטעון מראש כשקפים לכנס.';
$strings['Max total: %d MB'] = 'סך מקסימלי: %d MB';
$strings['Pre-upload Documents'] = 'מסמכים שהועלו מראש';
$strings['No documents found'] = 'לא נמצאו מסמכים';
$strings['Failed to load documents'] = 'טעינת המסמכים נכשלה';
$strings['No meetings or recordings are available yet.'] = 'אין עדיין פגישות או הקלטות זמינות.';
$strings['Share the conference link with allowed participants.'] = 'שתף את קישור הכנס עם המשתתפים המורשים.';
$strings['presentation'] = 'מצגת';
$strings['video'] = 'וידאו';
$strings['WebhooksDashboard'] = 'לוח בקרת Webhooks (גלובלי)';
$strings['MeetingTitleContains'] = 'כותרת הפגישה מכילה';
$strings['FromUTC'] = 'מ- (UTC)';
$strings['ToUTC'] = 'עד (UTC)';
$strings['OnlyOnlineRows'] = 'רק שורות מקוונות';
$strings['AllMeetings'] = 'כל הפגישות';
$strings['Apply'] = 'החל';
$strings['ExportCSV'] = 'ייצא CSV';
$strings['AutoRefresh10s'] = 'רענון אוטומטי (10 שניות)';
$strings['ActiveMeetings'] = 'פגישות פעילות';
$strings['ConnectedNow'] = 'מחוברים כעת';
$strings['JoinsToday'] = 'הצטרפויות היום';
$strings['Events24h'] = 'אירועים (24 שעות)';
$strings['OnlineTime'] = 'זמן מקוון';
$strings['Conversation'] = 'שיחה';
$strings['CameraShare'] = 'שיתוף מצלמה';
$strings['Messages'] = 'הודעות';
$strings['Reactions'] = 'תגובות';
$strings['Hands'] = 'ידיים';
$strings['Results'] = 'תוצאות';
$strings['Status'] = 'סטטוס';
$strings['Joined'] = 'הצטרף';
$strings['Last'] = 'אחרון';
$strings['Running'] = 'פעיל';
$strings['Finished'] = 'הסתיים';
$strings['UsersColon'] = 'משתמשים:';
$strings['OnlineColon'] = 'מקוונים:';
$strings['TalkColon'] = 'דיבור:';
$strings['CameraColon'] = 'מצלמה:';
$strings['Updated'] = 'עודכן';
$strings['FirstJoin'] = 'הצטרפות ראשונה';
$strings['LastSeen'] = 'נראה לאחרונה';
$strings['Totals'] = 'סה"כ';
$strings['Talking'] = 'מדבר';
$strings['User'] = 'משתמש';
$strings['No recording'] = 'אין הקלטה';
