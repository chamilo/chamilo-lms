...
$langDescriptionCopyCourse = "Chamilo introduit la possibilité de dupliquer tout ou partie d\'une formation existante vers une autre formation, qui peut être initialement vide.<br />Le seul préalable à cette manipulation est de disposer d\'une formation contenant des documents, annonc";
$DescriptionRecycleCourse = "Cet outil vide la formation des éléments sélectionnés, ou de l\'ensemble des éléments qu\'il contient. Il supprime les documents, les forums, liens... Cette procédure peut être mise en oeuvre à l\'issue d\'une formation.<br />Bien entendu, avant de vider";
