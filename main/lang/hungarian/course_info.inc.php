...
$langByDel = "A kurzus teljes törlése véglegesen etávolítja az összes hozzá tartozó tartalmat (dokumentumokat, publikációkat, hivatkozásokat, stb.), valamint véglegesen törli az összes feliratkozást (ez nem érint más kurzusokat). Szintén eltávolításra kerül minden olya";
$langY = "IGEN";
$langN = "NEM";
...
$langDescriptionCopyCourse = "A Dokoes lehet&#337;vé teszi, hogy a teljes kuzust (tárgyat), illetve annak egyes kiválsztott részeit egy másik, adott esetben akár üres kurzusba (tárgyba) átmásolja.br><br>A funkció használatának el&#337;feltétele, hogy rendelkezzen egy dokumentumokat, h";
$DescriptionRecycleCourse = "Ez az eszköz a kurzus kiválasztott elemeinek vagy teljes tartalmának törlését teszi lehet&#337;vé. Eltávolítja a dokumentumokat, fórumokat, likeket, stb... A törlésre egy félév vagy a képzés végén kerülhet sor. Er&#337;sen ajánlott, hogy a törlés el&#337;";
