 ...
 * @ExclusionPolicy("all")
 */
class AltTimecodeTimeFormat extends AbstractTag
{

    protected $Id = 'altTimecodeTimeFormat';

    protected $Name = 'AltTimecodeTimeFormat';
    ...
    protected $Description = 'Alt Timecode Time Format';
