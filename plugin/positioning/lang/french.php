...
$strings['InviteToTakePositioningTest'] = 'Merci de passer ce test de positionnement avant de commencer. Cela nous aidera à mesurer la qualité de ce cours.';
$strings['InitialTest'] = 'Test initial';
$strings['YouMustCompleteAThresholdToTakeFinalTest'] = 'Vous devez compléter au moins %s%% de progrès dans les parcours en moyenne pour débloquer le test final.';
