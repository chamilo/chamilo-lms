 ...
 * @ExclusionPolicy("all")
 */
class CircGradBasedCorrClarity2012 extends AbstractTag
{

    protected $Id = 'CircularGradientBasedCorrectionsLocalClarity2012';

    protected $Name = 'CircGradBasedCorrClarity2012';
