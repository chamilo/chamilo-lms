...
$langDescriptionCopyCourse = "Chamilo fornisce la possibilità di duplicare in parte o del tutto un corso, copiandolo su un corso che sia stato creato e sia inizialmente vuoto.<br /><br />L\'unico prerequisito è che il corso origine, da cui partire per la copia, contenga informazioni (";
$DescriptionRecycleCourse = "Questo strumento svuota del tutto o in parte il corso dei suoi contenuti. Il riazzeramento delle informazioni (documenti, forum, collegamenti ecc. saranno cancellati) è utile alla fine dell\'anno formativo per \\"riciclare\\" il corso. E\' OPPORTUNO FARE UN";
