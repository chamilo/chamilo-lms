...
$langDefaultTextInBlanks = "<table cellspacing=\"0\" cellpadding=\"10\" border=\"1\" width=\"720\" style=\"\" height:=\"\"> <tbody> <tr> <td colspan=\"2\"> <h3>Primer aktivnosti : izraÄŤunaj indeks telesne mase</h3> </td> </tr> <tr> <td style=\"text-align: right;\"><strong>Starost</strong></td> <td width=\"75%\" style=\"\">[25] let</td> </tr> <tr> <td style=\"text-align: right;\"><strong>Spol</strong></td> <td style=\"\" text-align:=\"\">[M] (M ali Ĺ˝)</td> </tr> <tr> <td style=\"text-align: right;\"><strong>TeĹľa</strong></td> <td style=\"\" text-align:=\"\">95 Kg</td> </tr> <tr> <td style=\"vertical-align: top; text-align: right;\"><strong>ViĹˇina</strong></td> <td style=\"vertical-align: top;\">1.81 m</td> </tr> <tr> <td style=\"vertical-align: top; text-align: right;\"><strong>Indeks telesne mase</strong></td> <td style=\"vertical-align: top;\">[29] BMI =teĹľa/viĹˇina<sup>2</sup> (glej <a href=\"http://en.wikipedia.org/wiki/Body_mass_index\" onclick=\"window.open(this.href,'','resizable=yes,location=yes,menubar=no,scrollbars=yes,status=yes,toolbar=no,fullscreen=no,dependent=no,width=800,height=600,left=40,top=40,status'); return false\"> ÄŤlanek Wikipedie</a>)</td> </tr> </tbody> </table>";
