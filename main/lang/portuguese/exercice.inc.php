...
$langDefaultTextInBlanks = "<table cellspacing=\\"0\\" cellpadding=\\"10\\" border=\\"1\\" width=\\"720\\" style=\\"\\" height:=\\"\\"> <tbody> <tr> <td colspan=\\"2\\"> <h3>Exemplo de preenchimento do formulário da atividade: calcular o Índice de Massa Corporal</h3> </td> </tr> <tr> <td style=\\"";
...
$langHotspotChoose = "Para criar um hotspot: selecionar uma forma de polígono ao lado da cor, e desenhar o hotspot.<br>Para mover um hotspot, selecionar a cor, clicar num outro ponto da imagem, e desenhar o hotspot.<br>Para adicionar um hotspot: clicar no botão Adicionar hotsp";
$Fault = "Incorrecto";
...
$DirectFeedbackCantModifyTypeQuestion = "O tipo de exercício não pode ser modificado, uma vez que foi configurado para ser uma auto-avaliação. A auto-avaliação permite a possibilidade de atribuir feedback directo ao utilizador, mas não é compatível com todos os tipos de perguntas, não sendo poss";
