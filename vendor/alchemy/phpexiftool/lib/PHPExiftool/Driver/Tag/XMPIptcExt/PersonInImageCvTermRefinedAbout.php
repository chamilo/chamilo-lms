 ...
 * @ExclusionPolicy("all")
 */
class PersonInImageCvTermRefinedAbout extends AbstractTag
{

    protected $Id = 'PersonInImageWDetailsPersonCharacteristicCvTermRefinedAbout';

    protected $Name = 'PersonInImageCvTermRefinedAbout';
