...
$langKwHelp = "<br/> 點擊 \'+\' 按鈕打開, \'-\' 按鈕關閉, \'++\' 按鈕打開所有, \'--\' 按鈕關閉所有.<br/> <br/> 透過關閉次目錄取消對所有關鍵字的選擇,再次打開點按鈕 \'+\'.<br/> Alt-click \'+\' 在次目錄中尋找原始關鍵字.<br/> <br/> Alt-click 關鍵詞 選擇不含broader terms的關鍵詞或放棄選擇含broader terms的關鍵詞.<br/> <br/>  如果您改變了簡介語言, 請不要同時加上關鍵字.<br/>";
$langLocation = "網址";
