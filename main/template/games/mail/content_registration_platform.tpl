...
<p>{{ 'ThanksForRegisteringToSite'|get_lang|format(_s.site_name) }} Como sabes nuestros cursos son bastante aplicativos y buscan asegurar un aprendizaje efectivo.</p>
