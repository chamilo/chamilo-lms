    ...
    <div class="bc-info-actions">
        ...
        <div class="bc-info-actions__right">
            ...
            {% else %}
                ...
                {% if has_blocking_sale|default(false) %}
    ...
    <article class="bc-info-hero">
        ...
        <div class="bc-info-hero__body">
            <div class="bc-info-badges">
                ...
                {% if is_upgrade|default(false) %}<span class="bc-info-badge bc-info-badge--blue">{{ 'Upgrade'|get_plugin_lang('BuyCoursesPlugin') }}</span>{% endif %}
            </div>
    ...
    <section class="bc-info-grid">
        ...
        <aside class="bc-info-card">
            ...
            {% if is_upgrade|default(false) and upgrade_offer %}
                ...
                <div class="bc-summary-box"><div class="bc-summary-box__label">{{ 'UpgradeRemainingDays'|get_plugin_lang('BuyCoursesPlugin')|format(upgrade_offer.remaining_days) }}</div><div class="bc-summary-box__value">{{ upgrade_offer.source_date_end_formatted|e }}</div></div>
