...
class Version20160405112100 extends AbstractMigrationChamilo
{
    public function up(Schema $schema)
    {
        ...
        if ($schema->hasTable('skill')) {
            ...
            if (false == $table->hasForeignKey('FK_5E3DE477CCFA12B8')) {
            ...
            if (false == $table->hasIndex('IDX_5E3DE477CCFA12B8')) {
        ...
        if ($schema->hasTable('skill_level')) {
            ...
            if (false == $table->hasForeignKey('FK_BFC25F2FCCFA12B8')) {
            ...
            if (false == $table->hasIndex('IDX_BFC25F2FCCFA12B8')) {
