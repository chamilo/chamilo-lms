...
$password_request = "Você solicitou a troca de sua senh";
...
$AccountsExternalAuthSource = "Chamilo não pode realizar automáticamente a solicitação porque pelo menos uma das contas tem uma fonte de autorização externa. Por favor, tome as medidas apropiadas em todas as contas (incluindo as que tem autorização da plataforma) e notifique-as para o";
