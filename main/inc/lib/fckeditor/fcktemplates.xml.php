...
<Templates imagesBasePath="fck_template/images/">
	<Template title="Content" image="Assignment_description">
	...
	<Template title="Content" image="Certificate_of_completion">
		<Description>Certificate of completion</Description>
		<Html>
			<![CDATA[
					<?php echo $css ?>
	...
	<Template title="Content" image="Comparison">
	...
	<Template title="Content" image="Course_preface">
		<Description>Course preface</Description>
		<Html>
			<![CDATA[
					<?php echo $css ?>
	...
	<Template title="Content" image="Diagram_explained">
		<Description>Diagram explained</Description>
		<Html>
			<![CDATA[
					<?php echo $css ?>
	...
	<Template title="Content" image="Flash_animation_page">
		<Description>Flash animation page</Description>
		<Html>
			<![CDATA[
					<?php echo $css ?>
	...
	<Template title="Content" image="Frequently_asked_questions">
	...
	<Template title="Content" image="Picture">
	...
	<Template title="Content" image="Resources">
	...
	<Template title="Content" image="Table">
	...
	<Template title="Content" image="Teacher_explaining">
		<Description>Teacher explaining</Description>
		<Html>
			<![CDATA[
					<?php echo $css ?>
	...
	<Template title="Content" image="Text">
	...
	<Template title="Content" image="Video">
