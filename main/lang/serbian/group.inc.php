...
$langMax = "maks.";
$langGroupPlacesThis = "sedita (opcionalno)";
...
$langGroupPropertiesModified = "Podeavanja grupe su modifikovana";
...
$Optional = "(opcionalno)";
$langGroupSettingsModified = "Podeavanja grupe su modifikovana";
$langGroupTooMuchMembers = "Broj koji ste naveli premauje maks. broj koji ste dozvolili (moete ga promeniti dole). Sastav grupe nije promenjen.";
...
$langPublic = "javno";
$langPropModify = "Modifikuj podeavanja";
$langState = "Stanje";
$langGroupFilledGroups = "Grupe su popunili (ili zavrili) korisnici koji su na listi 'Korisnici'";
$langSubscribed = "korisnici prijavljeni na ovaj kurs";
$langStudentsNotInThisGroups = "Korisnici koji nisu u ovoj grupi";
$langQtyOfUserCanSubscribe_PartBeforeNumber = "Jedan korisnik moe da bude &#269;lan u maksimalno";
...
$langDefaultSettingsForNewGroups = "Osnovna podeavanja za nove grupe";
...
$langPleaseEnterValidNumber = "Molim Vas unesite eljeni broj grupa";
...
$MaxGroupsPerUserInvalid = "Maksimalan broj grupa po korisniku koji ste napisali je neispravan. Postoje korisnici koji su trenutno prijavljeni na vie grupa od broja koji ste predloili.";
