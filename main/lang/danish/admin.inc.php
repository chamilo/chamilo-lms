...
$langVisioconfDescription = "Chamilo Live Conferencing® er et standardiseret videokonference-værktøj. Værktøjer tilbyder følgende: Visning af diapos, whiteboard der kan tegnes og skrives på, audio/video og chat. Du skal have en Flash® player installeret på computeren for at kunne ben";
$langPpt2lp = "oogie";
...
$UseSessionModeComment = "Sessioner giver en alternativ mulighed for at administrere kursussider, hvor der en opretter/underviser, en instruktor og deltagere. Hver instruktor vælger, hvor lang tid en gruppe deltagere skal have adgang til en kursusside. Tidsperioden kaldes en *sess";
...
$BreadCrumbsCourseHomepageComment = "Via krummestien kan man navigere (gå tilbage i ens handlinger) ud fra et horisontalt link-struktur. Krummestien vises normalt øverst til venstre på siden. Krummestien viser, hvilken side du er på og giver dig links tilbage til trinnet/trinnene forinden de";
$Comment = "Kommentar";
$Version = "Version";
...
$PublicPagesComplyToWAIComment = "WAI (Web Accessibility Initiative) står for et initiativ i forhold til at gøre internettet mere tilgængeligt. Ved at vælge denne mulighed, bliver DOKEOS siderne mere tilgængelige. Dette betyder derudover, at indholdet på de åbne kursussider kan fremstå an";
...
$Ajax_course_tracking_refresh_comment = "Muligheden anvendes i forhold til at lave en real-time beregning af den tid, som deltageren anvendte på kursussiden. Værdien til formularen viser intervallet (opdateret) i sekunder. For at deaktivere denne mulighed, skal default-værdien være sat til 0 i f";
...
$EphorusDescription = "Start using the Ephorus anti plagiarism service in Chamilo.With Ephorus, you will prevent internet plagiarism without any additional effort.You can use our unique open standard webservice to build your own integration or you can use one of our Chamilo-int";
...
$InstallDirAccessibleSecurityThreat = "The main/install directory of your Chamilo system is still accessible to web users. This might represent a security threat for your installation. We recommend that you remove this directory or that you change its permissions so web users cannot use the sc";
