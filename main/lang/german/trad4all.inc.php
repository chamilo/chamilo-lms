...
$UplFileTooBig = "Die Datei für den Upload ist zu gross für die jetzigen Chamilo Einstellungen (%sMB). Kontaktieren Sie den Chamilo Administrator, um diese Sache zu besprechen.";
$UplGenericError = "Der Upload Ihrer Datei war nicht erfolgreich. Versuchen Sie es bitte später nochmals oder kontaktieren Sie den Chamilo Administrator";
$MyGradebook = "Mein Gradebook";
$Gradebook = "Gradebook";
$OpenIDWhatIs = "Wie lautet die OpenID?";
$OpenIDDescription = "Mit OpenID benötigt man nicht mehrere Benutzernamen auf verschiedenen Websites, ,was die Online Erfahrung vereinfacht. Sie wöhlen den OpenID Provider, der am besten Ihren Bedürfnissen entspricht, und dem Sie vor allem vertrauen. Andererseits behalten Sie";
