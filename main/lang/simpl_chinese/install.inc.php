...
$langDBSettingIntro = "安装脚本将要创建Dokeos主数据库，请注意 Chamilo 讲要创建多个数据库，如果你的主机服务商只允许使用一个数据库，Dokeos将不会工作，除非你选择“单个数据库”选项.";
$langStep1 = "步骤1/6";
$langStep2 = "步骤2/6";
$langStep3 = "步骤3/6";
$langStep4 = "步骤4/6";
