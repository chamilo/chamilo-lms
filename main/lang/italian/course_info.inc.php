...
$langConfTip = "Per default, il corso � accessibile al pubblico. Le opzioni qui sopra modificano il livello di riservatezza.";
...
$langTipLang  = "Questa lingua verr� utilizzata per chiunque visiti il corso.";
$langVid = "Video";
$langWork = "Elaborati";
...
$langRestoreDescription = "Il corso � un file di archivio che si pu� selezionare dall\'elenco sottostante.<br><br>
...
$langDescriptionCopyCourse = "Dokeos fornisce la possibilit� di duplicare in parte o del tutto un corso, copiandolo su un corso che sia stato creato e sia inizialmente vuoto.<br /><br />L\'unico prerequisito � che il corso origine, da cui partire per la copia, contenga informazioni (documenti, forum...) che non si sovrappongano a quelle del corso destinazione.";
