	...
	echo '<div id="social-content-right">';			
		...
		foreach($users as $user) {	 
			switch ($user['relation_type']) {			
				...
				$user['link']  = '<a href="group_waiting_list.php?id='.$group_id.'&u='.$user['user_id'].'&action=accept">'.Display::return_icon('add_normal_user.png', get_lang('Accept')).'</a>';
				$user['link'] .= '<a href="group_waiting_list.php?id='.$group_id.'&u='.$user['user_id'].'&action=set_moderator">'.Display::return_icon('add_moderator.png', get_lang('Moderator')).'</a>';
