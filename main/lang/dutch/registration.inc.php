...
$langSend = "Opsturen";
$langUserAddExplanation = "Elke lijn van het bestand dat opgestuurd wordt, moet uit exact deze 5 velden bestaan: <b>Naam   Voornaam   		Gebruikersnaam   Wachtwoord 		  E-mail</b> door tabs gescheiden en in deze volgorde. De gebruikers zullen hun gebruikersnaam en wachtwoord per e-m";
...
$langSettings = "met de volgende parameter";
...
$AccountsExternalAuthSource = "Chamilo kan de aanvraag niet automatisch behandelen omdat minstens een van de accounts een externe authenticatiebron gebruikt. Gelieve de gepaste maatregelen te nemen voor alle accounts (ook die met platformauthenticatie) en de gebruiker hierover in te li";
