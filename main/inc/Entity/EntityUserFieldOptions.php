...
/**
 * EntityUserFieldOptions
 *
 * @Table(name="user_field_options")
 * @Entity
 */
class EntityUserFieldOptions
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @Column(name="option_display_text", type="string", length=64, precision=0, scale=0, nullable=true, unique=false)
     */
