...
function fill_Db_course($courseDbName, $courseRepository, $language,$pictures_array)
{
	...
	*/
	...
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_LINK . "','link/link.php','file_html.gif','".string2binary(api_get_setting('course_create_active_tools', 'links')) . "','0','squaregrey.gif','NO','_self','authoring')");
