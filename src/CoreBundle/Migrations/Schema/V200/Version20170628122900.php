...
class Version20170628122900 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            "ALTER TABLE access_url_rel_course_category CHANGE access_url_id access_url_id INT DEFAULT NULL, CHANGE course_category_id course_category_id {$courseCategoryIdType} DEFAULT NULL"
        );
