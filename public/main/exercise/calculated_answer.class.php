...
(function () {
  ...
  function renderRanges(blanks) {
    ...
    for (var i=0; i<blanks.length; i++) {
      ...
      html += "<td><input class=\\"span1\\" style=\\"margin-inline-start:0em;\\" size=\\"5\\" value=\\""+lowVal+"\\" type=\\"text\\" id=\\"lowestValue["+i+"]\\" name=\\"lowestValue["+i+"]\\" onblur=\\"updateRandomValue(this)\\"/></td>";
      html += "<td><input class=\\"span1\\" style=\\"margin-inline-start:0em;width:80px;\\" size=\\"5\\" value=\\""+highVal+"\\" type=\\"text\\" id=\\"highestValue["+i+"]\\" name=\\"highestValue["+i+"]\\" onblur=\\"updateRandomValue(this)\\"/></td>";
