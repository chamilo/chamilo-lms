...
final class Version20240811221900 extends AbstractMigrationChamilo
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($schema->getTable('c_blog_attachment')->hasIndex('course')) {
        ...
        if ($schema->getTable('c_blog_rating')->hasIndex('course')) {
        ...
        if ($schema->getTable('c_blog_post')->hasIndex('course')) {
        ...
        if ($schema->getTable('c_blog_rel_user')->hasIndex('course')) {
        ...
        if ($schema->getTable('c_blog_task')->hasIndex('course')) {
        ...
        if ($schema->getTable('c_blog_comment')->hasIndex('course')) {
