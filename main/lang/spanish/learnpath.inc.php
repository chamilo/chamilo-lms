...
$lang_add_chapter = "Añadir un capítulo";
...
$lang_learnpath_added = "La nueva lección se ha creado con éxito. Ahora puede añadirle capítulos haciendo clic en signo más (+).";
...
$lang_add_learnpath_chapter_to_path = "Añadir un capítulo a esta lección";
...
$lang_delete_learnpath_module = "Eliminar capítulo";
$lang_learnpath_module_edited = "El capitulo de la lección ha sido modificado";
$lang_learnpath_module_deleted = "El capítulo de la lección y todos sus elementos han sido eliminados";
$lang_nochapters = "No hay capítulos añadidos.";
$lang_add_learnpath_item = "Añadir elementos a este capítulo";
$lang_learnpath_item_deleted = "El elemento de la lección ha sido eliminado.";
$lang_assign_learnpath_items_to = "asigne estos elementos a un capítulo de la lección:";
...
$langTitleManipulateChapter = "Modificar el capítulo actual";
$langTitleManipulateModule = "Modificar el capítulo actual";
...
$langLPCreatedToContinue = "Para continuar, añada a su lección un capítulo o un elemento.";
$langLPCreatedAddChapterStep = "Añada capítulos y elementos a su lección";
