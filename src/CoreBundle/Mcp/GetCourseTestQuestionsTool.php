    ...
    public function getCourseTestQuestions(
        ...
        try {
            ...
            foreach ($this->testReader->listQuestionLinks($quiz) as $position => $rel) {
                $questions[] = $this->testReader->normalizeQuestion($rel->getQuestion(), $position + 1);
            }
