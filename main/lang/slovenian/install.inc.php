...
$langDBSettingIntro = "Namestitveni skript bo tvoril glavno podatkovno bazo Chamilo/Claroline. Chamilo/Claroline  mora tvoriti				več podatkovnih baz (DB) (v kolikor spodaj ne izbereš opcije \\"Ena\\" ). Če administrator sistema dovoli 				za vašo spletno stran le eno DB, Chamilo";
...
$DirectoryAndFilePermissionsInfo = "Nekatere mape in datoteke morajo biti zapisljive s strani strežnika, da bi Chamilo normalno deloval (potrebne za prepis datotek, spreminjanje html datotek domačih strani, ...). Sprememba lahko zahteva ročno posredovanje oz. nastavitev (na nivoju operacijs";
...
$DBSettingUpgradeIntro = "Postopek bo obnovil in nadgradil Chamilo podatkovne baze. V postopku nadgraditve bodo uporabljene podatkovne baze in nastavitve, kot so podane spodaj. Strogo priporo&#269;amo, da izvedete popolno arhivsko kopijo vaših podatkovnih baz, predenj nadaljujete";
$ExtensionMBStringNotAvailable = "MBString razširitev ni na voljo";
$ExtensionMySQLNotAvailable = "MySQL razširitev ni na voljo";
$DokeosArtLicense = "Galeriji slik in drugih medijskih datotek Chamilo-a vsebujejo slike iz galerij Nuvola, Crystal Clear in Tango. Druge slike in medijske datoteke, kot so diagrami, Flash animacije so sposojene iz Wikimedia in gradiv Ali Pakdel-a ter Denis Hoa z njihovim pri";
