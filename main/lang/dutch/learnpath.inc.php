...
$lang_short_help = "Om een item toe te voegen, klik op het +-icoon; om een titel/beschrijving toe te voegen, klik op het potloodicoon; om voorkennisvereisten toe te voegen, klik op het documentenicoon. U kan controleren wat de studenten te zien krijgen door het zicht rechtsb";
...
$WelcomeWoogieConverter = "Welkom in de Woogie converteerder<ul type=\\"1\\"><li>Kies een .doc, .sxw of .odt bestand<li>Upload het in Woogie. Het wordt geconverteerd in een leerpad<li>Vervolgens kan u audiocommentaar op elke pagina toevoegen en testen en andere activiteiten tussen de";
