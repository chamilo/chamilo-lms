...
function extra_formatter(cellvalue, options, rowObject) {
    ...
    return \' \'+calendarName+\' <a href="'.
        api_get_path(WEB_CODE_PATH).'admin/usergroup_users.php?calendar_id=\'+calendarId+\'&user_id=\'+options.rowId+\'&id='.$id.'&action=edit_calendar&width=700" class="btn btn--secondary ajax"> '.get_lang('Edit').'</a>\';
    }
