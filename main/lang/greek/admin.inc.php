...
$Maximum = "μέγιστος";
$MaximumOfParticipants = "Μέγιστος αριθμός συμμετέχοντων";
$Participants = "Μέλη";
...
$ImportFileLocation = "Τοποθεσία του αρχείου CSV / XML";
$FileType = "Τύπος αρχείου";
$OutputFileType = "Τύπος αρχείου εξαγωγής";
...
$ExampleCSVFile = "Παράδειγμα αρχείου CSV";
...
$SystemAnnouncements = "Ανακοινώσεις Portal";
$AddAnnouncement = "Προσθήκη νέας ανακοίνωσης";
$AnnouncementAdded = "Η ανακοίνωση έχει προστεθεί";
$AnnouncementUpdated = "Η ανακοίνωση έχει ενημερωθεί";
$AnnouncementDeleted = "Η ανακοίνωση έχει διαγραφεί";
$Content = "Περιεχόμενο";
...
$OpenToTheWorld = "Δημόσια πρόσβαση (για όλο τον κόσμο)";
$OpenToThePlatform = "Ανοιχτή πρόσβαση (μόνο για εγγεγραμμένους χρήστες της πλατφόρμας)";
$Private = "Ιδιωτική πρόσβαση";
$CourseVisibilityClosed = "Χωρίς πρόσβαση (μόνο για εκπαιδευτικούς)";
