...
$langSend = "Отправить";
$langUserAddExplanation = "Каждая строка посылаемого файла необходима и включает только 5 полей: <b>Имя";
...
$AccountsExternalAuthSource = "Программа Докеос не может автоматически управлять запросом, так как по крайней мере одна учетная запись имеет внешний идентификационный источник. Пожалуйста, предпримите соответствующие меры для всех учетных записей (включая те, что имеют идентификацию пл";
...
$OpenIDCouldNotBeFoundPleaseRegister = "Этот ID_Открытия не найден в нашей базе данных. Пожалуйста, зарегистрируйтесь для создания новой учетной записи. Если у нас уже есть Ваша учетная запись, пожалуйста, отредактируйте свой профиль внутри вашей учетной записи так, чтобы добавить этот ID_Откры";
