...
$langCreatePath = "Créer un cours (Chamilo AUTEUR)";
...
$langOogieConversionPowerPoint = "Chamilo RAPID: conversion Powerpoint";
...
$Options = "Options";
$WelcomeOogieConverter = "Bienvenue dans le convertisseur de Power Point Chamilo RAPID<ul type=\\"1\\"><li>Choisissez un fichier .ppt ou .odp<li>Importez ce fichier. Il sera converti en cours SCORM<li>Vous pourrez ensuite ajouter des commentaires audio sur chaque dia et insérer test";
...
$HelpDefaultDirDocuments = "Ce répertoire contient les fichiers par défaut. Vous pouvez supprimer des fichiers ou en ajouter de nouveaux, mais si un fichier invisible est inséré dans un document web, les apprenants ne pourront pas voir ce fichier dans le document. Lorsque vous insér";
$HelpSharedFolder = "Ce répertoire contient les fichiers que d\'autres apprenants (ou vous-même) ont envoyé dans un cours au travers de l\'éditeur en ligne (à l\'exception de l\'outil de groupe). Par défaut, ils seront visibles par tous les enseignants, mais resteront invisib";
