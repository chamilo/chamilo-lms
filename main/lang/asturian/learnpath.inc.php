...
$lang_short_help = "P\'amestar un elementu, calque nel signu más (+). Pa cambiar un títulu/descripción, calque nel iconu cola forma de llapiceru. Pa amestar prerrequisitos calque nel iconu con dos documentos. Pue comprobar lo que los estudiantes van ver calcando enriba \'Vis";
...
$langWarning = "¡ Cuidáu !";
$langWarningEditingDocument = "Si edita un documentu que ya esiste nel itinerariu d\'aprendizaxe, la versión nueva del documentu nun va escribir enriba la vieya, lo que va facer ye guardala como un documentu nuevu. Si quier editar un documentu pa cambialu dafechu, pue facelo cola ferra";
...
$WelcomeWoogieConverter = "Bienveníu al conversor Woogie<ul type=\\"1\\"><li>Escoyer un archivu .doc, .sxw, .odt<li>Unvialu a Woogie, que lu va convertir nun itinerariu d\'aprendizaxe SCORM<li>Va poder amestar comentarios d\'audio a caúna les páxines y tamién insertar test y otres ac";
...
$SearchFeatureSearchExplanation = "Pa buscar na base datos d\'itinerrios d\'aprendizaxe, use la sintaxis que vien darréu: <br/><br/>   <i>term tag:tag_name -exclude +include \\"exact phrase\\"</i><br/><br/>Por exemplu<br/><br/>    <i>coche tag:camión -ferrari +ford \\"consumu altu\\".</i><br/>";
