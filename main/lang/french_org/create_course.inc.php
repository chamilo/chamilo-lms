...
$langProgram="Catalogue des espaces</a>. Si l'espace que vous voulez créer ne correspond pas à un cod'espaces existant, vous pouvez en inventer un. Par exemple <i>INNOV001</i> s'il s'agit d'un programme de gestion de l'innovation";
$langProfessors="Responsables";
$langExplanation="Une fois que vous aurez cliqué sur OK, un espace contenant Forum, Liste de liens, Tests, Agenda, Liste de documents... sera créé. Grâce à votre pseudo de responsable vous pourrez en modifier le contenu";
...
$langModifyInfo="Propriétés de l'espace";
...
$langIntroductionText="Ceci est le texte d'accueil.";
...
// Dev tools : create many test espacees
$langMinimum = "Minimum";
$langMaximum = "Maximum";
