...
switch ($action) {
    case 'move':
        ...
        break;
    case 'view':
        $content = AnnouncementManager::display_announcement($announcement_id, $allowToEdit);
        break;
    case 'list':
    ...
    case 'modify':
        ...
        $form->addHtml(
            "<div class='control-group'><div class='controls'><div class='alert alert-info'>".$htmlTags."</div></div>"
        );
        ...
        $form->addElement('style_submit_button', 'submit', get_lang('Send'));
