 ...
 * @ExclusionPolicy("all")
 */
class GradientBasedCorrHighlights2012 extends AbstractTag
{

    protected $Id = 'GradientBasedCorrectionsLocalHighlights2012';

    protected $Name = 'GradientBasedCorrHighlights2012';
