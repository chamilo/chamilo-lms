...
*/
$langHFor = "Yard&#305;m Forumlar&#305;";
$langClose = "Pencereyi Kapat";
...
$langHMycourses = "Ba&#351;lang&#305;ç sayfas&#305; hakk&#305;nda";
...
$langClarContent1 = "&#304;çeri&#287;i temizle";
$langClarContent2 = "&#304;çeri&#287;i temizle";
$langHGroups = "Gruplar";
$langGroupsContent = "Gruplar&#305;n içeri&#287;i";
$langGuide = "Rehber";
$langHCourseRolesRights = "Roller ve haklar hakk&#305;nda yard&#305;m";
$langCourseRolesRightsContent = "<p>In the Roles and rights overview page for your course you can define exactly <em>who is allowed to do what in which place</em>.</p> <p>The basic concept is that for every course tool, you can specify who can view the contents of that tool, add new items and folders, edit existing information, or delete content. However, you do not have to specify this for every individual user. Users have roles inside your course, like guest visitor, normal course member, teaching assistant, and course admin. For each of these roles, you can specify the permissions for every tool. You can say all users can access the forum, but guests cannot post there - only registered users. You can say that the teaching assistant can add documents to your course, but not delete them. And so on.</p> <p> In the users tool of your course, you can see the roles of users and edit them (just use the edit button in the list of users). </p> <h3>Overview of all local roles</h3> <p> There are five local roles inside Dokeos. These are the roles that you can assign to users inside your course. <ul> <li><b>Anonymous course visitor</b>: this could be anyone in any place of the world, who just opens a browser and tries to visit your course. By default these users have no rights at all and can\'t even view your course.</li> <li><b>Registered course visitor</b>: this is someone who is registered in the Dokeos platform, and visits your course without being enrolled in it.</li> <li><b>Normal course member</b>: this is the default role for users who enroll into your course. Typically, the majority of users keeps this role, and course admins assign the role of teaching assistant to some users so they can help develop the course.</li> <li><b>Teaching assistant</b>: this assistant role has many permissions. In most tools, the assistant can view, add and edit content, but not delete it. The teaching assistant also cannot edit the course settings or course rights by default.</li> <li><b>Course admin</b>: the course admin has all rights in the course and can do everything. The creator of a course automatically gets this role.</li> </ul> </p> <h3>Overview of all rights</h3> <p> There are four basic rights inside Dokeos: <ul> <li><b>View</b>: the right to see a tool and its contents</li> <li><b>Add</b>: the right to add new content in a tool, e.g. add hyperlinks, categories, documents, folders, student publications, forum messages...</li> <li><b>Edit</b>: the right to edit existing content in a tool, e.g. edit the url of a hyperlinks, the name of a folder, the title and keywords of a document...</li> <li><b>Delete</b>: the right to delete existing content in a tool, e.g. delete hyperlinks, student publications, forum messages, documents...</li> </ul> </p> <h3>Overview of locations</h3> <p> Every course and every course tool for every course is a separate location in Dokeos. So a few example locations are <ul> <li>The course TEST_COURSE</li> <li>The documents tool of course TEST_COURSE</li> <li>The agenda tool of course Psychology101</li> </ul></p> <h3>Setting permissions</h3> <p>As course admin, you specify who can do what in which location. For every role and location combination the four rights can be set. So you can set the view right for the teaching assistant in the documents tool, the add right for the normal course members in the links tool, etc. </p>";
?>