...
if (!empty($_POST)) {
    ...
    if ($check) {
        ...
        if (1 == $sltCentersExists) {
            ...
            if (isset($newClassroom) && 1 != $newClassroom) {
...
if (api_is_platform_admin()) {
    ...
    $interbreadcrumb[] = ['url' => 'specialty-action-edit.php?new_specialty=0&specialty_id='.(int) ($_GET['specialty_id']).'&action_id='.(int) ($_GET['action_id']), 'name' => $plugin->get_lang('SpecialtyFormativeAction')];
    if (isset($_GET['new_classroom']) && 1 == (int) ($_GET['new_classroom'])) {
        ...
        $tpl->assign('action_id', (int) ($_GET['action_id']));
        $tpl->assign('specialty_id', (int) ($_GET['specialty_id']));
        $tpl->assign('classroom_id', (int) ($_GET['classroom_id']));
