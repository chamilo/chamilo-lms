...
class CItemProperty
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ChamiloLMS\CoreBundle\Entity\Course", inversedBy="items")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ChamiloLMS\CoreBundle\Entity\Session", inversedBy="items")
