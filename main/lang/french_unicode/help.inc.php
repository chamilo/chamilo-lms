...
$langDocContent = "<p>L\'outil Documents gère vos fichiers comme le fait le Gestionnaire de fichiers de votre ordinateur, à la diffférence qu\'il les partage avec vos apprenants. </p><p>Vous pouvez y créer des pages web grâce à l\'outil Templates (première icône dans l\'éditeur en ligne) et y d�poser des documents de tous type
 ...
 attentifs � ce que les membres disposent des
 outils n�cessaires � leur consultation. Soyez
 �galement vigilants � ne pas envoyer
  des documents infect�s par des virus. Il est prudent de soumettre
 son document � un logiciel antivirus � jour avant de le
 d�poser
  sur le portail.</p>
<p>Les documents sont pr�sent�s par ordre
 alphab�tique.<br><br>
  <b>Astuces:</b> si vous souhaitez que les documents soient class�s
 de
  mani�re diff�rente, vous pouvez les faire
 pr�c�der
  d\'un num�ro, le classement se fera d�s lors sur cette base.
 </p>
<p>Vous pouvez :</p>
...
<ul>
  <li>S�lectionnez le document sur votre ordinateur � l\'aide
 du
	bouton \"Parcourir...\"
	<input type=\"button\" value=\"Parcourir...\">
	� droite de votre �cran.</li>
  <li>Ex�cutez le transfert � l\'aide du
 bouton \"Transférer\"
	<input type=\"button\" value=\"Transférer\">
	.</li>
</ul>
<h4>Renommer un document (ou un r�pertoire)</h4>
<ul>
  <li>cliquez sur le bouton <img src=\"../img/edit.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">
	dans la colonne \"Modifier\".</li>
  <li>Tapez le nouveau nom dans la zone pr�vue � cet effet.</li>
  <li>Valider en cliquant sur \"Valider\"
	<input type=\"button\" value=\"Valider\">
	.
</ul>
	<h4>Supprimer un document (ou un r�pertoire)</h4>
	<ul>
 ...
 src=\"../img/comment.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">
	dans la colonne \"Modifier\"</li>
	  <li>Tapez le nouveau commentaire dans la zone pr�vue � cet
 ...
 rangeant
	  les documents dans des r�pertoires. Pour ce faire vous devez :</p>
	<h4><b>Cr�er un r�pertoire</b></h4>
	<ul>
	  <li>Cliquez sur le lien \"<img
 src=\"../img/dossier.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">Cr�er
		un r�pertoire\" en haut de la liste des fichiers</li>
	  <li>Tapez le nom de votre nouveau r�pertoire dans la zone
 pr�vue
		� cet effet en haut � gauche de l\'�cran.</li>
	  <li>Validez en cliquant \"Valider\"
		<input type=\"button\" value=\"Valider\">
		.</li>
	</ul>
	<h4>D�placer un document (ou un r�pertoire)</h4>
	<ul>
	  <li>Cliquez sur le bouton <img src=\"../img/deplacer.gif\" width=\"34\" height=\"16\" align=\"absmiddle\">
		dans la colonne \"D�placer\"</li>
	  <li>Choisissez le r�pertoire dans lequel vous souhaitez
 d�placer
		le document ou le r�pertoire dans le menu d�roulant
 pr�vu
		� cet effet qui appara�tra en haut � gauche (note:
		le mot \"root\" dans ce menu repr�sente la racine de
...
<li><b>P�dagogie</b> : Scorm intègre la notion de prérequis ou de <i>séquence</i> (p.ex. \"Vous ne pouvez pas entrer dans le chapitre 2 tant que vous n\'avez pas passé le Quiz 1\"),</li>
