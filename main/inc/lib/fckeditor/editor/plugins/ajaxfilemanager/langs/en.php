...
define('SEARCH_TYPE_SVG', 'Image');

define('SEARCH_TYPE_OGG', 'Audio');
define('SEARCH_TYPE_ODP', 'File');
define('SEARCH_TYPE_ODS', 'File');
define('SEARCH_TYPE_ODG', 'File');
define('SEARCH_TYPE_ODT', 'File');
