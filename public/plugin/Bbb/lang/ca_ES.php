...
$strings['Review meetings, recordings and available actions.'] = 'Reviseu les reunions, les gravacions i les accions disponibles.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Seleccioneu els fitxers PDF o PPTX que voleu precarregar com a diapositives per a la conferència.';
$strings['Max total: %d MB'] = 'Màxim total: %d MB';
$strings['Pre-upload Documents'] = 'Precàrrega de documents';
$strings['No documents found'] = "No s'han trobat documents";
$strings['Failed to load documents'] = "No s'han pogut carregar els documents";
$strings['No meetings or recordings are available yet.'] = 'Encara no hi ha reunions ni gravacions disponibles.';
$strings['Share the conference link with allowed participants.'] = "Compartiu l'enllaç de la conferència amb els participants autoritzats.";
$strings['presentation'] = 'Presentacio';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Tauler de Webhooks (Global)';
$strings['MeetingTitleContains'] = 'El títol de la reunió conté';
$strings['FromUTC'] = 'Des de (UTC)';
$strings['ToUTC'] = 'Fins a (UTC)';
$strings['OnlyOnlineRows'] = 'Només files en línia';
$strings['AllMeetings'] = 'Totes les reunions';
$strings['Apply'] = 'Aplicar';
$strings['ExportCSV'] = 'Exportar CSV';
$strings['AutoRefresh10s'] = 'Actualització automàtica (10s)';
$strings['ActiveMeetings'] = 'Reunions actives';
$strings['ConnectedNow'] = 'Connectats ara';
$strings['JoinsToday'] = 'Connexions avui';
$strings['Events24h'] = 'Esdeveniments (24h)';
$strings['OnlineTime'] = 'Temps en línia';
$strings['Conversation'] = 'Conversació';
$strings['CameraShare'] = 'Compartir càmera';
$strings['Messages'] = 'Missatges';
$strings['Reactions'] = 'Reaccions';
$strings['Hands'] = 'Mans alçades';
$strings['Results'] = 'Resultats';
$strings['Status'] = 'Estat';
$strings['Joined'] = "S'ha unit";
$strings['Last'] = 'Últim';
$strings['Running'] = 'En curs';
$strings['Finished'] = 'Finalitzada';
$strings['UsersColon'] = 'Usuaris:';
$strings['OnlineColon'] = 'En línia:';
$strings['TalkColon'] = 'Parla:';
$strings['CameraColon'] = 'Càmera:';
$strings['Updated'] = 'Actualitzat';
$strings['FirstJoin'] = 'Primera connexió';
$strings['LastSeen'] = 'Última visualització';
$strings['Totals'] = 'Totals';
$strings['Talking'] = 'Parlant';
$strings['User'] = 'Usuari';
