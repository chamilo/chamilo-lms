...
$PermissionsForNewFilesComment = "Möjligheten att definiera behörighetsinställningarna för alla nyskapade filer förbättrar säkerheten mot attacker där filer laddas upp till din portal. Standardinställningen (0550) ska vara tillräcklig för att ge din server en rimlig skyddsnivå. Formatet ä";
$langStudent = "Student";
$Guest = "Gäst";
...
$SplitUsersUploadDirectoryComment = "På kursportaler som har mycket hög belastning, där användare skickar in bilder, kan uppladdningsmappen  (main/upload/users/) bli överfylld (det finns rapporter om stopp vid mer än 36000 filer på en Debianserver). Om du aktiverar detta val förändras sättet";
...
$AvailablePlugins = "Detta är de insticksmoduler som hittats på ditt system. Du kan hämta ytterligare insticksmoduler från <a href=\\"http://www.chamilo.org/extensions/index.php?section=plugins\\">http://www.chamilo.org/extensions/index.php?section=plugins</a>";
...
$PermissionsForNewDirsComment = "Möjligheten att sätta rättighetsnivån på varje nyskapad mapp kan hjälpa dig att förbättra säkerheten mot hackare som vill ladda upp skadligt material till din kursportal.Standardinställningen för rättigheter (0770) bör vara tillräcklig för en rimlig säker";
...
$VersionCheckExplanation = "För att kunna aktivera automatisk versionskontroll måste man registrera sin kursportal på chamilo.comInformationen som skickas när du aktiverar med knappen används bara för internt bruk. Endast sammanslagna data kommer att visas upp (totalt antal kursport";
...
$UploadExtensionsBlacklistComment = "Svartlistan används för att ta bort (eller namnändra) alla filer med filändelse från listan. Filändelserna ska skrivas in utan föregående punkt (.) och separeras med semikolon (;) exempel: exe;com;bat;scr;php Filer utan ändelse accepteras. Stora eller små";
$UploadExtensionsWhitelistComment = "Vitlistan används för att ta bort (eller namnändra) alla filer som INTE har en filändelse från listan. Vitlistan räknas som säkrare, men mycket mer strikt filtermetod än svartlistan. Filändelserna ska skrivas in utan föregående punkt (.) och separeras med";
$UploadExtensionsSkip = "Filtreringsmetod (tabort/namnändra)";
$UploadExtensionsSkipComment = "Om du väljer \\"tabort\\", kommer filtreringen med svart- eller vitlistan innebära att filen inte uppladdas till systemet.Om du väljer \\"namnändra\\" kommer den att uppladdas och byter filändelse till det som är angivet i filändringsinställningen. OBS! Namnä";
...
$InstallDirAccessibleSecurityThreat = "Mappen main/install i din installation av Chamilo är fortfarande tillgänglig för alla på Internet. Det innebär en säkerhetsrisk för din installation. Vi rekommenderar att du tar bort mappen eller ändrar rättigheterna för mappen så att inte användare kan k";
...
$AllowurlfopenIsSetToOff = "Inställningen för \\"allow_url_fopen\\" i PHP är satt till \\"off\\". Det gör att registreringsmekanismen inte fungerar som den ska. Inställningen kan ändras i din servers konfiguraionsfil för PHP (php.ini) eller med konfigurering i Apache Virtual Host, genom";
...
$LDAPEnableComment = "Med LDAP aktiverat kan användare använda sitt LDAP-konto som inloggning till Chamilo.För att kunna använda en LDAP-server måste du först konfigurera inställningarna nedan i enlighet med installationsguiden, sedan aktivera LDAP-användning. Om du inte vet v";
...
$LDAPFilledTutorFieldComment = "En kontroll görs mot LDAP-servern om den som får ett konto är handledare/lärare eller vanlig användare. Om du vill att alla ska bli vanliga användare lämnar du fältet tomt. Inställningen kan även ändras i koden, läs isåfall mer om det i <a href=\\"../../do";
