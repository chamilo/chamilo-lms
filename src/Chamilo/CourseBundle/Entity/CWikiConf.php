...
class CWikiConf
{
     ...
     * @var string
     *
     * @ORM\Column(name="task", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $task;
     ...
     * @var string
     *
     * @ORM\Column(name="feedback1", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $feedback1;
     ...
     * @var string
     *
     * @ORM\Column(name="feedback2", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $feedback2;
     ...
     * @var string
     *
     * @ORM\Column(name="feedback3", type="text", precision=0, scale=0, nullable=false, unique=false)
     */
    private $feedback3;
     ...
     * @var string
     *
     * @ORM\Column(name="fprogress1", type="string", length=3, precision=0, scale=0, nullable=false, unique=false)
     */
    private $fprogress1;
     ...
     * @var string
     *
     * @ORM\Column(name="fprogress2", type="string", length=3, precision=0, scale=0, nullable=false, unique=false)
     */
    private $fprogress2;
     ...
     * @var string
     *
     * @ORM\Column(name="fprogress3", type="string", length=3, precision=0, scale=0, nullable=false, unique=false)
     */
    private $fprogress3;
     ...
     * @var integer
     *
     * @ORM\Column(name="max_size", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $maxSize;
     ...
     * @var integer
     *
     * @ORM\Column(name="max_text", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $maxText;
     ...
     * @var integer
     *
     * @ORM\Column(name="max_version", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $maxVersion;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="startdate_assig", type="datetime", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="enddate_assig", type="datetime", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="delayedsubmit", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
