...
FCKLang.txtLongitude  = 'Дължина, ° ' ;
FCKLang.GMapsMarker		= 'Маркер' ;
FCKLang.GMapsSearchLabel	= 'Търсене на място' ;
FCKLang.GMapsSearch		= 'Търсене' ;
...
FCKLang.GMapsClickToAddMarker = 'Щракнете върху картата за да добавите маркер.' ;
FCKLang.GMapsDeleteMarker = 'Изтриване на маркера' ;
FCKLang.GMapsAddMarker = 'Добавяне на маркер' ;
