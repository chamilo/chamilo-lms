...
$OpenIDDescription = "Met OpenID hebt u niet langer verschillende gebruikersnamen nodig voor allerlei websites, hetgeen uw webwerk aanzienlijk vereenvoudigt. Aan u de OpenID Provider te kiezen die het best aan uw behoeften beantwoordt en, nog belangrijker, die u vertrouwt. And";
...
$Folder = "Folder";
$CloseOtherSession = "De chat is niet beschikbaar omdat een andere cursus geopend is in een andere pagina. Om dit te voorkomen dient u te verifiëren dat u in dezelfde cursus blijft voor de ganse chatsessie. Om de chat sessie opnieuw te laden dient u deze te herstarten van de c";
