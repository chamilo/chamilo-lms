...
$langPublish = "Objavi";
$langScormcontentstudent = "Ovo je kolegij formata Scorm. elite li ga pokrenuti, kliknite ovdje: <input type=button name=scormbutton value=\'Pokreni !\' onclick=\'openscorm()\'>";
$langScormcontent = "Ovo je sadraj formata Scorm<br><input type=button name=scormbutton value=Pokreni ! onclick=\'openscorm()\'>";
