...
$lang_short_help = "Para adicionar uma etapa, clique na cruz; para adicionar um novo título/descrição, clique no lápis; para adicionar pré-requisitos clique no ícone com dois documentos. Você pode verificar o que os estudantes irão visualizar clicando na Visão do Estudante a";
...
$langWarning = "Atenção!";
$langWarningEditingDocument = "Quando edita um documento existente na Rota de Aprendizagem, a nova versão do documento não se sobrepõe à versão antiga, mas será guardada como novo documento. Se desejar editar um documento de maneira definitiva terá de o fazer a partir da ferramenta Doc";
...
$WelcomeWoogieConverter = "Bem-Vindo ao conversor Woogie<ul type=\\"1\\"><li>Escolher um arquivo .doc, .sxw, .odt<li>Carregar o arquivo no Woogie. Será convertido numa Rota de Aprendizagem SCORM<li>Depois, poderá acrescentar comentários áudio em cada página e inserir questionários e";
