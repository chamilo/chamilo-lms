...
// mPDF - see edit near end of script
  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '<?php echo _MPDF_URI; ?>progress/progbarback.png',	// boxImage : image around the progress bar
			barImage	: '<?php echo _MPDF_URI; ?>progress/progbar.png',	// Image to use in the progressbar. Can be an array of images 
  ...
  */
	 ...
	 */
		...
		if (autoHook == true) {
			...
			initProgressBarHandler();	// mPDF edit to show immediately before loaded
		}