...
$langYourDokeosUses = "La so instalación de Chamilo usa agora mesmo";
...
$PermissionsForNewFilesComment = "La capacidá de definir la configuración de permisos asociaos a los archivos nuevos aumenta la seguridá escontra ataques de hackers que faigan por unviar material pelligrosu a la plataforma. La configuración por defeutu (0550) tendría de ser abondo pa que\";
...
$SplitUsersUploadDirectoryComment = "En portales con munchu usu, con munchos usuarios qu\'unvíen fotos, el direutoriu nel que s\'almacenen (main/upoload/users/) pue llegar enllenase de mou y manera que\'l sistema nun seya manexalos bien (tiense documentao\'l casu d\'un servidor Debian con má";
...
$DropboxAllowStudentToStudentComment = "Dar permisu pa que los estudiantes unvíen documentos a otros estudiantes (peer to peer, intercambiu P2P). Piense que los estudiantes puen usar esto pa unviase documentos ensin valir (mp3, solucionarios, etc.) Si quita esta función los estudiantes namás va";
...
$PermissionsForNewDirsComment = "La posibilidá de definir la configuración de permisos asignaos a direutorios nuevos da más seguridá escontra ataques de hackers qu\'intenten unviar material pelligrosu a la plataforma. La configuración por defeutu (0770) debería ser abondo pa una proteici";
...
$langVisioconfDescription = "Chamilo Live Conferencing® ye una ferramienta estándar de videoconferencia qu\'ufierta: enseñar diapositives, pizarra pa dibuxar y escribir, audio/video duplex, chat. Namás necesita Flash® player y tien tres modos: ún a ún, ún a munchos y munchos a muncho";
$langPpt2lp = "Oogie-Woogie Itinerarios d\'aprendizaxe";
$langPpt2lpDescription = "Oogie-Woogie ye una ferramienta que permite xenerar secuencies d\'aprendizaxe de manera rápida. Pue convertir presentaciones Powerpoint y documentos Word, y los sos equivalentes d\'Openoffice en cursos tipu SCORM. Dempués de la conversión, el documentu va";
...
$VersionCheckExplanation = "P\'habilitar la comprobación automática de la versión, tien de rexistrar el so portal en chamilo.com La información que s\'unvía de la que se calca esti botón val namás pa usu internu y namás los datos amestaos van tar visibles pal públicu (númberu total";
...
$PublicPagesComplyToWAIComment = "WAI (Web Accessibility Initiative) ye una aniciativa que nagua por facer la web más accesible. Seleicionando esta opción, les páxines públiques de Chamilo van ser más accesibles. Esto tamién va facer que dellos conteníos de les páxines públicaes se vean d";
...
$UploadExtensionsBlacklistComment = "La blacklist o llistáu negru úsase pa filtrar los ficheros poles sos estensiones, esborrando (o renomando) tolos ficheros pa los que la estensión nun tea nel llistáu. Les estensiones hai que les escribir ensin el puntu (.) y separtaes por puntu y coma (;)";
$UploadExtensionsWhitelistComment = "La whitelist o llistáu blancu úsase pa filtrar los ficheros según estensiones, esborrando (o renomando) tolos ficheros pa los que la estensión un ta nel llistáu. Ye\'l tipu de filtráu más seguru, pero tamién el más restrictivu. Les estensiones tienen de f";
$UploadExtensionsSkip = "Comportamientu del filtráu (esborrar/renomar)";
$UploadExtensionsSkipComment = "Si escueye esborrar, los archivos filtraos cola blacklist o la whitelist nun van poder unviase al sistema. Si escueye renomalos, la estensión va sustituyise pola definida na configuración de remplazu d\'estensiones. Piense que renomales nun ye davezu prot";
...
$EphorusDescription = "Entamar a usar en Chamilo el serviciu antiplaxu d\'Ephorus  <br/> <strong>Con Ephorus pue defendese del plaxu n\'Internet ensin mayor esfuerzu.</strong><br/> Pue usar el nuestru serviciu web estándar pa facer la so propia integración o usar ún de los módu";
...
$PlatformCharsetComment = "El xueu de carauteres ye\'l que controla la manera na que ciertos idiomes apaecen en Chamilo. Si, por exemplu, usa carauteres rusos o xaponeses, lo más probable ye que quiera cambiar el xueu. Pa tolos carauteres anglosaxones, llatinos y d\'Europa Occident";
...
$NoReplyEmailAddressComment = "Esta ye la direición de corréu electrónicu que va usar de la que s\'unvía un corréu solicitando que\'l destinatariu nun retruque. Xeneralmente, esta direición de corréu electrónicu tien de tar configurada nel so servidor esborrando/ignorando cualquier otr";
...
$InstallDirAccessibleSecurityThreat = "El direutoriu d\'instalación main/install/ ta abiertu a los uausarios de la web. Esto pue ser un pelligru pa la seguridá. Recomiéndase esborrar esti direutoriu o camudar los permisos de mou y manera que los usuarios de la web nun puedan usar los scripts q";
...
$UserThemeSelectionComment = "Dar permisu pa que los usuarios puedan escoyer el so propiu tema visual dende\'l so perfil. Esto cambia l\'aspeutu de Chamilo pero l\'estilu por defeutu de la plataforma queda ensin tocar. Si un cursu o sesión tienen asignáu un tema específicu, nellos va";
$AllowurlfopenIsSetToOff = "El parámetru de PHP \\"allow_url_fopen\\" ta inactivu. Esto fae que\'l mecanismu de rexistru nun funcione correutamente. Esti parámetru pue cambiase nel archivu de configuración de PHP (php.ini) o na configuración del Virtual Host d\'Apache con una direutiv";
...
$UserFieldsAddHelp = "Amestar un campu d\'usuariu ye perfácil: <br/>-escueya una palabra como identificador en minúscules, <br/>-seleicione un tipu, <br/>-escueya\'l testu que-y va apaecer al usuariu (si usa un nome yá traducíu por Chamilo, como BirtDate o UserSex, automáticam";
$AllowCourseThemeTitle = "Dar permisu pa temes gráficos personalizaos nos cursos";
$AllowCourseThemeComment = "Dar permisu pa que los cursos puedan tener un tema gráficu distintu, pudiendo camudar la fueya d\'estilu por una de les disponibles en Chamilo. Si un usuariu entra nun cursu, la fueya d\'estilu del cursu tien preferencia sobre la del usuariu y sobre la qu";
...
$ShowClosedCoursesComment = "¿ Amosar los cursos pesllaos na páxina de rexistru y na páxina d\'entamu de la plataforma ? Na páxina d\'entamu de la plataforma va apaecer un iconu al llau del cursu, pa poder matriculase de manera rápida nél. Esto namás va apaecer na páxina d\'entamu de";
$LDAPConnectionError = "Erru de conesión LDAP";
$LDAP = "LDAP";
$LDAPEnableTitle = "Habilitar LDAP";
$LDAPEnableComment = "Si tien un servidor LDAP va tener que configurar los parámetros d\'embaxu y modificar el ficheru de configuración descritu na guia d\'instalación pa activalu. Con ello va dar permisu pa que los usuarios s\'identifiquen col so nome d\'usuariu LDAP. Si nun";
...
$LDAPFilledTutorFieldComment = "Esto va facer una comprobación del conteníu del campu de contautu LDAP nel que van ponese los usuarios nuevos. Si esti campu nun ta vacíu, l\'usuariu consideraráse profesor y Chamilo va apuntalu como tal. Si quier que tolos usuarios seyan namás usuarios n";
...
$VisioUseRtmptComment = "El protocolu rtmpt da la posibilidá d\'acceder a una videoconferencia dende detrás d\'un cortafueos (firewall), redirixendo les comunicaciones pel puertu 80. Esto va facer más lento\'l streaming polo que nun se recomienda\'l so usu a nun ser que seya nece";
...
$LDAPFilledTutorFieldValueComment = "De la que se fai una comprobación nel campu profesor qu\'apaez enriba pa que l\'usuariu apaeza como profesor, el valor que se-y dé tien de ser ún de los soelementos del campu profesor. Si\'l campu queda en blancu, la única condición pa ser consideráu prof";
...
$Templates = "Plantíes";
$HideCampusFromPublicDokeosPlatformsList = "Nun amosar el mio campus nel llistáu públicu de portales Chamilo";
...
$AllowUseSubLanguageComment = "Al activar esta opción, podrás definir variaciones pa cada términu del llinguaxe usáu pa la interface de la plataforma, na forma d\'un nuevu llinguaxe basáu nun llinguaxe esistente. Podrás alcontrar esta opción nel menú d\'idiomes de la to páxina d\'almin";
...
$CopyCourseFromSessionToSessionExplanation = "Si quies copiar un cursu d\'una sesión a otru cursu d\'otra sesión, primero tienes que seleicionar un cursu de la llista de cursos d\'orixe de la sesión. Puedes copiar conteníos de les ferramientes descripción del cursu, documentos, glosariu, enllaces, ex";
...
$DokeosClassic2D = "Chamilo clásicu 2D";
