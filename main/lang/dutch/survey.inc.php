...
$UseLinkSyntax = "De geselecteerde gebruikers zullen een email ontvangen met de tekst die u hierboven tikt en een unieke link die ze dienen aan te klikken om de enquete in te vullen. Als u deze link ergens in uw tekst wilt laten verschijen dient u de **link** (ster ster li";
...
$CompleteReportDetail = "In dit rapport krijgt u een overzicht van alle antwoorden van alle gebruikers op alle vragen. U kunt het rapport ook wijzigen door slechts bepaalde vragen in het rapport op te nemen. De gegevens die u te zien krijgt kunnen ook geëxporteerd worden naar een";
