...
FCKLang['Folder']             = 'Mapa' ;
FCKLang['CreateNewFolder']    = 'Izrada mape' ;
FCKLang['UploadFile']         = 'Prenesi datoteku' ;
FCKLang['Upload']             = 'Pošalji' ;
FCKLang['UploadSelectFileFirst'] = 'Please, select a file before pressing the upload button.' ;

FCKLang['ResourceTypeRoot']   = 'Korijen' ;
FCKLang['ResourceTypeAudio']  = 'Zvučni zapis' ;
FCKLang['ResourceTypeFlash']  = 'Flash format' ;
