...
$langAllAdmin = "has now <b>ALL teacher rights on this site</b>";
$langNoAdmin = "has now <b>NO teacher rights on this site</b>";
$langAll = "All";
$langNone = "None";
$UserPicture = "Picture";
...
$langAccountExist = "This account exists.<BR>A mail is sent to  administrator.<BR>";
$langAccountNotExist = "Account not found.<BR>A mail is sent to  administrator. They  would search manually.<BR>";
