...
$langVisioconfDescription = "Chamilo Live Conferencing® ist ein Standard Tool von Visioconference. Es bietet: Anzeige von Diapos, Whiteboard zum Zeichnen und Schreiben, Audio/Video duplex, Chat. Es ist lediglich der Flash® Player notwendig und es werden 3 Modi unterstützt: one2one, one2many und many2many.";
...
$UserThemeSelectionComment = "Benutzer können ihr eigenes Theme in ihrem Profil auswählen. Das verändert das Aussehen von Chamilo für sie, lässt aber den Stil des Portals intakt. Falls ein bestimmter Kurs oder eine Session ein bestimmtes Theme verwendet, hat dies Vorrang über Benutzer definierte Themes";
