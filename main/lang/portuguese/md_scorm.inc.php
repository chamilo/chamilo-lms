...
*/
$nameTools = "variсvel de linguaguem obsoleta";
$langMdCallingTool = "Sequъncia de Aprendizagem - Scorm";
$langTool = "Operaчѕes MD Scorm";
$langSorry = "Seleccionar um curso primeiro";
$langDenied = "Esta funчуo estс apenas disponэvel para o administrador do curso";
$langNotInDB = "Nуo existe entrada DB Dokeos";
$langManifestSyntax = "(erro de sintaxe no ficheiro manifest ...)";
$langEmptyManifest = "(esvaziar ficheiro manifest ...)";
$langNoManifest = "(nуo existe ficheiro manifest ...)";
$langNotFolder = "nуo щ possэvel, nуo щ uma pasta ...";
$langUploadHtt = "Transferir ficheiro HTT";
$langHttFileNotFound = "O novo ficheiro HTT nуo pєde ser aberto (ex.: vazio, demasiado grande)";
$langHttOk = "Novo ficheiro HTT foi transferido";
$langHttNotOk = "falhou a transferъncia do ficheiro HTT";
$langRemoveHtt = "Remover ficheiro HTT";
$langHttRmvOk = "O ficheiro HTT foi removido";
$langHttRmvNotOk = "A remoчуo do ficheiro HTT falhou";
...
$langStatistics = "Estatэsticas";
$langTotalMDEs = "Nњmero total de entradas MD Scorm:";
$langMainMD = "Abrir MDE Principal";
$langLines = "linhas";
$langPlay = "Abrir index.php";
$langNonePossible = "Nуo sуo possэveis operaчѕes MD";
...
$langMffNotOk = "Falhou reposiчуo do ficheiro manifest";
$langMffOk = "O ficheiro manifest foi recolocado";
$langMffFileNotFound = "Novo ficheiro manifest nуo pode ser aberto (ex.: vazio, demasiado grande)";
