...
class CcResources implements CcIResource
{
     ...
     */
    public function addResource($fname, $location = ''): void
    {
     ...
     * Import a resource.
     */
    public function importResource(DOMElement &$node, CcIManifest &$doc): void
    {
     ...
     * @param string $folder
     */
    public function processResource($manifestroot, &$fname, $folder): void
    {
    ...
    public function initEmptyNew(): void
    {
