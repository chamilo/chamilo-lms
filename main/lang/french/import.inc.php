...
$langExplanation = "Cette page doit être au format HTML (p. ex. \"ma_page.htm\"). Elle sera accrochée par un lien sur la page d'accueil du site. Si vous désirez envoyer un document non HTML (PDF, Power Point, Word...) utilisez l'outil <a href=../document/document.php> Docu";
