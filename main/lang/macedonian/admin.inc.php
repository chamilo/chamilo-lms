...
$CourseLanguage = "Јазик на курсот";
...
$Maximum = "максимум";
$MaximumOfParticipants = "Максимален број на членови";
...
$ImportFileLocation = "Локација на CSV / XML датотеката";
$FileType = "Тип на датотека";
$OutputFileType = "Излезен тип на датотека";
...
$AddACategory = "Додади категорија";
$Into = "во";
...
$Back = "Назад до претходната страна";
...
$ExampleXMLFile = "Пример на XML датотека";
$ExampleCSVFile = "Пример на CSV датотека";
...
$AddAnnouncement = "Додај ново известување";
$AnnouncementAdded = "Известувањето беше додадено";
...
$ConfigureExtensions = "Подеси ги сервисите";
