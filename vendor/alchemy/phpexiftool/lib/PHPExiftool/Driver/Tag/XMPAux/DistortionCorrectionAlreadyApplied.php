 ...
 * @ExclusionPolicy("all")
 */
class DistortionCorrectionAlreadyApplied extends AbstractTag
{

    protected $Id = 'DistortionCorrectionAlreadyApplied';

    protected $Name = 'DistortionCorrectionAlreadyApplied';
