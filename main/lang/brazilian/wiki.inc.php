...
$WarningDeleteMainPage = "Não se recomenda a eliminação da Página principal do Wiki, já que é o acesso principal à estrutura hierárquica.<br> Se, por qualquer razão, necessita eliminá-la, não esqueça de voltar a criá-la. Até que o faça, os outros usuários não podem acrescentar nov";
