...
$UplFileTooBig = "O arquivo que enviou é muito grande para a atual configuração do Chamilo (%sMB). Por favor, contate o Administrador da Plataforma.";
...
$OpenIDDescription = "OpenID elimina a necessidade de ter vários nomes de usuário em diferentes sítios web, simplificando a experiência do usuário na Internet. Pode escolher o provedor de OpenID que melhor satisfaça as suas necessidades e, o que é mais importante, aquele em qu";
