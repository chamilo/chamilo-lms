...
test.describe('Attendance tool', () => {
  ...
  test('Create', async ({ Given, Then, And, page }) => { 
    await Given('I am on "/main/attendance/index.php?cid=1&action=attendance_add"', null, { page }); 
  ...
  test('Read', async ({ Given, Then, And, page }) => { 
    await Given('I am on "/main/attendance/index.php?cid=1"', null, { page }); 
    await And('I wait for the page to be loaded', null, { page }); 
  ...
  test('Update', async ({ Given, When, Then, And, page }) => { 
    await Given('I am on the attendance page "/main/attendance/index.php?cid=1&action=attendance_edit&attendance_id=ATTENDANCE_ID"', null, { page }); 
    await And('I wait for the page to be loaded', null, { page }); 
  ...
  test('Delete', async ({ Given, Then, And, page }) => { 
    await Given('I am on "/main/attendance/index.php?cid=1&sid=0"', null, { page }); 
    await And('I wait for the page to be loaded', null, { page }); 
