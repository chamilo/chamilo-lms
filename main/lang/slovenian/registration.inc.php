...
$AccountExternalAuthSource = "Chamilo ne more te zahteve servisirati avtomatièno, ker je uporabniški raèun avtoriziran s pomoèjo tunanjega izvora. Izvedite odgovarjajoèe mere in obvestite uporabnika.";
$AccountsExternalAuthSource = "Chamilo ne more servisirati te izjeme avtomatièno, ker je vsaj eden od uporabniških raèunov avtoriziran preko zunanjega izvora. Izvedite odgovarjajoèe mere za vse uporabniške raèune (vklju&#269;no s tistimi, ki jih avtorizira platforma) in ibvestite uporabnike.";
$RequestSentToPlatformAdmin = "Chamilo ne more servisirati zahteve avtomati&#269;no za to vrsto uporabniškega raèuna. Vaša zahteva je bila posredovana upravitelju platforme, ki bo izvedel odgovarjajoèe mere in vas naknadno obvestil o rezultatih izvedbe zahteve.";
$langphone = "Tel.";
$Unreg = "Odjavi";
...
$ByClickingRegisterYouAgreeTermsAndConditions = "S klikom se strinjam z naèini in pogoji rabe";
$User = "Uporabnik";
...
$NoUserAccountWithThisEmailAddress = "Tu ni uporabniškega raèuna s tem uporabniškim imenom ali e-poštnim naslovom";
?>