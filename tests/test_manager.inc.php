...
require_once $maindir.'exercise/export/scorm/scorm_classes.php';
require_once $maindir.'exercise/export/qti2/qti2_classes.php';
require_once $maindir.'exercise/export/exercise_import.inc.php';
require_once $maindir.'exercise/exercise_result.class.php';
require_once $maindir.'exercise/answer.class.php';
require_once $maindir.'exercise/exercise.class.php';
require_once $maindir.'exercise/fill_blanks.class.php';
require_once $maindir.'exercise/freeanswer.class.php';
