...
$OpenIDDescription = "OpenID élimine le besoin de logins multiples pour accéder à différents sites web, simplifiant ainsi votre vie quotidienne. Vous pouvez choisir un fournisseur OpenID en qui vous avez confiance. En même temps, vous gardez votre OpenID, quel que soit le four";
...
$Folder = "Dossier";
$CloseOtherSession = "Le chat n\'est pas disponible car une autre page a été ouverte dans une autre formation. Pour éviter ce problème, merci de rester dans le même cours pendant toute la durée de votre discussion. Nous vous invitons à recharger la page courante depuis la page";
...
$TitleColumnGradebook = "Titre de colonne dans le certificat";
$QualifyWeight = "Poids dans le certificat";
$ThematicAdvance = "";
$EditProfile = "";
$TabsDashboard = "";
$Dashboard = "";
