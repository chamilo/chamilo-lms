...
$AddComment = "Dodaj/Modyfikuj komentarz do";
...
$Scormcontent = "To jest zawartość pliku SCORM<br><input type=button name=scormbutton value='Uruchom!' ='openscorm()'>";
$Scormcontentstudent = "To jest kurs w formacie SCORM. Aby uruchomić naciśnij:<input type=button name=scormbutton value='Uruchom !' ='openscorm()'>";
$Publish = "Publikowanie";
$MissingImagesDetected = "Wykryto brakujące obrazki";
$CreateDocument = "Utwórz dokument";
$EditDocument = "Edytuj";
$Documents = "Dokumenty";
$OrganiseDocuments = "Tworzenie spisu treści";
...
$AddMetadata = "Podgląd/Edycja Metadanych";
$GoMetadata = "Idź";
