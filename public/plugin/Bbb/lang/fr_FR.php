...
$strings['big_blue_button_students_start_conference_in_groups'] = 'Permettre aux apprenants de démarrer les vidéoconférences de leurs groupes';
...
$strings['Share the conference link with allowed participants.'] = 'Partager le lien de la conférence avec les participants autorisés.';
$strings['presentation'] = 'Présentation';
$strings['video'] = 'Vidéo';
$strings['No recording'] = "Pas d'enregistrement";
$strings['WebhooksDashboard'] = 'Tableau de bord des activités (Global)';
$strings['MeetingTitleContains'] = 'Titre du meeting contient';
$strings['FromUTC'] = 'Du (UTC)';
$strings['ToUTC'] = 'Au (UTC)';
$strings['OnlyOnlineRows'] = 'Uniquement les lignes en ligne';
$strings['AllMeetings'] = 'Tous les meetings';
$strings['Apply'] = 'Appliquer';
$strings['ExportCSV'] = 'Exporter CSV';
$strings['AutoRefresh10s'] = 'Actualisation automatique (10s)';
$strings['ActiveMeetings'] = 'Meetings actifs';
$strings['ConnectedNow'] = 'Connectés maintenant';
$strings['JoinsToday'] = "Connexions aujourd'hui";
$strings['Events24h'] = 'Événements (24h)';
$strings['OnlineTime'] = 'Temps en ligne';
$strings['Conversation'] = 'Conversation';
$strings['CameraShare'] = 'Partage caméra';
$strings['Messages'] = 'Messages';
$strings['Reactions'] = 'Réactions';
$strings['Hands'] = 'Mains levées';
$strings['Results'] = 'Résultats';
$strings['Status'] = 'Statut';
$strings['Joined'] = 'Rejoint';
$strings['Last'] = 'Dernier';
$strings['Running'] = 'En cours';
$strings['Finished'] = 'Terminé';
$strings['UsersColon'] = 'Utilisateurs :';
$strings['OnlineColon'] = 'En ligne :';
$strings['TalkColon'] = 'Parole :';
$strings['CameraColon'] = 'Caméra :';
$strings['Updated'] = 'Mis à jour';
$strings['FirstJoin'] = 'Première connexion';
$strings['LastSeen'] = 'Dernière activité';
$strings['Totals'] = 'Totaux';
$strings['Talking'] = 'Parole';
