...
$lang_learning_path_builder = "Créer un cours (Chamilo AUTEUR)";
...
$langWarningEditingDocument = "Quand vous modifiez un document existant dans un cours, la nouvelle version du document n\'écrasera pas l\'ancienne version mais sera sauvegardée en tant que nouveau document. Si vous voulez modifier un document de façon permanente, vous pouvez le faire d";
...
$WelcomeWoogieConverter = "Bienvenue dans le convertisseur de Word Woogie<ul type=\\"1\\"><li>Choisissez un fichier .doc, docx, .sxw ou.odt<li>Envoyez ce fichier à Woogie. Il sera converti en cours<li>Vous pourrez ensuite ajouter des commentaires audio sur chaque page et insérer test";
...
$SearchFeatureSearchExplanation = "Pour effectuer une recherche dans la base de données des parcours, veuillez utiliser la syntaxe suivante:<br />   <i>terme tag:nom_du_tag -exclusion +inclusion \\"phrase exacte\\"</i><br/> Par exemple:<br/>        <i>voiture tag:camion -ferrari +ford \\"haut";
