...
$PlatformLanguagesExplanation = "������߹����ڵ�½ҳ������ѡ��˵���ƽ̨����Ա�ܾ�����������Ӧ����Ϊ����û�����";
$OriginalName = "原名字";
$EnglishName = "英文名";
$DokeosFolder = "桌面文件夹";
$Properties = "属性";
...
$CourseUsage = "课程使用";
$NoCoursesForThisUser = "���û�ûע�ᵽ�κογ�";
$NoClassesForThisUser = "���û�ûע�ᵽ�κΰ༶";
$NoCoursesForThisClass = "�˰༶ûע���κογ�";
...
$DummyCourseDescription = "�����˿γ�����, ����Ϊ������.";
$AvailablePlugins = "�����ϵͳ�з������в��. ���<a href=\"http://www.chamilo.org/extensions/index.php?section=plugins\">�ڴ�</a>���ظ������";
...
$UseDocumentTitleComment = "����ʹ���ļ�����, ����document_name.ext";
...
$CannotUnsubscribeUserFromCourse = "�û��޷�ע��. ���û�Ϊ�γ̹���Ա.";
