...
require_once $libdir.'fileManager.lib.php';
    ...
    function create_test_course($course_code = 'TESTCOURSE')
    {
        ...
        if (empty($row[0])) {
            ...
            $res = CourseManager::create_course(
                $course_data['wanted_code'],
                $course_data['title'],
                $course_data['tutor_name'],
                $course_data['category_code'],
                $course_data['course_language'],
                $course_data['course_admin_id'],
                $course_data['db_prefix'],
                $course_data['firstExpirationDelay']
            );
        }
