<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-xs-12">
                    ...
                    <p id="n-price" class="lead text-right" style="color: white;"><span
                                class="label label-primary">{{ course.currency == 'BRL' ? 'R$' : course.currency }} {{ course.price }}</span>
                    </p>
        ...
        {% elseif buying_session %}
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-xs-12">
                    ...
                    <p id="n-price" class="lead text-right" style="color: white;"><span
                                class="label label-primary">{{ session.currency == 'BRL' ? 'R$' : session.currency }} {{ session.price }}</span>
                    </p>
                    <p id="s-price" class="lead text-right"></p>
                </div>
            </div>
    ...
    <div class="col-md-6 panel panel-default buycourse-panel-default">
        ...
        <div class="form-group">
            <div class="col-sm-1"><input class="" type="checkbox" id="confirmTermsAndConditons"
                                         name="confirmTermsAndConditons"></div>
