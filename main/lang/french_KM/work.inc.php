...
/*
      ...
      +----------------------------------------------------------------------+
      |   $Id: work.inc.php 950 2004-04-01 20:24:14Z olivierb78 $         |
      +----------------------------------------------------------------------+
...
$langWorks="Contributions des membres";
...
// ADDED BY UGENT, february 2004, Patrick Cool: visibility newly uploaded documents
$lang_default_upload="Visibilité par défaut des documents envoyés (y compris dans le futur)";
$lang_new_visible="Les nouveau documents sont par défaut visibles par tous les membres";
$lang_new_unvisible="Les nouveau documents sont par défaut visibles seulement par les responsables";
