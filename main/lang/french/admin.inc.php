...
$ShowStudentViewComment = "Activer la vue �tudiant?<br />Cette fonctionnalit� permet � l\'enseignant de voir ce qu\'un �tudiant verrait.";
...
$PlatformLanguageComment = "Vous pouvez d�terminer la langue de la plateforme dans une autre section de l\'administration, soit: <a href=\"languages.php\">Langues de la plateforme Dokeos</a>";
$PlatformLanguageTitle = "Langue de la plateforme";
...
$InvalidStartDate = "Date de d�part invalide. <br />
Veuillez v�rifier.";
...
$ImageResizeComment = "Les images t�l�charg�s par les utilisateurs peuvent �tre redimensionn�es si PHP a �t� compil� avec la <a href=\\\"http://php.net/manual/en/ref.image.php\\\" target=\\\"_blank\\\">librairie GD</a>. Si ce n\'est pas le cas, ce r�glage n\'a aucun effet.";
...
$YesAddCSVHeader = "Oui, ajouter la ligne d\'en-t�te CSV<br />Cette ligne d�finit les champs et est n�cessaire lorsque vous d�sirez importer le fichier sur un autre campus Dokeos";
$DeleteSelectedSessions = "Supprimer les sessions s�lectionn�es";
