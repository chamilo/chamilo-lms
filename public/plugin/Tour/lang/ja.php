...
$strings['tour_home_topbar_logo_title'] = 'プラットフォームのロゴ';
$strings['tour_home_topbar_logo_content'] = 'このロゴをクリックすると、プラットフォームのホームページに戻ります。';
$strings['tour_home_topbar_actions_title'] = 'クイックアクション';
$strings['tour_home_topbar_actions_content'] = 'ここには、役割に応じてコース作成、ガイド付きヘルプ、チケット、メッセージなどのショートカットアイコンが表示されます。';
$strings['tour_home_menu_button_title'] = 'メニューボタン';
$strings['tour_home_menu_button_content'] = 'このボタンを使ってサイドメニューをすばやく開閉できます。';
$strings['tour_home_sidebar_title'] = 'メインメニュー';
$strings['tour_home_sidebar_content'] = 'このサイドメニューから、権限に応じてプラットフォームの主要セクションにアクセスできます。';
$strings['tour_home_user_area_title'] = 'ユーザーエリア';
$strings['tour_home_user_area_content'] = 'ここからプロフィール、個人設定にアクセスしたり、ログアウトしたりできます。';
