...
$langSend = "Enviar";
$langUserAddExplanation = "Cada linea del archivo que envíe necesariamente tiene que incluirtodos y cada uno de estos 5 campos (y ninguno más):  <b>Nombre   Apellidos   		Nombre de usuario   Contraseña 		  Correo Electrónico</b> separadas por tabuladores y en óste orden.		Los usuar";
...
$AccountsExternalAuthSource = "Chamilo no puede gestionar automáticamente la petición porque al menos una de las cuentas tiene una fuente de autorización externa.  Por favor, tome las medidas apropiadas en todas las cuentas (incluyendo las que tienen autorización de la plataforma) y no";
