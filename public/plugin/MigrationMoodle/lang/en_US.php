...
$strings['InstallError'] = 'An error occurred installing the plugin: %s';
$strings['AdminIntro'] = 'Run Moodle migration tasks in order. Each step is enabled only after its parent step has been completed.';
$strings['MoodleDatabase'] = 'Moodle database';
$strings['MoodledataPath'] = 'Moodledata path';
$strings['AccessUrlId'] = 'Access URL ID';
$strings['Configured'] = 'Configured';
$strings['NotConfigured'] = 'Not configured';
$strings['ConfigurePlugin'] = 'Configure plugin';
$strings['MissingRequiredDatabaseConfiguration'] = 'Configure the Moodle database host, user and database name before running migration tasks.';
$strings['MissingMoodledataPathWarning'] = 'Moodledata path is empty. File-related tasks may fail until this setting is configured.';
$strings['InvalidMigrationAction'] = 'Invalid migration action.';
$strings['InvalidSecurityToken'] = 'Invalid security token. Please reload the page and try again.';
$strings['MigrationTasks'] = 'Migration tasks';
$strings['MaintenanceScripts'] = 'Maintenance scripts';
$strings['ExecutionOutput'] = 'Execution output';
$strings['TaskAlreadyExecuted'] = 'This task or script has already been executed.';
$strings['SelectTaskToRun'] = 'Select a migration task to run. Output will appear here.';
