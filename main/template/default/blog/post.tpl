                    ...
                    <div id="blog-header">
                        ...
                        <div class="info-post">
                            ...
                            <span class='comments'><i
                                        class="fa fa-comment-o"></i> {{ post.n_comments }} {{ 'Comments' | get_lang }} </span>
                        ...
                        {% if post.files %}
                            <div class="well well-sm files">
                                <i class="fa fa-paperclip" aria-hidden="true"></i> <a
                                        href="download.php?file={{ post.files.path }}">{{ post.files.filename }}</a>
                            </div>
                        {% endif %}
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="info-post">
                                                ...
                                                <span class="score"><i class="fa fa-star"
                                                                       aria-hidden="true"></i> {{ item.score_ranking }}</span>
                                            </div>
                                            {{ item.content }}
