...
$TicketSendWarningToAllAdminsComment = "Stuur een bericht als een ticket is aangemaakt zonder categorie of als aan een categorie geen beheerder is toegewezen.";
...
$MailingTestSent = "Email verzonden. Deze procedure werkt in alle opzichten op dezelfde manier als de normale e-mailverzending van Chamilo, maar zorgt voor meer flexibiliteit wat betreft bestemmingse-mail en berichttekst.";
$EMailTester = "Email tester";
$TicketMsgWelcome = "Welkom bij JOUW tickets sectie. Hier kun je de status volgen van alle tickets die je hebt gemaakt.";
$TicketNoHistory = "Geen geschiedenis";
$UpgradeVersion = "Upgrade Chamilo LMS version";
$CRSTablesIntro = "Het installatiescript heeft tabellen van eerdere versies gedetecteerd die problemen kunnen veroorzaken tijdens het upgradeproces. Klik op de onderstaande knop om ze te verwijderen. We raden u ten zeerste aan om er een volledige back-up van te maken voordat u deze laatste installatiestap bevestigt.";
