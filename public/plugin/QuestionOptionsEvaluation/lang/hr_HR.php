...
$strings['QuizQuestionsScoreRulesTitleConfirm'] = 'Promjena formule procjene generira promjene za svako pitanje u vježbi i sprječava poništavanje ove promjene dolje. Jeste li sigurni da želite nastaviti?';
$strings['EvaluationFormula'] = 'Formula procjene';
$strings['NoFormula'] = 'Nema formule';
$strings['Formula1'] = 'Uspješno - Neuspješno';
$strings['Formula2'] = '(Uspješno - Neuspješno) / 2';
$strings['Formula3'] = '(Uspješno - Neuspješno) / 3';
