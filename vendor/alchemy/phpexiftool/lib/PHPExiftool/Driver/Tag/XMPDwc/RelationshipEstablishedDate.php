 ...
 * @ExclusionPolicy("all")
 */
class RelationshipEstablishedDate extends AbstractTag
{

    protected $Id = 'ResourceRelationshipRelationshipEstablishedDate';

    protected $Name = 'RelationshipEstablishedDate';
