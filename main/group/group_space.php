...
else
{
	...
	{
		// link to the documents area of this group
		$tools .= "- <a href=\"../document/document.php?".api_get_cidreq()."&amp;gidReq=".$current_group['id']."&amp;origin=$origin\">".get_lang("GroupDocument")."</a><br/>";
	}
	if ( $current_group['calendar_state'] == TOOL_PUBLIC )	
	{
		//link to a group-specific part of agenda
		$tools .= "- <a href=\"../calendar/agenda.php?".api_get_cidreq()."&amp;toolgroup=".$current_group['id']."&amp;group=".$current_group['id']."\">".get_lang("GroupCalendar")."</a><br/>";
	}
	...
	{
		//link to a group-specific part of announcements
		$tools .= "- <a href=\"../announcements/announcements.php?".api_get_cidreq()."&amp;toolgroup=".$current_group['id']."&amp;group=".$current_group['id']."\">".get_lang("GroupAnnouncements")."</a><br/>";
	}
