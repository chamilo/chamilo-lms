...
$langDefaultTextInBlanks = "<table cellspacing=\\"0\\" cellpadding=\\"10\\" border=\\"1\\" width=\\"720\\" height:=\\"\\" style=\\"\\">    <tbody>        <tr>            <td colspan=\\"2\\">            <h3>Exemple de Remplir le formulaire : calculer l\'Indice de Masse Corporelle</h3>            <";
...
$langHotspotChoose = "Pour créer une zone hotspot, sélectionnez la forme à côté de la couleur, ensuite dessinez la zone. Pour déplacer une zone, sélectionnez la couleur, cliquez sur un autre endroit dans l\'image et redessinez la zone. Pour ajouter une zone, cliquez sur le bou";
$Fault = "Incorrect";
...
$DirectFeedbackCantModifyTypeQuestion = "Le type d\'exercice ne peut pas être modifié car il a été enregistré comme auto-évaluation. L\'auto-évaluation vous donne la possibilité de donner une rétro-alimentation immédiate à l\'apprenant, mais ce type n\'est pas compatible avec tous les types de q";
