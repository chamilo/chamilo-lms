<?php
$lang_height = "ارتفاع";
$lang_resizing_comment = "تغییر اندازه عکس بر طبق اندازه های زیر بر حسب واحد پیکسل";
$lang_width = "عرض";
$lang_resizing = "تغییر اندازه پنجره";
$lang_no_resizing_comment = "نمایش تمام عکس ها در اندازه اصلی آنها. هیچ تغییری در اندازه عکس ها ایجاد نمی شود. اگر اندازه عکس ها از اندازه صفحه نمایش بزرگتر باشد، میله های مخصوص تغییر مکان در صفحه به طور خودکار در گوشه های صفحه ایجاد خواهند شد ";
