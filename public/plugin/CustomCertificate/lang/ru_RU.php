...
$strings['CertificateMode'] = 'Режим сертификата';
$strings['UseCourseCustomCertificate'] = 'Использовать пользовательский сертификат курса';
$strings['UseDefaultCustomCertificate'] = 'Использовать пользовательский сертификат платформы по умолчанию';

$strings['CreateCertificateWithTags'] = 'Создать сертификат с использованием этих тегов';

$strings['DeleteCertificate'] = 'Удалить сертификат';

$strings['SaveCertificate'] = 'Сохранить сертификат';

$strings['SelectOneOptionBeforeOpeningEditor'] = 'Выберите один из вариантов и сохраните настройки перед открытием редактора сертификатов.';

$strings['ChooseCustomCertificateModeHelp'] = 'Выберите, как этот курс должен использовать пользовательские сертификаты.';

$strings['CouldNotSaveCertificate'] = 'Не удалось сохранить конфигурацию сертификата.';
