...
<div id="actions" class="actions">
	...
	&nbsp;<a href="<?php echo api_get_self() ?>?action=sortmycourses"><?php echo Display::return_icon('back.png', trans('Back'),'','32'); ?></a>
...
?>
    <form name="create_course_category" method="post" action="<?php echo api_get_self() ?>?action=createcoursecategory">
        ...
        <button type="submit" class="save" name="create_course_category"><?php echo trans('AddCategory') ?></button>
    </form>
