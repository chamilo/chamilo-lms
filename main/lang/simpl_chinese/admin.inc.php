...
$ExampleXMLFile = "XML文件样例";
$ExampleCSVFile = "CSV文件样例";
...
$AnnouncementAdded = "通知已经被添加";
$AnnouncementUpdated = "通知已经被更新";
$AnnouncementDeleted = "通知已经被删除";
$Content = "内容";
