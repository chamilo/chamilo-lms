...
$strings['Review meetings, recordings and available actions.'] = 'Pārskatiet sanāksmes, ierakstus un pieejamās darbības.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Atlasiet PDF vai PPTX failus, kurus vēlaties iepriekš ielādēt kā slaidus konferencei.';
$strings['Max total: %d MB'] = 'Maksimālais kopējais: %d MB';
$strings['Pre-upload Documents'] = 'Iepriekš augšupielādēt dokumentus';
$strings['No documents found'] = 'Dokumenti nav atrasti';
$strings['Failed to load documents'] = 'Neizdevās ielādēt dokumentus';
$strings['No meetings or recordings are available yet.'] = 'Vēl nav pieejamu sanāksmju vai ierakstu.';
$strings['Share the conference link with allowed participants.'] = 'Kopīgojiet konferences saiti ar atļautajiem dalībniekiem.';
$strings['presentation'] = 'Prezentacija';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Tīmekļa āķu panelis (Globāls)';
$strings['MeetingTitleContains'] = 'Sapulces nosaukums satur';
$strings['FromUTC'] = 'No (UTC)';
$strings['ToUTC'] = 'Līdz (UTC)';
$strings['OnlyOnlineRows'] = 'Tikai tiešsaistes rindas';
$strings['AllMeetings'] = 'Visas sapulces';
$strings['Apply'] = 'Pielietot';
$strings['ExportCSV'] = 'Eksportēt CSV';
$strings['AutoRefresh10s'] = 'Automātiska atsvaidzināšana (10s)';
$strings['ActiveMeetings'] = 'Aktīvās sapulces';
$strings['ConnectedNow'] = 'Pieslēgušies tagad';
$strings['JoinsToday'] = 'Pievienojumi šodien';
$strings['Events24h'] = 'Notikumi (24h)';
$strings['OnlineTime'] = 'Tiešsaistes laiks';
$strings['Conversation'] = 'Saruna';
$strings['CameraShare'] = 'Kameras koplietošana';
$strings['Messages'] = 'Ziņojumi';
$strings['Reactions'] = 'Reakcijas';
$strings['Hands'] = 'Rokas';
$strings['Results'] = 'Rezultāti';
$strings['Status'] = 'Statuss';
$strings['Joined'] = 'Pievienojies';
$strings['Last'] = 'Pēdējais';
$strings['Running'] = 'Notiek';
$strings['Finished'] = 'Pabeigts';
$strings['UsersColon'] = 'Lietotāji:';
$strings['OnlineColon'] = 'Tiešsaistē:';
$strings['TalkColon'] = 'Runā:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Atjaunināts';
$strings['FirstJoin'] = 'Pirmais pievienojums';
$strings['LastSeen'] = 'Pēdējoreiz redzēts';
$strings['Totals'] = 'Kopā';
$strings['Talking'] = 'Runā';
