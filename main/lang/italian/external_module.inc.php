...
$langSubTitle = "Aggiunge alla pagina principale del Corso un collegamento a un sito, una pagina o a qualsiasi indirizzo web. <br> Suggerimento: se desiderate aggiungere un collegamento a una pagina, navigate fino alla pagina richiesta, copiate l\'indirizzo dalla barra de";
...
$langExplanation = "La pagina deve essere in formato HTML (es. \\"my_page.htm\\"). Sarà collegata dalla pagina principale. Se desiderate inviare documenti in altro formato (PDF, Word, Power Point, Video, ecc.) utilizzate lo strumento <a href=../document/document.php>Documenti<";
