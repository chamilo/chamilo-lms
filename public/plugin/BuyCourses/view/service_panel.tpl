                            ...
                            {% if sale.is_renewable %}
                                <div class="bc-recurring-box">
                                    <div>
                                        ...
                                        {% if sale.next_charge_date %}<p class="bc-recurring-box__extra">{{ sale.renewal_date_label|e }}: {{ sale.next_charge_date|e }}</p>{% endif %}
                                    ...
                                    <div class="bc-actions" style="margin-top: 0;">
                                        ...
                                        {% if sale.can_cancel_recurring %}
                                            <form method="post" action="{{ sale.cancel_recurring_url|e }}" onsubmit="return confirm('{{ sale.cancel_renewal_message|e('js') }}');">
                                                <input type="hidden" name="order" value="{{ sale.id }}">
                                                <input type="hidden" name="action" value="cancel_recurring_payment">
                                                <input type="hidden" name="sec_token" value="{{ sale.cancel_recurring_token|e('html_attr') }}">
