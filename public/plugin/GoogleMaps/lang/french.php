...
<br><br>
Suivez le lien pour voir la carte : <a href='".api_get_path(WEB_PLUGIN_PATH)."GoogleMaps/src/map_coordinates.php'>".api_get_path(WEB_PLUGIN_PATH).'google_maps/src/map_coordinates.php</a>';
