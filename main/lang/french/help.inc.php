...
$langCourseRolesRightsContent = "<p>Dans les rôles et droits et de la vue d\'ensemble de droits de votre cours, vous pouvez définir exactement <em>Qui est autorisé de faire, et dans quel emplacement</em>.</p> <p>Le concept de base est que vous pouvez indiquer qui peuvent consulter le contenu de cet outil, ajouter de nouveaux articles et répertoires, éditer l\'information existante, ou supprimer le contenu. Cependant, vous ne devez pas indiquer ceci pour chaque utilisateur individuellement. Les utilisateurs ont des rôles à l\'intérieur de votre cours, comme le visiteur d\'invité, de membre normal de cours, d\'aide d\'enseignement, et de cours admin. Pour chacun de ces rôles, vous pouvez indiquer les permissions pour chaque outil. Vous pouvez dire que tous les utilisateurs peuvent accéder au forum, mais les invités ne peuvent pas y poster - seulement les utilisateurs enregistrés. Vous pouvez dire que l\'aide d\'enseignement peut ajouter des documents à votre cours, mais ne pas les supprimer.</p> <p>Dans l\'outil d\'utilisateurs de votre cours, vous pouvez voir les rôles des utilisateurs et les éditer (utilisation juste le bouton d\'édition dans la liste d\'utilisateurs). </p> <h3>Vue d\'ensemble de tout les rôles</h3> <p>Il y en a 5 rôles locaux à l\'intérieur de Dokeos. Ce sont les rôles que vous pouvez assigner aux utilisateurs à l\'intérieur de votre cours. <ul><li><b>Visiteur  anonyme</b> : Celui là pourrait être n\'importe qui dans n\'importe quel endroit du monde, qui juste ouvre un browser et essaye de visiter votre cours. Par défaut ces utilisateurs n\'ont aucun droit du tout et ne peuvent même pas regarder votre cours.</li> <li><b>Visiteur enregistré</b> : C\'est quelqu\'un qui est enregistré dans la plateforme de Dokeos, et visite votre cours sans être inscrit.</li> <li><b>Membre normal</b> : C\'est le rôle par défaut pour les utilisateurs qui s\'inscrivent dans votre cours. Typiquement, la majorité d\'utilisateurs garde ce rôle, et les admins de cours assignent  le rôle de l\'aide d\'enseignement à quelques utilisateurs ainsi il peuvent aider à développer le cours.</li> <li><b>Assistant d\'enseignement</b>: Ce rôle auxiliaire a beaucoup de permissions. Dans la plupart des outils, l\'assistant d\'enseignement peut regarder, ajouter et éditer le contenu, mais ne pas le supprimer. L\'assistant d\'enseignement ne peut pas également éditer la configuration des droits des cours par défaut.</li> <li><b>Administrateur de cours</b> : Il a tous les droits dans le cours et peut faire tout. Le créateur d\'un cours obtient automatiquement ce rôle.</li></ul></p> <h3>Vue d\'ensemble de tout les droits</h3> <p> Il y en a 4 droits fondamentaux à l\'intérieur de Dokeos:<ul> <li><b>Voir</b> : Le droit de voir un outil et son contenu</li><li><b>Ajouter</b> : Le droit d\'ajouter un nouveau contenu dans un outil, par exemple ; il permet d\'ajouter des liens hypertextes, catégories, documents, dossiers, publications d\'étudiant, messages de forum...</li><li><b>Editer</b>: Le droit d\'éditer le contenu existant dans un outil, par exemple ; il permet d\'éditer l\'URL des liens hypertextes, le nom d\'un dossier, le titre et les mots-clés d\'un document...</li> <li><b>Supprimer</b> : Le droit de supprimer le contenu existant dans un outil, par exemple ; il permet du supprimer les liens hypertextes, publications d\'étudiant, messages du forum, documents...</li> </ul> </p> <h3>Vue d\'ensemble des locations</h3> <p>Chauque cours et chaque otil de cours a un endroit séparé dans Dokeos. Quelques endroits d\'endroits sont<ul> <li>Cours TEST_COURSE</li> <li>L\'outil des documents du cours TEST_COURSE</li> <li>L\'outil agenda du cours Psychology101</li> </ul></p> <h3>Options des permissions</h3><p> En tant qu\'administrateur du cours, vous pouvez indiquer qui peut faire quoi, et dans quel endroit. Pour chaque combinaison de rôle et d\'endroit les 4 droits peuvent être placées.</p>";
?>