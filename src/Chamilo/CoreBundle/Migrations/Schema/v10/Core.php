...
class Core implements Migration, OrderedMigrationInterface
{
    ...
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery("ALTER TABLE settings_current ADD namespace VARCHAR(255) NOT NULL");
        $queries->addQuery("ALTER TABLE settings_current ADD name VARCHAR(255) NOT NULL");
    }
