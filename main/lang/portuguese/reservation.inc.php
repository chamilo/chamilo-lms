...
$ViewItemRight = "Visualizar as permissões do item";
$DeleteSelectedItemRights = "Excluir as permissões dos items selecionados";
$SetEditRights = "Definir permissões de edição";
$UnsetEditRights = "Remover permissões de edição";
$SetDeleteRights = "Atribuir permissões para apagar";
$UnsetDeleteRights = "Remover permissões para apagar";
$SetMresRights = "Atribuir permissões de reserva";
$UnsetMresRights = "Remover permissões de reserva";
$SetViewRights = "Definir permissão de visualização";
$UnsetViewRights = "Remover a permissão de visualização";
$SetAllRights = "Atribuir todas as permissões";
$UnsetAllRights = "remover todas as permissões";
$ItemCourse = "Item do curso";
$MItemRight = "Permissões do item";
$EditItem2 = "Editar item";
$ItemManagerHeader = "Gerir o item";
$LangClass = "Turma";
$MReservationPeriodsRight = "Permissão de períodos de reserva";
$AddNewItem = "Adicionar novo item";
$ItemName = "Nome do item";
$ItemDescription = "Descrição do item";
$ItemExist = "O item existe";
$EditItem = "Editar o item";
$ItemEdited = "Item atualizado";
$CategoryFilter = "Filtro de Categoria";
$ItemCreator = "Ferramenta de criação de item";
$DeleteSelectedItems = "Apagar os items selecionados";
$BookingPeriodTimepickerLimitation = "Limitação no seletor de período de reserva";
...
$PermissionsStored = "Permissões guardadas";
$PermissionGranted = "Permissão concedida";
$PermissionRevoked = "Permissão negada";
$RoleGranted = "Perfil aceite";
$RoleRevoked = "Perfil negado";
$ErrorPleaseGiveRoleName = "Por favor nomeie este perfil";
$RoleDeleted = "Perfil criado";
