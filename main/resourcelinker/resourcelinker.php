...
if ($content == "Forum")
{
	$TBL_FORUMS = Database::get_course_table(FORUM_TABLE);
	$TBL_CATAGORIES = Database::get_course_table(FORUM_CATEGORY_TABLE);
	$TBL_FORUMTOPICS = Database::get_course_table(FORUM_TOPIC_TABLE);
