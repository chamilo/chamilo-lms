...
$Microphone = "Mikrofon";
$Name = "Ime";
$DeleteStream = "Obrii podatkovni tok";
...
$Poll = "Anketa";
$YouHaveToBecomeModeratorOfThisRoomToStartPolls = "Morate postati Moderator ukoliko elite napraviti anketu u ovoj sobi.";
$YourVoteHasBeenSent = "Va glas je poslan";
$YouAlreadyVotedForThisPoll = "Ve&#263; ste glasali u ovoj anketi";
$VoteButton = "Glasaj!";
$YourAnswer = "Va odgovor:";
$Yes = "Da";
$No = "Ne";
$WantsToKnow = "eli saznati:";
$PollResults = "Rezultati ankete";
$Votes = "Glasovi:";
$Result = "Rezultat:";
$ThereIsNoPoll = "Ne postoji anketa.";
$MeetingMode = "Sastanak (najvie 4 mjesta)";
$ConferenceMaxSeats = "Konferencija (najvie 50 mjesta)";
$Mode = "Na&#269;in";
...
$OK = "OK";
$YouHaveToReconnectSoThatTheChangesTakeEffect = "Morate izvriti ponovno spajanje da izmjene budu primjenjene.";
$ChangeSettings = "Promjena postavki";
$Course = "Kolegij:";
$CourseLanguage = "Jezik kolegija:";
$ConfirmClearWhiteboard = "Potvrdi brisanje plo&#269;e";
$ShouldWitheboardBeClearedBeforeNewImage = "elite li brisanje plo&#269;e prije dodavanja nove slike?";
$DontAskMeAgain = "Ne pitaj me ponovno";
$EditSettings = "Uredi postavke";
$ShowConfirmationBeforeClearingWhiteboard = "Zatrai potvrdu prije brisanja plo&#269;e";
$UserInfo = "Informacije o korisniku";
$ClearDrawArea = "Obrii podru&#269;je za crtanje";
$Undo = "Poniti";
$Redo = "Ponovi";
...
$Elipse = "Elipsa";
$Arrow = "Strelica";
$DeleteChosenItem = "Obrii odabrani element";
$ApplyForModeration = "Zatrai mjesto moderatora";
$Apply = "Zatrai";
...
$Bold = "Bold";
$Waiting = "&#268;ekanje....";
$AUserWantsToApplyForModeration = "Mjesto moderatora je zatraio korisnik:";
$Accept = "Prihvati";
$Reject = "Odbijanje";
$SendingRequestToFollowingUsers = "aljem zahtjev sljede&#263;im korisnicima";
$Accepted = "Prihvatili";
$Rejected = "Odbili";
