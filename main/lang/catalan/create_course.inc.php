...
$langExplanation = "Un cop hagueu clicat Acceptar es crearà el lloc web d\'un curs. el qual constarà de diverses eines: un gestor de documents, un creador d\'itineraris formatius en format SCORM, un visualitzador de lliçons o itineraris formatius, la possibilitat de realitza";
...
$IntroductionWiki = "La paraula Wiki és una abreviatura de WikiWikiWeb. Wikiwiki és una paraula hawaiana que significa ràpid o veloç. En un Wiki els usuaris poden escriure pàgines conjuntament. Si una persona escriu alguna cosa malament, la següent ho pot corregir. Aquesta da";
