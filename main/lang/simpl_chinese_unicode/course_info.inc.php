...
$langModifInfo = "课程设置";
$langCode = "课程代码";
$langCourseVisibilityModified = "修改（角色-权限系统有更多详细设置）";
$langWorkEmailAlert = "作业上传提醒";
$langWorkEmailAlertActivate = "邮件提醒";
$langWorkEmailAlertDeactivate = "不提醒";
$langDropboxEmailAlert = "投递文件提醒";
$langDropboxEmailAlertActivate = "邮件提醒";
$langDropboxEmailAlertDeactivate = "不提醒";
$langAllowUserEditAgenda = "允许修改日程";
$langAllowUserEditAgendaActivate = "允许";
$langAllowUserEditAgendaDeactivate = "拒绝";
$langAllowUserEditAnnouncement = "允许修改通知";
$langAllowUserEditAnnouncementActivate = "允许";
$langAllowUserEditAnnouncementDeactivate = "拒绝";
$langOrInTime = "或在";
$langCourseRegistrationPassword = "课程注册密码";
$langDescriptionRecycleCourse = "该工具将会清空课程的全部或选择的部分内容，请在操作前注意备份您的课程！";
?>