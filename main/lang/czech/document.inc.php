...
$Impossible = "Operace není možná";
$AddComment = "Přidat/upravit komentář k";
$DocCopied = "Dokument je zkopírovaný";
$DocDeleted = "Dokument je vymazaný";
$ElRen = "Element je přejmenovaný";
$DirMv = "Element je přesunutý";
$ComMod = "Komentář byl upraven";
$ViMod = "Viditelnost je upravená";
$GroupSpace = "Prostor skupiny";
$GroupSpaceLink = "Prostor skupiny";
$GroupForumLink = "Fórum skupiny";
$ZipNoPhp = "Zip soubor nemůže obsahovat soubory .PHP";
$Uncompress = "Rozbalit zip";
$DownloadAndZipEnd = "Zip soubor byl nahrán a rozbalen";
$Root = "root";
$CreateDoc = "Vytvořit dokument";
$Down = "dolů";
$FileError = "Soubor k nahrání je neplatný";
$MaxFileSize = "Maximální velikost souboru je";
$FileName = "Název souboru";
$NoFileName = "Prosím, napište název souboru";
$NoText = "Napište prosím text (popř. HTML) obsah stránky";
$AreYouSureToDelete = "Jste si jistí, že to chcete smazat";
$Scormcontent = "Toto je Scorm obsah <br><input type=button name=scormbutton value='Launch it !' onclick='openscorm()'>";
$Scormcontentstudent = "Toto je kurz formátu Scorm. Poud jej chcete přehrát, pak klikněte zde: <input type=button name=scormbutton value='Launch it !' onclick='openscorm()'>";
$Publish = "Publikovat";
$MissingImagesDetected = "Detekovány chybějící obrázky";
$CreateDocument = "Vytvořit dokument";
$EditDocument = "Upravit";
$Documents = "Dokumenty";
$OrganiseDocuments = "Vytvořit obsah";
$EditTOC = "Upravit obsah";
$Chapter = "Kapitola";
$DocumentList = "Seznam všech dokumentů";
...
$AddMetadata = "Zobrazit/Upravit Metadata";
$GoMetadata = "Start";
