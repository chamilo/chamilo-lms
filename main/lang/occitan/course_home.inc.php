...
$langInLnk  = "Liames desactivats";
$langDelLk = "Voletz vertadierament eliminar aqueste liame ?";
$langCourseCreate  = "Crear un cors web";
$langNameOfTheLink  = "Nom dau liame";
$lang_main_categories_list                  = "Lista dei categorias principalas";
$langCourseAdminOnly = "Noms dei professors";
$PlatformAdminOnly = "Nom deis administrators";
$langCombinedCourse = "Cors combinat";
