...
$langSingleDb = "Usar Chamilo con una o varias bases de datos";
...
$DokeosLicenseInfo = "Chamilo es software libre distribuido bajo GNU General Public licence (GPL)";
$IAccept = "Acepto";
...
$WelcomToTheDokeosInstaller = "Bienvenido al Instalador de Chamilo";
...
$DBSettingUpgradeIntro = "El programa de actualización recuperará y actualizará las bases de datos de Chamilo. Para realizar esto, el programa utilizará las bases de datos y la configuración definidas debajo. ¡ Debido a que nuestro software funciona en una amplia gama de sistemas";
$ExtensionMBStringNotAvailable = "Extensión MBString no disponible";
$ExtensionMySQLNotAvailable = "Extensión MySQL no disponible";
$DokeosArtLicense = "Las imágenes y las galerías de medios de Chamilo utilizan imágenes e iconos de Nuvola, Crystal Clear y Tango. Otras imágenes y medios, como diagramas y animaciones flash, se han tomado prestadas de Wikimedia y de los cursos de Ali Pakdel y de Denis Hoa co";
