...
$langParamSentTo = "Thông tin đã gửi đến ";
$langInPlaceOf = "thay vì ";
$langTryWith = "Thử với";
$langYourAccountParam = "Đây là tên đăng nhập và mật khẩu của bạn";
$langEmailNotSent = "Có trục trặc gì đó, xin báo lại cho ";
$langTotalEntryFound = "Đã tìm thấy";
$langExplainFormLostPass = "Hãy gõ lại những gì bạn còn nhớ được khi đăng ký";
$langLoginRequest = "Cần thiết Login ";
$langDataFromDb = "Dữ liệu trong CSDL";
$langDataFromUser = "Dữ liệu do user gửi đi";
$langCaseSensitiveCaution = "Chú ý : case sensitive.";
$langWaitAMailOn = "Thư sẽ gửi đến ";
$langAccountExist = "Tìm thấy tài khoản.<BR>Đã gửi thư cho quản trị<BR>";
$langAccountNotExist = "Không thấy tài khoản.<BR>Đã gửi thư cho quản trị để tìm bằng tay<BR>";
$langMailSentToAdmin = "Đã gửi thư cho quản trị";
$langRetrieve = "Thông tin";
