...
*/
$langAdminBy  = "Administrat de";
$langAdministrationTools  = "Administrare";
$langState  = "Starea sistemului";
$langDevAdmin  = "Administrarea dezvoltarii proiectului";
$langLinksToClaroProjectSite  = "Trimitere spre site-ul proiectului";
$langStatistiques  = "Statistici";
$langNbProf  = "Numarul profesorilor";
$langNbStudents  = "Numarul studentilor";
$langNbLogin  = "Numarul de logari";
$langToday    = "Azi";
$langLast7Days  = "In ultimele 7 zile";
$langLast30Days  = "In ultimele 30 de zile";
$langNbAnnoucement  = "Numarul de anunturi";
$langCheckDatabase  = "Verificati baza de date principala";
$langPleaseCheckConfigForMainDataBaseName  = "Va rugam verificati aceste valori<br>Numele bazei de date principale in <br>";
$langBaseFound  = "A fost gasit.<br>Se verifica tablourile acestei baze de date";
$langNeeded  = "necesar";
