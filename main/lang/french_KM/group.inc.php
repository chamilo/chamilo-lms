...
/*
      ...
      +----------------------------------------------------------------------+
      |   $Id: group.inc.php 950 2004-04-01 20:24:14Z olivierb78 $         |
      +----------------------------------------------------------------------+
...
$langStudentRegNotAllowed="Les membres <b>ne sont pas autorisés</b>
			à s'inscrire eux-mêmes dans les groupes";
...
$langSubscribed ="membres(s) inscrit(s) à ce cours";
$langAdminsOfThisCours ="Responsables de ce cours";
$langEditGroup="Editer ce groupe";
$langUncompulsory="(facultatif)";
$langNoGroupStudents="Membres sans groupe";
$langGroupMembers="Membres du groupe";
$langGroupCancel="annuler";
$langGroupSettingsModified="Paramètres de ce groupe modifiés.";
$langGroupStudentsInGroup="membres inscrits dans les groupes";
$langGroupStudentsRegistered="membres inscrits dans l'espace";
$langGroupNoGroup="membres sans groupe";
$langGroupUsersList="Cf. liste des <a href=../user/user.php>membres</a>";
...
$langGroupTutors="Modérateurs";
$langGroupNoTutor="(aucun)";
$langGroupNone="(aucune)";
$langGroupNoneMasc="(aucun)";
$langGroupUManagement="Gestion des membres";
...
$langGroupFilledGroups="Les groupes ont été remplis (ou complétés) par les membres figurant dans la liste 'Utilisateurs'.";
