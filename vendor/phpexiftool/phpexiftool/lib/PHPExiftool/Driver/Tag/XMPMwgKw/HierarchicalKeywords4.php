 ...
 * @ExclusionPolicy("all")
 */
class HierarchicalKeywords4 extends AbstractTag
{

    protected $Id = 'KeywordsHierarchyChildrenChildrenChildrenKeyword';
    ...
    protected $Description = 'Hierarchical Keywords 4';
