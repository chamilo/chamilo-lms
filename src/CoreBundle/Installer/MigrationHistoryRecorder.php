...
final class MigrationHistoryRecorder
{
     ...
     * V310 is the case in point and is deliberately missing below: its migrations add
     * settings rows and one table no entity maps, so no schema answers for it.
     *
     * A namespace missing from this list is never recorded, and its migrations run
     * instead. That is the safe direction, and for a namespace like V310 it is also the
