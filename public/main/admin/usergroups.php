...
$action_links = 'function action_formatter (cellvalue, options, rowObject) {
    return \''
    .' <a href="/admin/usergroups/\'+options.rowId+\'/add-users">'.Display::getMdiIcon(ObjectIcon::USER, 'ch-tool-icon-success', null, ICON_SIZE_MEDIUM, get_lang('Subscribe users to class')).'</a>'
    .' <a href="add_courses_to_usergroup.php?id=\'+options.rowId+\''.$ctx.'">'.Display::getMdiIcon(ObjectIcon::COURSE, 'ch-tool-icon-success', null, ICON_SIZE_MEDIUM, get_lang('Subscribe class to courses')).'</a>'
    .' <a href="add_sessions_to_usergroup.php?id=\'+options.rowId+\''.$ctx.'">'.Display::getMdiIcon(ObjectIcon::SESSION, 'ch-tool-icon-success', null, ICON_SIZE_MEDIUM, get_lang('Subscribe class to sessions')).'</a>'
    ...
    .' <a href="?action=edit&id=\'+options.rowId+\''.$ctx.'">'.Display::getMdiIcon(ActionIcon::EDIT, 'ch-tool-icon-secondary', null, ICON_SIZE_SMALL, get_lang('Edit')).'</a>'
    .' <a onclick="javascript:if(!confirm('."\'".addslashes(api_htmlentities(get_lang("Please confirm your choice"), ENT_QUOTES))."\'".')) return false;"  href="?action=delete&id=\'+options.rowId+\''.$ctx.'">'.Display::getMdiIcon(ActionIcon::DELETE, 'ch-tool-icon-danger', null, ICON_SIZE_SMALL, get_lang('Delete')).'</a>\';
}';
