...
$strings['Review meetings, recordings and available actions.'] = 'Rever reuniões, gravações e ações disponíveis.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Selecione os ficheiros PDF ou PPTX que pretende pré-carregar como diapositivos para a conferência.';
$strings['Max total: %d MB'] = 'Máx. total: %d MB';
...
$strings['No meetings or recordings are available yet.'] = 'Ainda não existem reuniões ou gravações disponíveis.';
$strings['Share the conference link with allowed participants.'] = 'Partilhe a hiperligação da conferência com os participantes autorizados.';
$strings['presentation'] = 'Apresentacao';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Painel de Webhooks (Global)';
$strings['MeetingTitleContains'] = 'O título da reunião contém';
...
$strings['ConnectedNow'] = 'Ligados agora';
...
$strings['CameraShare'] = 'Partilha de câmara';
