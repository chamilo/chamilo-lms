 ...
 * CAttendanceCalendar
 *
 * @ORM\Table(name="c_attendance_calendar", indexes={@ORM\Index(name="attendance_id", columns={"attendance_id"}), @ORM\Index(name="done_attendance", columns={"done_attendance"})})
 * @ORM\Entity
 */
